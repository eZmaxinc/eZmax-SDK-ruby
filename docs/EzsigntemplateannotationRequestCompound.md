# EzmaxApi::EzsigntemplateannotationRequestCompound

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **pki_ezsigntemplateannotation_id** | **Integer** | The unique ID of the Ezsigntemplateannotation | [optional] |
...
instance = EzmaxApi::EzsigntemplateannotationRequestCompound.new(
