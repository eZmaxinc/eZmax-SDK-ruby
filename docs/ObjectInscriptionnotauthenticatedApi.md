...
> File inscriptionnotauthenticated_batch_download_v1(pki_inscriptionnotauthenticated_id, inscriptionnotauthenticated_batch_download_v1_request)
...
inscriptionnotauthenticated_batch_download_v1_request = EzmaxApi::InscriptionnotauthenticatedBatchDownloadV1Request.new({a_pki_attachment_id: [1]}) # InscriptionnotauthenticatedBatchDownloadV1Request | 

begin
  # Download multiples attachments from a Inscriptionnotauthenticated
  result = api_instance.inscriptionnotauthenticated_batch_download_v1(pki_inscriptionnotauthenticated_id, inscriptionnotauthenticated_batch_download_v1_request)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_batch_download_v1: #{e}"
end
```

#### Using the inscriptionnotauthenticated_batch_download_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(File, Integer, Hash)> inscriptionnotauthenticated_batch_download_v1_with_http_info(pki_inscriptionnotauthenticated_id, inscriptionnotauthenticated_batch_download_v1_request)

```ruby
begin
  # Download multiples attachments from a Inscriptionnotauthenticated
  data, status_code, headers = api_instance.inscriptionnotauthenticated_batch_download_v1_with_http_info(pki_inscriptionnotauthenticated_id, inscriptionnotauthenticated_batch_download_v1_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => File
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_batch_download_v1_with_http_info: #{e}"
end
```
...
> <InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Response> inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1(pki_inscriptionnotauthenticated_id, inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1_request)
...
api_instance = EzmaxApi::ObjectInscriptionnotauthenticatedApi.new
pki_inscriptionnotauthenticated_id = 56 # Integer | 
inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1_request = EzmaxApi::InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Request.new({a_obj_inscriptionnotauthenticatedcondition: [EzmaxApi::CustomInscriptionnotauthenticatedconditionRequest.new({pki_inscriptionnotauthenticatedcondition_id: 16, dt_inscriptionnotauthenticatedcondition_completed: '2020-12-31'})]}) # InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Request | 

begin
  # Fills the Inscriptionnotauthenticatedcondition in the Inscriptionnotauthenticated
  result = api_instance.inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1(pki_inscriptionnotauthenticated_id, inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1_request)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1: #{e}"
end
```

#### Using the inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Response>, Integer, Hash)> inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1_with_http_info(pki_inscriptionnotauthenticated_id, inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1_request)

```ruby
begin
  # Fills the Inscriptionnotauthenticatedcondition in the Inscriptionnotauthenticated
  data, status_code, headers = api_instance.inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1_with_http_info(pki_inscriptionnotauthenticated_id, inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <InscriptionnotauthenticatedFillInscriptionnotauthenticatedconditionV1Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_fill_inscriptionnotauthenticatedcondition_v1_with_http_info: #{e}"
end
```
...
> <InscriptionnotauthenticatedGetAttachmentsV1Response> inscriptionnotauthenticated_get_attachments_v1(pki_inscriptionnotauthenticated_id)
...
begin
  # Retrieve Inscriptionnotauthenticated's attachments
  result = api_instance.inscriptionnotauthenticated_get_attachments_v1(pki_inscriptionnotauthenticated_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_get_attachments_v1: #{e}"
end
```

#### Using the inscriptionnotauthenticated_get_attachments_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<InscriptionnotauthenticatedGetAttachmentsV1Response>, Integer, Hash)> inscriptionnotauthenticated_get_attachments_v1_with_http_info(pki_inscriptionnotauthenticated_id)

```ruby
begin
  # Retrieve Inscriptionnotauthenticated's attachments
  data, status_code, headers = api_instance.inscriptionnotauthenticated_get_attachments_v1_with_http_info(pki_inscriptionnotauthenticated_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <InscriptionnotauthenticatedGetAttachmentsV1Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_get_attachments_v1_with_http_info: #{e}"
end
```
...
> <InscriptionnotauthenticatedGetInscriptionnotauthenticatedconditionsV1Response> inscriptionnotauthenticated_get_inscriptionnotauthenticatedconditions_v1(pki_inscriptionnotauthenticated_id)
...
begin
  # Retrieve Inscriptionnotauthenticated conditions
  result = api_instance.inscriptionnotauthenticated_get_inscriptionnotauthenticatedconditions_v1(pki_inscriptionnotauthenticated_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_get_inscriptionnotauthenticatedconditions_v1: #{e}"
end
```

#### Using the inscriptionnotauthenticated_get_inscriptionnotauthenticatedconditions_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<InscriptionnotauthenticatedGetInscriptionnotauthenticatedconditionsV1Response>, Integer, Hash)> inscriptionnotauthenticated_get_inscriptionnotauthenticatedconditions_v1_with_http_info(pki_inscriptionnotauthenticated_id)

```ruby
begin
  # Retrieve Inscriptionnotauthenticated conditions
  data, status_code, headers = api_instance.inscriptionnotauthenticated_get_inscriptionnotauthenticatedconditions_v1_with_http_info(pki_inscriptionnotauthenticated_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <InscriptionnotauthenticatedGetInscriptionnotauthenticatedconditionsV1Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_get_inscriptionnotauthenticatedconditions_v1_with_http_info: #{e}"
end
```
...
> <InscriptionnotauthenticatedGetObjectV2Response> inscriptionnotauthenticated_get_object_v2(pki_inscriptionnotauthenticated_id)
...
api_instance = EzmaxApi::ObjectInscriptionnotauthenticatedApi.new
pki_inscriptionnotauthenticated_id = 56 # Integer | The unique ID of the Inscriptionnotauthenticated

begin
  # Retrieve an existing Inscriptionnotauthenticated
  result = api_instance.inscriptionnotauthenticated_get_object_v2(pki_inscriptionnotauthenticated_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_get_object_v2: #{e}"
end
```

#### Using the inscriptionnotauthenticated_get_object_v2_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<InscriptionnotauthenticatedGetObjectV2Response>, Integer, Hash)> inscriptionnotauthenticated_get_object_v2_with_http_info(pki_inscriptionnotauthenticated_id)

```ruby
begin
  # Retrieve an existing Inscriptionnotauthenticated
  data, status_code, headers = api_instance.inscriptionnotauthenticated_get_object_v2_with_http_info(pki_inscriptionnotauthenticated_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <InscriptionnotauthenticatedGetObjectV2Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectInscriptionnotauthenticatedApi->inscriptionnotauthenticated_get_object_v2_with_http_info: #{e}"
end
```
