# EzmaxApi::SystemconfigurationRequestCompoundV2
...
| **i_systemconfiguration_ezsignreminderhoursend** | **Integer** | The hour we will send the eZsign reminders |  |
...
instance = EzmaxApi::SystemconfigurationRequestCompoundV2.new(
