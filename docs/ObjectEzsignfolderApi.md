...
| [**ezsignfolder_get_ezsignfoldersignerassociations_v2**](ObjectEzsignfolderApi.md#ezsignfolder_get_ezsignfoldersignerassociations_v2) | **GET** /2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociations | Retrieve an existing Ezsignfolder&#39;s Ezsignfoldersignerassociations |
...
begin
  # Create a new Ezsignfolder
  result = api_instance.ezsignfolder_create_object_v3(ezsignfolder_create_object_v3_request)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_create_object_v3: #{e}"
end
```

#### Using the ezsignfolder_create_object_v3_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderCreateObjectV3Response>, Integer, Hash)> ezsignfolder_create_object_v3_with_http_info(ezsignfolder_create_object_v3_request)

```ruby
begin
  # Create a new Ezsignfolder
  data, status_code, headers = api_instance.ezsignfolder_create_object_v3_with_http_info(ezsignfolder_create_object_v3_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderCreateObjectV3Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_create_object_v3_with_http_info: #{e}"
end
```
...
api_instance = EzmaxApi::ObjectEzsignfolderApi.new
pki_ezsignfolder_id = 56 # Integer | 
ezsignfolder_duplicate_v1_request = EzmaxApi::EzsignfolderDuplicateV1Request.new({s_ezsignfolder_description: 'Test eZsign Folder', a_fki_ezsignfoldersignerassociation_id: [20], a_obj_ezsigndocument: [EzmaxApi::CustomEzsigndocumentDuplicateRequest.new({pki_ezsigndocument_id: 97, e_ezsigndocument_version: 'Initial'})]}) # EzsignfolderDuplicateV1Request | 

begin
  # Duplicate the Ezsignfolder
  result = api_instance.ezsignfolder_duplicate_v1(pki_ezsignfolder_id, ezsignfolder_duplicate_v1_request)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_duplicate_v1: #{e}"
end
```

#### Using the ezsignfolder_duplicate_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderDuplicateV1Response>, Integer, Hash)> ezsignfolder_duplicate_v1_with_http_info(pki_ezsignfolder_id, ezsignfolder_duplicate_v1_request)

```ruby
begin
  # Duplicate the Ezsignfolder
  data, status_code, headers = api_instance.ezsignfolder_duplicate_v1_with_http_info(pki_ezsignfolder_id, ezsignfolder_duplicate_v1_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderDuplicateV1Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_duplicate_v1_with_http_info: #{e}"
end
```
...
begin
  # Edit an existing Ezsignfolder
  result = api_instance.ezsignfolder_edit_object_v3(pki_ezsignfolder_id, ezsignfolder_edit_object_v3_request)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_edit_object_v3: #{e}"
end
```

#### Using the ezsignfolder_edit_object_v3_with_http_info variant
...
begin
  # End prematurely
  result = api_instance.ezsignfolder_end_prematurely_v1(pki_ezsignfolder_id, body)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_end_prematurely_v1: #{e}"
end
```

#### Using the ezsignfolder_end_prematurely_v1_with_http_info variant
...
> <EzsignfolderGetActionableElementsV3Response> ezsignfolder_get_actionable_elements_v3(pki_ezsignfolder_id)
...
begin
  # Retrieve actionable elements for the Ezsignfolder
  result = api_instance.ezsignfolder_get_actionable_elements_v3(pki_ezsignfolder_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_actionable_elements_v3: #{e}"
end
```

#### Using the ezsignfolder_get_actionable_elements_v3_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderGetActionableElementsV3Response>, Integer, Hash)> ezsignfolder_get_actionable_elements_v3_with_http_info(pki_ezsignfolder_id)

```ruby
begin
  # Retrieve actionable elements for the Ezsignfolder
  data, status_code, headers = api_instance.ezsignfolder_get_actionable_elements_v3_with_http_info(pki_ezsignfolder_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderGetActionableElementsV3Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_actionable_elements_v3_with_http_info: #{e}"
end
```
...
begin
  # Retrieve Attachment count
  result = api_instance.ezsignfolder_get_attachment_count_v1(pki_ezsignfolder_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_attachment_count_v1: #{e}"
end
```

#### Using the ezsignfolder_get_attachment_count_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderGetAttachmentCountV1Response>, Integer, Hash)> ezsignfolder_get_attachment_count_v1_with_http_info(pki_ezsignfolder_id)

```ruby
begin
  # Retrieve Attachment count
  data, status_code, headers = api_instance.ezsignfolder_get_attachment_count_v1_with_http_info(pki_ezsignfolder_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderGetAttachmentCountV1Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_attachment_count_v1_with_http_info: #{e}"
end
```
...
begin
  # Retrieve Ezsignfolder's Attachments
  result = api_instance.ezsignfolder_get_attachments_v1(pki_ezsignfolder_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_attachments_v1: #{e}"
end
```

#### Using the ezsignfolder_get_attachments_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderGetAttachmentsV1Response>, Integer, Hash)> ezsignfolder_get_attachments_v1_with_http_info(pki_ezsignfolder_id)

```ruby
begin
  # Retrieve Ezsignfolder's Attachments
  data, status_code, headers = api_instance.ezsignfolder_get_attachments_v1_with_http_info(pki_ezsignfolder_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderGetAttachmentsV1Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_attachments_v1_with_http_info: #{e}"
end
```
...
begin
  # Retrieve an existing Ezsignfolder's Ezsignannotations
  result = api_instance.ezsignfolder_get_ezsignannotations_v1(pki_ezsignfolder_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_ezsignannotations_v1: #{e}"
end
```

#### Using the ezsignfolder_get_ezsignannotations_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderGetEzsignannotationsV1Response>, Integer, Hash)> ezsignfolder_get_ezsignannotations_v1_with_http_info(pki_ezsignfolder_id)

```ruby
begin
  # Retrieve an existing Ezsignfolder's Ezsignannotations
  data, status_code, headers = api_instance.ezsignfolder_get_ezsignannotations_v1_with_http_info(pki_ezsignfolder_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderGetEzsignannotationsV1Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_ezsignannotations_v1_with_http_info: #{e}"
end
```
...
## ezsignfolder_get_ezsignfoldersignerassociations_v2

> <EzsignfolderGetEzsignfoldersignerassociationsV2Response> ezsignfolder_get_ezsignfoldersignerassociations_v2(pki_ezsignfolder_id)
...
begin
  # Retrieve an existing Ezsignfolder's Ezsignfoldersignerassociations
  result = api_instance.ezsignfolder_get_ezsignfoldersignerassociations_v2(pki_ezsignfolder_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_ezsignfoldersignerassociations_v2: #{e}"
end
```

#### Using the ezsignfolder_get_ezsignfoldersignerassociations_v2_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderGetEzsignfoldersignerassociationsV2Response>, Integer, Hash)> ezsignfolder_get_ezsignfoldersignerassociations_v2_with_http_info(pki_ezsignfolder_id)

```ruby
begin
  # Retrieve an existing Ezsignfolder's Ezsignfoldersignerassociations
  data, status_code, headers = api_instance.ezsignfolder_get_ezsignfoldersignerassociations_v2_with_http_info(pki_ezsignfolder_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderGetEzsignfoldersignerassociationsV2Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_ezsignfoldersignerassociations_v2_with_http_info: #{e}"
end
```
...
begin
  # Retrieve an existing Ezsignfolder's Ezsignformfieldgroups
  result = api_instance.ezsignfolder_get_ezsignformfieldgroups_v1(pki_ezsignfolder_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_ezsignformfieldgroups_v1: #{e}"
end
```

#### Using the ezsignfolder_get_ezsignformfieldgroups_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderGetEzsignformfieldgroupsV1Response>, Integer, Hash)> ezsignfolder_get_ezsignformfieldgroups_v1_with_http_info(pki_ezsignfolder_id)

```ruby
begin
  # Retrieve an existing Ezsignfolder's Ezsignformfieldgroups
  data, status_code, headers = api_instance.ezsignfolder_get_ezsignformfieldgroups_v1_with_http_info(pki_ezsignfolder_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderGetEzsignformfieldgroupsV1Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_ezsignformfieldgroups_v1_with_http_info: #{e}"
end
```
...
begin
  # Retrieve an existing Ezsignfolder's Ezsignsignatures
  result = api_instance.ezsignfolder_get_ezsignsignatures_v1(pki_ezsignfolder_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_ezsignsignatures_v1: #{e}"
end
```

#### Using the ezsignfolder_get_ezsignsignatures_v1_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderGetEzsignsignaturesV1Response>, Integer, Hash)> ezsignfolder_get_ezsignsignatures_v1_with_http_info(pki_ezsignfolder_id)

```ruby
begin
  # Retrieve an existing Ezsignfolder's Ezsignsignatures
  data, status_code, headers = api_instance.ezsignfolder_get_ezsignsignatures_v1_with_http_info(pki_ezsignfolder_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderGetEzsignsignaturesV1Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_ezsignsignatures_v1_with_http_info: #{e}"
end
```
...
begin
  # Retrieve an existing Ezsignfolder
  result = api_instance.ezsignfolder_get_object_v3(pki_ezsignfolder_id)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_object_v3: #{e}"
end
```

#### Using the ezsignfolder_get_object_v3_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderGetObjectV3Response>, Integer, Hash)> ezsignfolder_get_object_v3_with_http_info(pki_ezsignfolder_id)

```ruby
begin
  # Retrieve an existing Ezsignfolder
  data, status_code, headers = api_instance.ezsignfolder_get_object_v3_with_http_info(pki_ezsignfolder_id)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderGetObjectV3Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_get_object_v3_with_http_info: #{e}"
end
```
...
api_instance = EzmaxApi::ObjectEzsignfolderApi.new
pki_ezsignfolder_id = 56 # Integer | 
ezsignfolder_import_ezsigntemplatepackage_v3_request = EzmaxApi::EzsignfolderImportEzsigntemplatepackageV3Request.new({fki_ezsigntemplatepackage_id: 99, dt_ezsigndocument_duedate: '2020-12-31 23:59:59', a_obj_import_ezsigntemplatepackage_relation: [EzmaxApi::CustomImportEzsigntemplatepackageRelationRequest.new({fki_ezsignfoldersignerassociation_id: 20})], a_s_ezsigntemplateannotation_description: ['Name'], a_s_ezsigntemplateannotation_defaulttext: ['John Doe']}) # EzsignfolderImportEzsigntemplatepackageV3Request | 

begin
  # Import an Ezsigntemplatepackage in the Ezsignfolder
  result = api_instance.ezsignfolder_import_ezsigntemplatepackage_v3(pki_ezsignfolder_id, ezsignfolder_import_ezsigntemplatepackage_v3_request)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_import_ezsigntemplatepackage_v3: #{e}"
end
```

#### Using the ezsignfolder_import_ezsigntemplatepackage_v3_with_http_info variant

This returns an Array which contains the response data, status code and headers.

> <Array(<EzsignfolderImportEzsigntemplatepackageV3Response>, Integer, Hash)> ezsignfolder_import_ezsigntemplatepackage_v3_with_http_info(pki_ezsignfolder_id, ezsignfolder_import_ezsigntemplatepackage_v3_request)

```ruby
begin
  # Import an Ezsigntemplatepackage in the Ezsignfolder
  data, status_code, headers = api_instance.ezsignfolder_import_ezsigntemplatepackage_v3_with_http_info(pki_ezsignfolder_id, ezsignfolder_import_ezsigntemplatepackage_v3_request)
  p status_code # => 2xx
  p headers # => { ... }
  p data # => <EzsignfolderImportEzsigntemplatepackageV3Response>
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_import_ezsigntemplatepackage_v3_with_http_info: #{e}"
end
```
...
begin
  # Reorder Ezsigndocuments in the Ezsignfolder
  result = api_instance.ezsignfolder_reorder_v2(pki_ezsignfolder_id, ezsignfolder_reorder_v2_request)
  p result
rescue EzmaxApi::ApiError => e
  puts "Error when calling ObjectEzsignfolderApi->ezsignfolder_reorder_v2: #{e}"
end
```

#### Using the ezsignfolder_reorder_v2_with_http_info variant
