# EzmaxApi::EzsignsignaturecustomdateResponseCompoundV2

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **pki_ezsignsignaturecustomdate_id** | **Integer** | The unique ID of the Ezsignsignaturecustomdate |  |
...
instance = EzmaxApi::EzsignsignaturecustomdateResponseCompoundV2.new(
