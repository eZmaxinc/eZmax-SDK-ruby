...
begin
  # End prematurely
  result = api_instance.ezsigndocument_end_prematurely_v1(pki_ezsigndocument_id)
  p result
rescue EzmaxApi::ApiError => e
...
> <Array(<EzsigndocumentEndPrematurelyV1Response>, Integer, Hash)> ezsigndocument_end_prematurely_v1_with_http_info(pki_ezsigndocument_id)

```ruby
begin
  # End prematurely
  data, status_code, headers = api_instance.ezsigndocument_end_prematurely_v1_with_http_info(pki_ezsigndocument_id)
  p status_code # => 2xx
  p headers # => { ... }
