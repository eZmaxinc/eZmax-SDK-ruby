# EzmaxApi::EzsigntemplateglobalannotationResponseCompound
...
| **i_ezsigntemplateglobaldocumentpage_pagenumber** | **Integer** | The page number in the Ezsigntemplateglobaldocument |  |
...
instance = EzmaxApi::EzsigntemplateglobalannotationResponseCompound.new(
  ...
  i_ezsigntemplateglobaldocumentpage_pagenumber: 1,
