# EzmaxApi::EzsignfoldersignerassociationCreateEmbeddedUrlV2Request
...
| **s_iframe_origin** | **String** | This is used to fill the header frame ancestor to allow the application to embed the Ezsign signature page | [optional] |
...
instance = EzmaxApi::EzsignfoldersignerassociationCreateEmbeddedUrlV2Request.new(
  s_return_url: https://www.example.com,
  s_iframe_origin: https://www.example.com
)
```
