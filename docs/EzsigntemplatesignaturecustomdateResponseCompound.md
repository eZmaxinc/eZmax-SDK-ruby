# EzmaxApi::EzsigntemplatesignaturecustomdateResponseCompound

## Properties

| Name | Type | Description | Notes |
| ---- | ---- | ----------- | ----- |
| **pki_ezsigntemplatesignaturecustomdate_id** | **Integer** | The unique ID of the Ezsigntemplatesignaturecustomdate |  |
...
| **i_ezsigntemplatesignaturecustomdate_y** | **Integer** | The Y coordinate (Vertical) where to put the Ezsigntemplatesignaturecustomdate on the page.  Coordinate is calculated at 100dpi (dot per inch). So for example, if you want to put the Ezsigntemplatesignaturecustomdate 3 inches from the top border of the page, you would use \&quot;300\&quot; for the Y coordinate. |  |
...
instance = EzmaxApi::EzsigntemplatesignaturecustomdateResponseCompound.new(
