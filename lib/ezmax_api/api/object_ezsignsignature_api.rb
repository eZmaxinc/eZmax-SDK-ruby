...
module EzmaxApi
  class ObjectEzsignsignatureApi
    ...
    def ezsignsignature_get_children_v1(pki_ezsignsignature_id, opts = {})
      ezsignsignature_get_children_v1_with_http_info(pki_ezsignsignature_id, opts)
      nil
    end
    ...
    def ezsignsignature_get_children_v1_with_http_info(pki_ezsignsignature_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignsignatureApi.ezsignsignature_get_children_v1 ...'
      end
      # verify the required parameter 'pki_ezsignsignature_id' is set
      if @api_client.config.client_side_validation && pki_ezsignsignature_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignsignature_id' when calling ObjectEzsignsignatureApi.ezsignsignature_get_children_v1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ObjectEzsignsignatureApi.ezsignsignature_get_children_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignsignatureApi#ezsignsignature_get_children_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
