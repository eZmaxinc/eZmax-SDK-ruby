...
module EzmaxApi
  class ObjectEzsignfoldersignerassociationApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def ezsignfoldersignerassociation_get_object_get_children_v1(pki_ezsignfoldersignerassociation_id, opts = {})
      ezsignfoldersignerassociation_get_object_get_children_v1_with_http_info(pki_ezsignfoldersignerassociation_id, opts)
      nil
    end
    ...
    def ezsignfoldersignerassociation_get_object_get_children_v1_with_http_info(pki_ezsignfoldersignerassociation_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociation_get_object_get_children_v1 ...'
      end
      # verify the required parameter 'pki_ezsignfoldersignerassociation_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfoldersignerassociation_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfoldersignerassociation_id' when calling ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociation_get_object_get_children_v1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ObjectEzsignfoldersignerassociationApi.ezsignfoldersignerassociation_get_object_get_children_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfoldersignerassociationApi#ezsignfoldersignerassociation_get_object_get_children_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
