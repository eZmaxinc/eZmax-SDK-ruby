  ...
  class ObjectFranchiseofficeApi
    ...
    def franchiseoffice_get_autocomplete_v1_with_http_info(s_selector, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectFranchiseofficeApi.franchiseoffice_get_autocomplete_v1 ...'
      end
      # verify the required parameter 's_selector' is set
      if @api_client.config.client_side_validation && s_selector.nil?
        fail ArgumentError, "Missing the required parameter 's_selector' when calling ObjectFranchiseofficeApi.franchiseoffice_get_autocomplete_v1"
      end
      # verify enum value
      ...
      # resource path
      local_var_path = '/1/object/franchiseoffice/getAutocomplete/{sSelector}'.sub('{' + 'sSelector' + '}', CGI.escape(s_selector.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ObjectFranchiseofficeApi.franchiseoffice_get_autocomplete_v1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectFranchiseofficeApi#franchiseoffice_get_autocomplete_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
