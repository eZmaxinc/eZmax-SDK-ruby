...
module EzmaxApi
  class ObjectEzsignfolderApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def ezsignfolder_get_object_get_children_v1(pki_ezsignfolder_id, opts = {})
      ezsignfolder_get_object_get_children_v1_with_http_info(pki_ezsignfolder_id, opts)
      nil
    end
    ...
    def ezsignfolder_get_object_get_children_v1_with_http_info(pki_ezsignfolder_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_get_object_get_children_v1 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_get_object_get_children_v1"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_get_object_get_children_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_get_object_get_children_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
