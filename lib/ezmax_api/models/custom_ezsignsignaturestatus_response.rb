...
module EzmaxApi
  ...
  class CustomEzsignsignaturestatusResponse
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomEzsignsignaturestatusResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [e_ezsignsignaturestatus_steptype, i_ezsignsignaturestatus_step, i_ezsignsignaturestatus_total, i_ezsignsignaturestatus_signed].hash
    end
