...
module EzmaxApi
  ...
  class EzsignfolderGetObjectV1ResponseMPayload
    ...
    attr_accessor :dt_ezsignfolder_scheduleddestruction
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignfolderGetObjectV1ResponseMPayload` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignfolderGetObjectV1ResponseMPayload`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dt_ezsignfolder_scheduleddestruction')
        self.dt_ezsignfolder_scheduleddestruction = attributes[:'dt_ezsignfolder_scheduleddestruction']
      end
    ...
    def list_invalid_properties
      ...
      if @dt_ezsignfolder_duedate.nil?
        invalid_properties.push('invalid value for "dt_ezsignfolder_duedate", dt_ezsignfolder_duedate cannot be nil.')
      end

      if @dt_ezsignfolder_scheduledarchive.nil?
        invalid_properties.push('invalid value for "dt_ezsignfolder_scheduledarchive", dt_ezsignfolder_scheduledarchive cannot be nil.')
      end

      if @dt_ezsignfolder_scheduleddestruction.nil?
        invalid_properties.push('invalid value for "dt_ezsignfolder_scheduleddestruction", dt_ezsignfolder_scheduleddestruction cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @dt_ezsignfolder_duedate.nil?
      return false if @dt_ezsignfolder_scheduledarchive.nil?
      return false if @dt_ezsignfolder_scheduleddestruction.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dt_ezsignfolder_scheduleddestruction == o.dt_ezsignfolder_scheduleddestruction &&
    ...
    def hash
      [pki_ezsignfolder_id, fki_ezsignfoldertype_id, s_ezsignfoldertype_name_x, fki_billingentityinternal_id, s_billingentityinternal_description_x, fki_ezsigntsarequirement_id, s_ezsigntsarequirement_description_x, s_ezsignfolder_description, t_ezsignfolder_note, e_ezsignfolder_sendreminderfrequency, dt_ezsignfolder_duedate, dt_ezsignfolder_sentdate, dt_ezsignfolder_scheduledarchive, dt_ezsignfolder_scheduleddestruction, e_ezsignfolder_step, dt_ezsignfolder_close, obj_audit].hash
    end
