...
module EzmaxApi
  ...
  class ActivesessionResponseCompoundUser
    ...
    def list_invalid_properties
      ...
      if @s_avatar_url.nil?
        invalid_properties.push('invalid value for "s_avatar_url", s_avatar_url cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @s_avatar_url.nil?
    ...
    def hash
      [pki_user_id, s_avatar_url, s_user_firstname, s_user_lastname, s_email_address].hash
    end
