  ...
  class EzsigndocumentRequest
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'s_ezsigndocument_password')
        ...
        self.s_ezsigndocument_password = ''
      end
    ...
    def hash
      [e_ezsigndocument_source, e_ezsigndocument_format, s_ezsigndocument_base64, s_ezsigndocument_password, fki_ezsignfolder_id, dt_ezsigndocument_duedate, fki_language_id, s_ezsigndocument_name].hash
    end
