...
module EzmaxApi
  ...
  class EzsigndocumentRequestCompound
    ...
    def hash
      [e_ezsigndocument_source, e_ezsigndocument_format, s_ezsigndocument_base64, fki_ezsignfolder_id, dt_ezsigndocument_duedate, fki_language_id, s_ezsigndocument_filename, s_ezsigndocument_name].hash
    end
