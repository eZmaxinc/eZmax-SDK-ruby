...
module EzmaxApi
  ...
  class EzsignfoldersignerassociationRequest
    ...
    def list_invalid_properties
      ...
      if !@fki_user_id.nil? && @fki_user_id < 1
        invalid_properties.push('invalid value for "fki_user_id", must be greater than or equal to 1.')
      end
    ...
    def valid?
      return false if !@fki_user_id.nil? && @fki_user_id < 1
    ...
    def fki_user_id=(fki_user_id)
      if !fki_user_id.nil? && fki_user_id < 1
        fail ArgumentError, 'invalid value for "fki_user_id", must be greater than or equal to 1.'
      end
    ...
    def hash
      [fki_user_id, fki_ezsignfolder_id].hash
    end
