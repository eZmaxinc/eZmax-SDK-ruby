...
module EzmaxApi
  ...
  class EzsignsignatureRequestCompound
    ...
    def valid?
      ...
      e_ezsignsignature_type_validator = EnumAttributeValidator.new('String', ["Acknowledgement", "Handwritten", "Initials", "Name"])
      return false unless e_ezsignsignature_type_validator.valid?(@e_ezsignsignature_type)
      return false if @fki_ezsigndocument_id.nil?
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] e_ezsignsignature_type Object to be assigned
    def e_ezsignsignature_type=(e_ezsignsignature_type)
      validator = EnumAttributeValidator.new('String', ["Acknowledgement", "Handwritten", "Initials", "Name"])
      unless validator.valid?(e_ezsignsignature_type)
        fail ArgumentError, "invalid value for \"e_ezsignsignature_type\", must be one of #{validator.allowable_values}."
      end
