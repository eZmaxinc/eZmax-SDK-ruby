...
module EzmaxApi
  ...
  class ApikeyResponse
    ...
    attr_accessor :s_computed_token
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'s_computed_token')
        self.s_computed_token = attributes[:'s_computed_token']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          s_computed_token == o.s_computed_token &&
    ...
    def hash
      [obj_apikey_description, s_computed_token, pki_apikey_id, obj_audit].hash
    end
