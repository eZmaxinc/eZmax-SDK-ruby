  ...
  class AuthenticateAuthenticateV2Request
    ...
    def self.attribute_map
      {
        ...
        :'s_password_encrypted' => :'sPasswordEncrypted'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::AuthenticateAuthenticateV2Request` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::AuthenticateAuthenticateV2Request`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_password')
        self.s_password = attributes[:'s_password']
      end

      if attributes.key?(:'s_password_encrypted')
        self.s_password_encrypted = attributes[:'s_password_encrypted']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          s_password == o.s_password &&
          s_password_encrypted == o.s_password_encrypted
    end
    ...
    def hash
      [pks_customer_code, s_email_address, s_user_loginname, s_password, s_password_encrypted].hash
    end
