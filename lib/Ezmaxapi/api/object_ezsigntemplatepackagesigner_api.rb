...
module EzmaxApi
  class ObjectEzsigntemplatepackagesignerApi
    ...
    # Create a new Ezsigntemplatepackagesigner
    # The endpoint allows to create one or many elements at once.
    # @param ezsigntemplatepackagesigner_create_object_v2_request [EzsigntemplatepackagesignerCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsigntemplatepackagesignerCreateObjectV2Response]
    def ezsigntemplatepackagesigner_create_object_v2(ezsigntemplatepackagesigner_create_object_v2_request, opts = {})
      data, _status_code, _headers = ezsigntemplatepackagesigner_create_object_v2_with_http_info(ezsigntemplatepackagesigner_create_object_v2_request, opts)
      data
    end
    ...
    # @param ezsigntemplatepackagesigner_create_object_v2_request [EzsigntemplatepackagesignerCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatepackagesignerCreateObjectV2Response, Integer, Hash)>] EzsigntemplatepackagesignerCreateObjectV2Response data, response status code and response headers
    def ezsigntemplatepackagesigner_create_object_v2_with_http_info(ezsigntemplatepackagesigner_create_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_create_object_v2 ...'
      end
      # verify the required parameter 'ezsigntemplatepackagesigner_create_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsigntemplatepackagesigner_create_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsigntemplatepackagesigner_create_object_v2_request' when calling ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_create_object_v2"
      end
      # resource path
      local_var_path = '/2/object/ezsigntemplatepackagesigner'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsigntemplatepackagesigner_create_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatepackagesignerCreateObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_create_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatepackagesignerApi#ezsigntemplatepackagesigner_create_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # 
    # @param pki_ezsigntemplatepackagesigner_id [Integer] 
    # @param ezsigntemplatepackagesigner_edit_object_v2_request [EzsigntemplatepackagesignerEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsigntemplatepackagesignerEditObjectV2Response]
    def ezsigntemplatepackagesigner_edit_object_v2(pki_ezsigntemplatepackagesigner_id, ezsigntemplatepackagesigner_edit_object_v2_request, opts = {})
      data, _status_code, _headers = ezsigntemplatepackagesigner_edit_object_v2_with_http_info(pki_ezsigntemplatepackagesigner_id, ezsigntemplatepackagesigner_edit_object_v2_request, opts)
      data
    end
    ...
    # @param ezsigntemplatepackagesigner_edit_object_v2_request [EzsigntemplatepackagesignerEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatepackagesignerEditObjectV2Response, Integer, Hash)>] EzsigntemplatepackagesignerEditObjectV2Response data, response status code and response headers
    def ezsigntemplatepackagesigner_edit_object_v2_with_http_info(pki_ezsigntemplatepackagesigner_id, ezsigntemplatepackagesigner_edit_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_edit_object_v2 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatepackagesigner_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatepackagesigner_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatepackagesigner_id' when calling ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_edit_object_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatepackagesigner_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatepackagesigner_id" when calling ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_edit_object_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsigntemplatepackagesigner_edit_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsigntemplatepackagesigner_edit_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsigntemplatepackagesigner_edit_object_v2_request' when calling ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_edit_object_v2"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsigntemplatepackagesigner_edit_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatepackagesignerEditObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_edit_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatepackagesignerApi#ezsigntemplatepackagesigner_edit_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsigntemplatepackagesigner_get_object_v3(pki_ezsigntemplatepackagesigner_id, opts = {})
      data, _status_code, _headers = ezsigntemplatepackagesigner_get_object_v3_with_http_info(pki_ezsigntemplatepackagesigner_id, opts)
      data
    end
    ...
    # @param pki_ezsigntemplatepackagesigner_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatepackagesignerGetObjectV3Response, Integer, Hash)>] EzsigntemplatepackagesignerGetObjectV3Response data, response status code and response headers
    def ezsigntemplatepackagesigner_get_object_v3_with_http_info(pki_ezsigntemplatepackagesigner_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_get_object_v3 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatepackagesigner_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatepackagesigner_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatepackagesigner_id' when calling ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_get_object_v3"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatepackagesigner_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatepackagesigner_id" when calling ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_get_object_v3, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/3/object/ezsigntemplatepackagesigner/{pkiEzsigntemplatepackagesignerID}'.sub('{pkiEzsigntemplatepackagesignerID}', CGI.escape(pki_ezsigntemplatepackagesigner_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatepackagesignerGetObjectV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatepackagesignerApi.ezsigntemplatepackagesigner_get_object_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatepackagesignerApi#ezsigntemplatepackagesigner_get_object_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
