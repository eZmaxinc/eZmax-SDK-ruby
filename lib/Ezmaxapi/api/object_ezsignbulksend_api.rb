...
module EzmaxApi
  class ObjectEzsignbulksendApi
    ...
    # Create a new Ezsignbulksend
    # The endpoint allows to create one or many elements at once.
    # @param ezsignbulksend_create_object_v2_request [EzsignbulksendCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignbulksendCreateObjectV2Response]
    def ezsignbulksend_create_object_v2(ezsignbulksend_create_object_v2_request, opts = {})
      data, _status_code, _headers = ezsignbulksend_create_object_v2_with_http_info(ezsignbulksend_create_object_v2_request, opts)
      data
    end
    ...
    # @param ezsignbulksend_create_object_v2_request [EzsignbulksendCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignbulksendCreateObjectV2Response, Integer, Hash)>] EzsignbulksendCreateObjectV2Response data, response status code and response headers
    def ezsignbulksend_create_object_v2_with_http_info(ezsignbulksend_create_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignbulksendApi.ezsignbulksend_create_object_v2 ...'
      end
      # verify the required parameter 'ezsignbulksend_create_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsignbulksend_create_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignbulksend_create_object_v2_request' when calling ObjectEzsignbulksendApi.ezsignbulksend_create_object_v2"
      end
      # resource path
      local_var_path = '/2/object/ezsignbulksend'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignbulksend_create_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignbulksendCreateObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignbulksendApi.ezsignbulksend_create_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignbulksendApi#ezsignbulksend_create_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # 
    # @param pki_ezsignbulksend_id [Integer] 
    # @param ezsignbulksend_edit_object_v2_request [EzsignbulksendEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignbulksendEditObjectV2Response]
    def ezsignbulksend_edit_object_v2(pki_ezsignbulksend_id, ezsignbulksend_edit_object_v2_request, opts = {})
      data, _status_code, _headers = ezsignbulksend_edit_object_v2_with_http_info(pki_ezsignbulksend_id, ezsignbulksend_edit_object_v2_request, opts)
      data
    end
    ...
    # @param ezsignbulksend_edit_object_v2_request [EzsignbulksendEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignbulksendEditObjectV2Response, Integer, Hash)>] EzsignbulksendEditObjectV2Response data, response status code and response headers
    def ezsignbulksend_edit_object_v2_with_http_info(pki_ezsignbulksend_id, ezsignbulksend_edit_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignbulksendApi.ezsignbulksend_edit_object_v2 ...'
      end
      # verify the required parameter 'pki_ezsignbulksend_id' is set
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignbulksend_id' when calling ObjectEzsignbulksendApi.ezsignbulksend_edit_object_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignbulksend_id" when calling ObjectEzsignbulksendApi.ezsignbulksend_edit_object_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsignbulksend_edit_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsignbulksend_edit_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignbulksend_edit_object_v2_request' when calling ObjectEzsignbulksendApi.ezsignbulksend_edit_object_v2"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignbulksend_edit_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignbulksendEditObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignbulksendApi.ezsignbulksend_edit_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignbulksendApi#ezsignbulksend_edit_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param pki_ezsignbulksend_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @option opts [Boolean] :b_include_signed Include final document once all signatures were applied
    # @option opts [Boolean] :b_include_attachment Include attached files in signatures
    # @option opts [Boolean] :b_include_proofdocument Include the evidence report
    # @option opts [Boolean] :b_include_proof include the complete evidence archive including all of the above and more
    # @return [File]
    def ezsignbulksend_get_batch_file_v1(pki_ezsignbulksend_id, opts = {})
      data, _status_code, _headers = ezsignbulksend_get_batch_file_v1_with_http_info(pki_ezsignbulksend_id, opts)
      data
    end
    ...
    def ezsignbulksend_get_batch_file_v1_with_http_info(pki_ezsignbulksend_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignbulksendApi.ezsignbulksend_get_batch_file_v1 ...'
      end
      # verify the required parameter 'pki_ezsignbulksend_id' is set
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignbulksend_id' when calling ObjectEzsignbulksendApi.ezsignbulksend_get_batch_file_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignbulksend_id" when calling ObjectEzsignbulksendApi.ezsignbulksend_get_batch_file_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/ezsignbulksend/{pkiEzsignbulksendID}/getBatchFile'.sub('{pkiEzsignbulksendID}', CGI.escape(pki_ezsignbulksend_id.to_s))

      # query parameters
      query_params = opts[:query_params] || {}
      query_params[:'bIncludeSigned'] = opts[:'b_include_signed'] if !opts[:'b_include_signed'].nil?
      query_params[:'bIncludeAttachment'] = opts[:'b_include_attachment'] if !opts[:'b_include_attachment'].nil?
      query_params[:'bIncludeProofdocument'] = opts[:'b_include_proofdocument'] if !opts[:'b_include_proofdocument'].nil?
      query_params[:'bIncludeProof'] = opts[:'b_include_proof'] if !opts[:'b_include_proof'].nil?

      # header parameters
      header_params = opts[:header_params] || {}
      # HTTP header 'Accept' (if needed)
      header_params['Accept'] = @api_client.select_header_accept(['text/xml', 'application/json']) unless header_params['Accept']
      ...
      new_options = opts.merge(
        :operation => :"ObjectEzsignbulksendApi.ezsignbulksend_get_batch_file_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignbulksendApi#ezsignbulksend_get_batch_file_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignbulksend_get_object_v3(pki_ezsignbulksend_id, opts = {})
      data, _status_code, _headers = ezsignbulksend_get_object_v3_with_http_info(pki_ezsignbulksend_id, opts)
      data
    end
    ...
    # @param pki_ezsignbulksend_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignbulksendGetObjectV3Response, Integer, Hash)>] EzsignbulksendGetObjectV3Response data, response status code and response headers
    def ezsignbulksend_get_object_v3_with_http_info(pki_ezsignbulksend_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignbulksendApi.ezsignbulksend_get_object_v3 ...'
      end
      # verify the required parameter 'pki_ezsignbulksend_id' is set
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignbulksend_id' when calling ObjectEzsignbulksendApi.ezsignbulksend_get_object_v3"
      end
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignbulksend_id" when calling ObjectEzsignbulksendApi.ezsignbulksend_get_object_v3, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/3/object/ezsignbulksend/{pkiEzsignbulksendID}'.sub('{pkiEzsignbulksendID}', CGI.escape(pki_ezsignbulksend_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignbulksendGetObjectV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignbulksendApi.ezsignbulksend_get_object_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignbulksendApi#ezsignbulksend_get_object_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignbulksend_get_object_v4(pki_ezsignbulksend_id, opts = {})
      data, _status_code, _headers = ezsignbulksend_get_object_v4_with_http_info(pki_ezsignbulksend_id, opts)
      data
    end
    ...
    # @param pki_ezsignbulksend_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignbulksendGetObjectV4Response, Integer, Hash)>] EzsignbulksendGetObjectV4Response data, response status code and response headers
    def ezsignbulksend_get_object_v4_with_http_info(pki_ezsignbulksend_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignbulksendApi.ezsignbulksend_get_object_v4 ...'
      end
      # verify the required parameter 'pki_ezsignbulksend_id' is set
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignbulksend_id' when calling ObjectEzsignbulksendApi.ezsignbulksend_get_object_v4"
      end
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignbulksend_id" when calling ObjectEzsignbulksendApi.ezsignbulksend_get_object_v4, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/4/object/ezsignbulksend/{pkiEzsignbulksendID}'.sub('{pkiEzsignbulksendID}', CGI.escape(pki_ezsignbulksend_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignbulksendGetObjectV4Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignbulksendApi.ezsignbulksend_get_object_v4",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignbulksendApi#ezsignbulksend_get_object_v4\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
