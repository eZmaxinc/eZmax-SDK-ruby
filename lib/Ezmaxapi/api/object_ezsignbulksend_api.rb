...
module EzmaxApi
  class ObjectEzsignbulksendApi
    ...
    # @param ezsignbulksend_create_ezsignbulksendtransmission_v1_request [EzsignbulksendCreateEzsignbulksendtransmissionV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignbulksendCreateEzsignbulksendtransmissionV1Response]
    def ezsignbulksend_create_ezsignbulksendtransmission_v1(pki_ezsignbulksend_id, ezsignbulksend_create_ezsignbulksendtransmission_v1_request, opts = {})
      data, _status_code, _headers = ezsignbulksend_create_ezsignbulksendtransmission_v1_with_http_info(pki_ezsignbulksend_id, ezsignbulksend_create_ezsignbulksendtransmission_v1_request, opts)
      data
    end
    ...
    # @param ezsignbulksend_create_ezsignbulksendtransmission_v1_request [EzsignbulksendCreateEzsignbulksendtransmissionV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignbulksendCreateEzsignbulksendtransmissionV1Response, Integer, Hash)>] EzsignbulksendCreateEzsignbulksendtransmissionV1Response data, response status code and response headers
    def ezsignbulksend_create_ezsignbulksendtransmission_v1_with_http_info(pki_ezsignbulksend_id, ezsignbulksend_create_ezsignbulksendtransmission_v1_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignbulksendApi.ezsignbulksend_create_ezsignbulksendtransmission_v1 ...'
      end
      ...
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignbulksend_id' when calling ObjectEzsignbulksendApi.ezsignbulksend_create_ezsignbulksendtransmission_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsignbulksend_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignbulksend_id" when calling ObjectEzsignbulksendApi.ezsignbulksend_create_ezsignbulksendtransmission_v1, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsignbulksend_create_ezsignbulksendtransmission_v1_request' is set
      if @api_client.config.client_side_validation && ezsignbulksend_create_ezsignbulksendtransmission_v1_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignbulksend_create_ezsignbulksendtransmission_v1_request' when calling ObjectEzsignbulksendApi.ezsignbulksend_create_ezsignbulksendtransmission_v1"
      end
      # resource path
      local_var_path = '/1/object/ezsignbulksend/{pkiEzsignbulksendID}/createEzsignbulksendtransmission'.sub('{' + 'pkiEzsignbulksendID' + '}', CGI.escape(pki_ezsignbulksend_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignbulksend_create_ezsignbulksendtransmission_v1_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignbulksendCreateEzsignbulksendtransmissionV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignbulksendApi.ezsignbulksend_create_ezsignbulksendtransmission_v1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignbulksendApi#ezsignbulksend_create_ezsignbulksendtransmission_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
