...
module EzmaxApi
  class ObjectEzsigntemplateApi
    ...
    def ezsigntemplate_get_object_v4(pki_ezsigntemplate_id, opts = {})
      data, _status_code, _headers = ezsigntemplate_get_object_v4_with_http_info(pki_ezsigntemplate_id, opts)
      data
    end
    ...
    # @param pki_ezsigntemplate_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplateGetObjectV4Response, Integer, Hash)>] EzsigntemplateGetObjectV4Response data, response status code and response headers
    def ezsigntemplate_get_object_v4_with_http_info(pki_ezsigntemplate_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplateApi.ezsigntemplate_get_object_v4 ...'
      end
      # verify the required parameter 'pki_ezsigntemplate_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplate_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplate_id' when calling ObjectEzsigntemplateApi.ezsigntemplate_get_object_v4"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplate_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplate_id" when calling ObjectEzsigntemplateApi.ezsigntemplate_get_object_v4, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/4/object/ezsigntemplate/{pkiEzsigntemplateID}'.sub('{pkiEzsigntemplateID}', CGI.escape(pki_ezsigntemplate_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplateGetObjectV4Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplateApi.ezsigntemplate_get_object_v4",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplateApi#ezsigntemplate_get_object_v4\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
