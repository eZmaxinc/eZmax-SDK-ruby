...
module EzmaxApi
  class ObjectEzsigntemplateApi
    ...
    # Create a new Ezsigntemplate
    # The endpoint allows to create one or many elements at once.
    # @param ezsigntemplate_create_object_v2_request [EzsigntemplateCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsigntemplateCreateObjectV2Response]
    def ezsigntemplate_create_object_v2(ezsigntemplate_create_object_v2_request, opts = {})
      data, _status_code, _headers = ezsigntemplate_create_object_v2_with_http_info(ezsigntemplate_create_object_v2_request, opts)
      data
    end
    ...
    # @param ezsigntemplate_create_object_v2_request [EzsigntemplateCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplateCreateObjectV2Response, Integer, Hash)>] EzsigntemplateCreateObjectV2Response data, response status code and response headers
    def ezsigntemplate_create_object_v2_with_http_info(ezsigntemplate_create_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplateApi.ezsigntemplate_create_object_v2 ...'
      end
      # verify the required parameter 'ezsigntemplate_create_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsigntemplate_create_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsigntemplate_create_object_v2_request' when calling ObjectEzsigntemplateApi.ezsigntemplate_create_object_v2"
      end
      # resource path
      local_var_path = '/2/object/ezsigntemplate'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsigntemplate_create_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplateCreateObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplateApi.ezsigntemplate_create_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplateApi#ezsigntemplate_create_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # 
    # @param pki_ezsigntemplate_id [Integer] 
    # @param ezsigntemplate_edit_object_v2_request [EzsigntemplateEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsigntemplateEditObjectV2Response]
    def ezsigntemplate_edit_object_v2(pki_ezsigntemplate_id, ezsigntemplate_edit_object_v2_request, opts = {})
      data, _status_code, _headers = ezsigntemplate_edit_object_v2_with_http_info(pki_ezsigntemplate_id, ezsigntemplate_edit_object_v2_request, opts)
      data
    end
    ...
    # @param ezsigntemplate_edit_object_v2_request [EzsigntemplateEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplateEditObjectV2Response, Integer, Hash)>] EzsigntemplateEditObjectV2Response data, response status code and response headers
    def ezsigntemplate_edit_object_v2_with_http_info(pki_ezsigntemplate_id, ezsigntemplate_edit_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplateApi.ezsigntemplate_edit_object_v2 ...'
      end
      # verify the required parameter 'pki_ezsigntemplate_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplate_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplate_id' when calling ObjectEzsigntemplateApi.ezsigntemplate_edit_object_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplate_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplate_id" when calling ObjectEzsigntemplateApi.ezsigntemplate_edit_object_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsigntemplate_edit_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsigntemplate_edit_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsigntemplate_edit_object_v2_request' when calling ObjectEzsigntemplateApi.ezsigntemplate_edit_object_v2"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsigntemplate_edit_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplateEditObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplateApi.ezsigntemplate_edit_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplateApi#ezsigntemplate_edit_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
