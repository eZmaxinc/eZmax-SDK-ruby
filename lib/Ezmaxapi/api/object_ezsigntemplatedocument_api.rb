...
module EzmaxApi
  class ObjectEzsigntemplatedocumentApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [nil]
    def ezsigntemplatedocument_download_v1(pki_ezsigntemplatedocument_id, opts = {})
      ezsigntemplatedocument_download_v1_with_http_info(pki_ezsigntemplatedocument_id, opts)
      nil
    end
    ...
    def ezsigntemplatedocument_download_v1_with_http_info(pki_ezsigntemplatedocument_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_download_v1 ...'
      end
      ...
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_download_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatedocument_id" when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_download_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/download'.sub('{pkiEzsigntemplatedocumentID}', CGI.escape(pki_ezsigntemplatedocument_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_download_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatedocumentApi#ezsigntemplatedocument_download_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param pki_ezsigntemplatedocument_id [Integer] 
    # @param ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request [EzsigntemplatedocumentEditEzsigntemplateannotationsV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsigntemplatedocumentEditEzsigntemplateannotationsV1Response]
    def ezsigntemplatedocument_edit_ezsigntemplateannotations_v1(pki_ezsigntemplatedocument_id, ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request, opts = {})
      data, _status_code, _headers = ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_with_http_info(pki_ezsigntemplatedocument_id, ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request, opts)
      data
    end
    ...
    # @param ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request [EzsigntemplatedocumentEditEzsigntemplateannotationsV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatedocumentEditEzsigntemplateannotationsV1Response, Integer, Hash)>] EzsigntemplatedocumentEditEzsigntemplateannotationsV1Response data, response status code and response headers
    def ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_with_http_info(pki_ezsigntemplatedocument_id, ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplateannotations_v1 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplateannotations_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatedocument_id" when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplateannotations_v1, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request' is set
      if @api_client.config.client_side_validation && ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request' when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplateannotations_v1"
      end
      # resource path
      local_var_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplateannotations'.sub('{pkiEzsigntemplatedocumentID}', CGI.escape(pki_ezsigntemplatedocument_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsigntemplatedocument_edit_ezsigntemplateannotations_v1_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatedocumentEditEzsigntemplateannotationsV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplateannotations_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatedocumentApi#ezsigntemplatedocument_edit_ezsigntemplateannotations_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param pki_ezsigntemplatedocument_id [Integer] 
    # @param ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request [EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Response]
    def ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2(pki_ezsigntemplatedocument_id, ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request, opts = {})
      data, _status_code, _headers = ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_with_http_info(pki_ezsigntemplatedocument_id, ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request, opts)
      data
    end
    ...
    # @param ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request [EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Response, Integer, Hash)>] EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Response data, response status code and response headers
    def ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_with_http_info(pki_ezsigntemplatedocument_id, ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatedocument_id" when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request' is set
      if @api_client.config.client_side_validation && ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request' when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2"
      end
      # resource path
      local_var_path = '/2/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/editEzsigntemplatesignatures'.sub('{pkiEzsigntemplatedocumentID}', CGI.escape(pki_ezsigntemplatedocument_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatedocumentEditEzsigntemplatesignaturesV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatedocumentApi#ezsigntemplatedocument_edit_ezsigntemplatesignatures_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsigntemplatedocument_get_ezsigntemplateannotations_v1(pki_ezsigntemplatedocument_id, opts = {})
      data, _status_code, _headers = ezsigntemplatedocument_get_ezsigntemplateannotations_v1_with_http_info(pki_ezsigntemplatedocument_id, opts)
      data
    end
    ...
    # @param pki_ezsigntemplatedocument_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatedocumentGetEzsigntemplateannotationsV1Response, Integer, Hash)>] EzsigntemplatedocumentGetEzsigntemplateannotationsV1Response data, response status code and response headers
    def ezsigntemplatedocument_get_ezsigntemplateannotations_v1_with_http_info(pki_ezsigntemplatedocument_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_get_ezsigntemplateannotations_v1 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_get_ezsigntemplateannotations_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatedocument_id" when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_get_ezsigntemplateannotations_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getEzsigntemplateannotations'.sub('{pkiEzsigntemplatedocumentID}', CGI.escape(pki_ezsigntemplatedocument_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatedocumentGetEzsigntemplateannotationsV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_get_ezsigntemplateannotations_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatedocumentApi#ezsigntemplatedocument_get_ezsigntemplateannotations_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsigntemplatedocument_get_ezsigntemplatesignatures_v2(pki_ezsigntemplatedocument_id, opts = {})
      data, _status_code, _headers = ezsigntemplatedocument_get_ezsigntemplatesignatures_v2_with_http_info(pki_ezsigntemplatedocument_id, opts)
      data
    end
    ...
    # @param pki_ezsigntemplatedocument_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatedocumentGetEzsigntemplatesignaturesV2Response, Integer, Hash)>] EzsigntemplatedocumentGetEzsigntemplatesignaturesV2Response data, response status code and response headers
    def ezsigntemplatedocument_get_ezsigntemplatesignatures_v2_with_http_info(pki_ezsigntemplatedocument_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_get_ezsigntemplatesignatures_v2 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatedocument_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatedocument_id' when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_get_ezsigntemplatesignatures_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatedocument_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatedocument_id" when calling ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_get_ezsigntemplatesignatures_v2, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/2/object/ezsigntemplatedocument/{pkiEzsigntemplatedocumentID}/getEzsigntemplatesignatures'.sub('{pkiEzsigntemplatedocumentID}', CGI.escape(pki_ezsigntemplatedocument_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatedocumentGetEzsigntemplatesignaturesV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatedocumentApi.ezsigntemplatedocument_get_ezsigntemplatesignatures_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatedocumentApi#ezsigntemplatedocument_get_ezsigntemplatesignatures_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
