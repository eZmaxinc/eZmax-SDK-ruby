...
module EzmaxApi
  class ObjectEzmaxinvoicingApi
    ...
    def ezmaxinvoicing_get_autocomplete_v1(s_selector, opts = {})
      data, _status_code, _headers = ezmaxinvoicing_get_autocomplete_v1_with_http_info(s_selector, opts)
      data
    end
    ...
    def ezmaxinvoicing_get_autocomplete_v1_with_http_info(s_selector, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzmaxinvoicingApi.ezmaxinvoicing_get_autocomplete_v1 ...'
      end
      # verify the required parameter 's_selector' is set
      if @api_client.config.client_side_validation && s_selector.nil?
        fail ArgumentError, "Missing the required parameter 's_selector' when calling ObjectEzmaxinvoicingApi.ezmaxinvoicing_get_autocomplete_v1"
      end
      # verify enum value
      ...
      # resource path
      local_var_path = '/1/object/ezmaxinvoicing/getAutocomplete/{sSelector}'.sub('{' + 'sSelector' + '}', CGI.escape(s_selector.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ObjectEzmaxinvoicingApi.ezmaxinvoicing_get_autocomplete_v1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzmaxinvoicingApi#ezmaxinvoicing_get_autocomplete_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
