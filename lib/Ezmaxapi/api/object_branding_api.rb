...
module EzmaxApi
  class ObjectBrandingApi
    ...
    # @param branding_create_object_v2_request [BrandingCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [BrandingCreateObjectV2Response]
    def branding_create_object_v2(branding_create_object_v2_request, opts = {})
      data, _status_code, _headers = branding_create_object_v2_with_http_info(branding_create_object_v2_request, opts)
      data
    end
    ...
    # @param branding_create_object_v2_request [BrandingCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(BrandingCreateObjectV2Response, Integer, Hash)>] BrandingCreateObjectV2Response data, response status code and response headers
    def branding_create_object_v2_with_http_info(branding_create_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectBrandingApi.branding_create_object_v2 ...'
      end
      # verify the required parameter 'branding_create_object_v2_request' is set
      if @api_client.config.client_side_validation && branding_create_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'branding_create_object_v2_request' when calling ObjectBrandingApi.branding_create_object_v2"
      end
      # resource path
      local_var_path = '/2/object/branding'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(branding_create_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'BrandingCreateObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectBrandingApi.branding_create_object_v2",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectBrandingApi#branding_create_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # @param branding_edit_object_v2_request [BrandingEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [BrandingEditObjectV2Response]
    def branding_edit_object_v2(pki_branding_id, branding_edit_object_v2_request, opts = {})
      data, _status_code, _headers = branding_edit_object_v2_with_http_info(pki_branding_id, branding_edit_object_v2_request, opts)
      data
    end
    ...
    # @param branding_edit_object_v2_request [BrandingEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(BrandingEditObjectV2Response, Integer, Hash)>] BrandingEditObjectV2Response data, response status code and response headers
    def branding_edit_object_v2_with_http_info(pki_branding_id, branding_edit_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectBrandingApi.branding_edit_object_v2 ...'
      end
      # verify the required parameter 'pki_branding_id' is set
      if @api_client.config.client_side_validation && pki_branding_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_branding_id' when calling ObjectBrandingApi.branding_edit_object_v2"
      end
      if @api_client.config.client_side_validation && pki_branding_id < 0
        fail ArgumentError, 'invalid value for "pki_branding_id" when calling ObjectBrandingApi.branding_edit_object_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'branding_edit_object_v2_request' is set
      if @api_client.config.client_side_validation && branding_edit_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'branding_edit_object_v2_request' when calling ObjectBrandingApi.branding_edit_object_v2"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(branding_edit_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'BrandingEditObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectBrandingApi.branding_edit_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectBrandingApi#branding_edit_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def branding_get_object_v3(pki_branding_id, opts = {})
      data, _status_code, _headers = branding_get_object_v3_with_http_info(pki_branding_id, opts)
      data
    end
    ...
    # @param pki_branding_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(BrandingGetObjectV3Response, Integer, Hash)>] BrandingGetObjectV3Response data, response status code and response headers
    def branding_get_object_v3_with_http_info(pki_branding_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectBrandingApi.branding_get_object_v3 ...'
      end
      # verify the required parameter 'pki_branding_id' is set
      if @api_client.config.client_side_validation && pki_branding_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_branding_id' when calling ObjectBrandingApi.branding_get_object_v3"
      end
      if @api_client.config.client_side_validation && pki_branding_id < 0
        fail ArgumentError, 'invalid value for "pki_branding_id" when calling ObjectBrandingApi.branding_get_object_v3, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/3/object/branding/{pkiBrandingID}'.sub('{' + 'pkiBrandingID' + '}', CGI.escape(pki_branding_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'BrandingGetObjectV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectBrandingApi.branding_get_object_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectBrandingApi#branding_get_object_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
