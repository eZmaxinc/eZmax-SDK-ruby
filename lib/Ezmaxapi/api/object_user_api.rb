...
module EzmaxApi
  class ObjectUserApi
    ...
    def user_get_autocomplete_v2_with_http_info(s_selector, opts = {})
      ...
      # verify enum value
      allowable_values = ["AgentBrokerAssistant", "AgentBrokerEmployeeEzsignUserNormal", "AgentBrokerEmployeeNormalBuiltIn", "AgentBrokerEzsignuserNormal", "ClonableUsers", "EzsignuserBuiltIn", "Ezsignuser", "Normal", "UsergroupDelegated"]
