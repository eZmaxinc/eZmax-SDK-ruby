...
module EzmaxApi
  class ObjectUserApi
    ...
    # Create a new User
    # The endpoint allows to create one or many elements at once.
    # @param user_create_object_v2_request [UserCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [UserCreateObjectV2Response]
    def user_create_object_v2(user_create_object_v2_request, opts = {})
      data, _status_code, _headers = user_create_object_v2_with_http_info(user_create_object_v2_request, opts)
      data
    end
    ...
    # @param user_create_object_v2_request [UserCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserCreateObjectV2Response, Integer, Hash)>] UserCreateObjectV2Response data, response status code and response headers
    def user_create_object_v2_with_http_info(user_create_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectUserApi.user_create_object_v2 ...'
      end
      # verify the required parameter 'user_create_object_v2_request' is set
      if @api_client.config.client_side_validation && user_create_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'user_create_object_v2_request' when calling ObjectUserApi.user_create_object_v2"
      end
      # resource path
      local_var_path = '/2/object/user'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(user_create_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'UserCreateObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectUserApi.user_create_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectUserApi#user_create_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param user_edit_colleagues_v2_request [UserEditColleaguesV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [UserEditColleaguesV2Response]
    def user_edit_colleagues_v2(pki_user_id, user_edit_colleagues_v2_request, opts = {})
      data, _status_code, _headers = user_edit_colleagues_v2_with_http_info(pki_user_id, user_edit_colleagues_v2_request, opts)
      data
    end
    ...
    # @param user_edit_colleagues_v2_request [UserEditColleaguesV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserEditColleaguesV2Response, Integer, Hash)>] UserEditColleaguesV2Response data, response status code and response headers
    def user_edit_colleagues_v2_with_http_info(pki_user_id, user_edit_colleagues_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectUserApi.user_edit_colleagues_v2 ...'
      end
      # verify the required parameter 'pki_user_id' is set
      if @api_client.config.client_side_validation && pki_user_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_user_id' when calling ObjectUserApi.user_edit_colleagues_v2"
      end
      if @api_client.config.client_side_validation && pki_user_id < 0
        fail ArgumentError, 'invalid value for "pki_user_id" when calling ObjectUserApi.user_edit_colleagues_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'user_edit_colleagues_v2_request' is set
      if @api_client.config.client_side_validation && user_edit_colleagues_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'user_edit_colleagues_v2_request' when calling ObjectUserApi.user_edit_colleagues_v2"
      end
      # resource path
      local_var_path = '/2/object/user/{pkiUserID}/editColleagues'.sub('{pkiUserID}', CGI.escape(pki_user_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(user_edit_colleagues_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'UserEditColleaguesV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectUserApi.user_edit_colleagues_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectUserApi#user_edit_colleagues_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_get_autocomplete_v2_with_http_info(s_selector, opts = {})
      ...
      # verify enum value
      allowable_values = ["AgentBrokerAssistant", "AgentBrokerEmployeeEzsignUserNormalWithoutEzmaxpartner", "AgentBrokerEmployeeEzsignUserNormal", "AgentBrokerEmployeeNormalBuiltIn", "AgentBrokerEzsignuserNormal", "ClonableUsers", "EzsignuserBuiltIn", "Ezsignuser", "Normal", "UsergroupDelegated"]
    ...
    def user_get_colleagues_v2(pki_user_id, opts = {})
      data, _status_code, _headers = user_get_colleagues_v2_with_http_info(pki_user_id, opts)
      data
    end
    ...
    # @param pki_user_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserGetColleaguesV2Response, Integer, Hash)>] UserGetColleaguesV2Response data, response status code and response headers
    def user_get_colleagues_v2_with_http_info(pki_user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectUserApi.user_get_colleagues_v2 ...'
      end
      # verify the required parameter 'pki_user_id' is set
      if @api_client.config.client_side_validation && pki_user_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_user_id' when calling ObjectUserApi.user_get_colleagues_v2"
      end
      if @api_client.config.client_side_validation && pki_user_id < 0
        fail ArgumentError, 'invalid value for "pki_user_id" when calling ObjectUserApi.user_get_colleagues_v2, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/2/object/user/{pkiUserID}/getColleagues'.sub('{pkiUserID}', CGI.escape(pki_user_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UserGetColleaguesV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectUserApi.user_get_colleagues_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectUserApi#user_get_colleagues_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_get_ezmaxcustomeruser_v1(pki_user_id, opts = {})
      data, _status_code, _headers = user_get_ezmaxcustomeruser_v1_with_http_info(pki_user_id, opts)
      data
    end
    ...
    # @param pki_user_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserGetEzmaxcustomeruserV1Response, Integer, Hash)>] UserGetEzmaxcustomeruserV1Response data, response status code and response headers
    def user_get_ezmaxcustomeruser_v1_with_http_info(pki_user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectUserApi.user_get_ezmaxcustomeruser_v1 ...'
      end
      # verify the required parameter 'pki_user_id' is set
      if @api_client.config.client_side_validation && pki_user_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_user_id' when calling ObjectUserApi.user_get_ezmaxcustomeruser_v1"
      end
      if @api_client.config.client_side_validation && pki_user_id < 0
        fail ArgumentError, 'invalid value for "pki_user_id" when calling ObjectUserApi.user_get_ezmaxcustomeruser_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/user/{pkiUserID}/getEzmaxcustomeruser'.sub('{pkiUserID}', CGI.escape(pki_user_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UserGetEzmaxcustomeruserV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectUserApi.user_get_ezmaxcustomeruser_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectUserApi#user_get_ezmaxcustomeruser_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_get_usergroupexternals_v1(pki_user_id, opts = {})
      data, _status_code, _headers = user_get_usergroupexternals_v1_with_http_info(pki_user_id, opts)
      data
    end
    ...
    # @param pki_user_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserGetUsergroupexternalsV1Response, Integer, Hash)>] UserGetUsergroupexternalsV1Response data, response status code and response headers
    def user_get_usergroupexternals_v1_with_http_info(pki_user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectUserApi.user_get_usergroupexternals_v1 ...'
      end
      # verify the required parameter 'pki_user_id' is set
      if @api_client.config.client_side_validation && pki_user_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_user_id' when calling ObjectUserApi.user_get_usergroupexternals_v1"
      end
      if @api_client.config.client_side_validation && pki_user_id < 0
        fail ArgumentError, 'invalid value for "pki_user_id" when calling ObjectUserApi.user_get_usergroupexternals_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/user/{pkiUserID}/getUsergroupexternals'.sub('{pkiUserID}', CGI.escape(pki_user_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UserGetUsergroupexternalsV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectUserApi.user_get_usergroupexternals_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectUserApi#user_get_usergroupexternals_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def user_get_usergroups_v1(pki_user_id, opts = {})
      data, _status_code, _headers = user_get_usergroups_v1_with_http_info(pki_user_id, opts)
      data
    end
    ...
    # @param pki_user_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserGetUsergroupsV1Response, Integer, Hash)>] UserGetUsergroupsV1Response data, response status code and response headers
    def user_get_usergroups_v1_with_http_info(pki_user_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectUserApi.user_get_usergroups_v1 ...'
      end
      # verify the required parameter 'pki_user_id' is set
      if @api_client.config.client_side_validation && pki_user_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_user_id' when calling ObjectUserApi.user_get_usergroups_v1"
      end
      if @api_client.config.client_side_validation && pki_user_id < 0
        fail ArgumentError, 'invalid value for "pki_user_id" when calling ObjectUserApi.user_get_usergroups_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/user/{pkiUserID}/getUsergroups'.sub('{pkiUserID}', CGI.escape(pki_user_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'UserGetUsergroupsV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectUserApi.user_get_usergroups_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectUserApi#user_get_usergroups_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param pki_user_id [Integer] 
    # @param user_impersonate_v1_request [UserImpersonateV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [UserImpersonateV1Response]
    def user_impersonate_v1(pki_user_id, user_impersonate_v1_request, opts = {})
      data, _status_code, _headers = user_impersonate_v1_with_http_info(pki_user_id, user_impersonate_v1_request, opts)
      data
    end
    ...
    # @param user_impersonate_v1_request [UserImpersonateV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(UserImpersonateV1Response, Integer, Hash)>] UserImpersonateV1Response data, response status code and response headers
    def user_impersonate_v1_with_http_info(pki_user_id, user_impersonate_v1_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectUserApi.user_impersonate_v1 ...'
      end
      # verify the required parameter 'pki_user_id' is set
      if @api_client.config.client_side_validation && pki_user_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_user_id' when calling ObjectUserApi.user_impersonate_v1"
      end
      if @api_client.config.client_side_validation && pki_user_id < 0
        fail ArgumentError, 'invalid value for "pki_user_id" when calling ObjectUserApi.user_impersonate_v1, must be greater than or equal to 0.'
      end

      # verify the required parameter 'user_impersonate_v1_request' is set
      if @api_client.config.client_side_validation && user_impersonate_v1_request.nil?
        fail ArgumentError, "Missing the required parameter 'user_impersonate_v1_request' when calling ObjectUserApi.user_impersonate_v1"
      end
      # resource path
      local_var_path = '/1/object/user/{pkiUserID}/impersonate'.sub('{pkiUserID}', CGI.escape(pki_user_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(user_impersonate_v1_request)

      # return_type
      return_type = opts[:debug_return_type] || 'UserImpersonateV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectUserApi.user_impersonate_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectUserApi#user_impersonate_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
