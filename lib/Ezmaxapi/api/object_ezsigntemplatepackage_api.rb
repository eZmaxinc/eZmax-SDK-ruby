...
module EzmaxApi
  class ObjectEzsigntemplatepackageApi
    ...
    # Using this endpoint, you can edit multiple Ezsigntemplatepackagesigners at the same time.
    # @param pki_ezsigntemplatepackage_id [Integer] 
    # @param ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request [EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response]
    def ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2(pki_ezsigntemplatepackage_id, ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request, opts = {})
      data, _status_code, _headers = ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_with_http_info(pki_ezsigntemplatepackage_id, ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request, opts)
      data
    end
    ...
    # @param ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request [EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response, Integer, Hash)>] EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response data, response status code and response headers
    def ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_with_http_info(pki_ezsigntemplatepackage_id, ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatepackageApi.ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatepackage_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatepackage_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatepackage_id' when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatepackage_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatepackage_id" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request' is set
      if @api_client.config.client_side_validation && ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request' when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2"
      end
      # resource path
      local_var_path = '/2/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}/editEzsigntemplatepackagesigners'.sub('{pkiEzsigntemplatepackageID}', CGI.escape(pki_ezsigntemplatepackage_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatepackageEditEzsigntemplatepackagesignersV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatepackageApi.ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatepackageApi#ezsigntemplatepackage_edit_ezsigntemplatepackagesigners_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsigntemplatepackage_get_autocomplete_v2_with_http_info(s_selector, opts = {})
      ...
      # verify enum value
      allowable_values = ["All", "AllMultipleCopiesDisabled", "Ezsigntemplatepublic"]
    ...
    def ezsigntemplatepackage_get_list_v1_with_http_info(opts = {})
      ...
      allowable_values = ["pkiEzsigntemplatepackageID_ASC", "pkiEzsigntemplatepackageID_DESC", "fkiTeamID_ASC", "fkiTeamID_DESC", "fkiEzsignfoldertypeID_ASC", "fkiEzsignfoldertypeID_DESC", "fkiLanguageID_ASC", "fkiLanguageID_DESC", "eEzsigntemplatepackageType_ASC", "eEzsigntemplatepackageType_DESC", "sEzsigntemplatepackageDescription_ASC", "sEzsigntemplatepackageDescription_DESC", "bEzsigntemplatepackageNeedvalidation_ASC", "bEzsigntemplatepackageNeedvalidation_DESC", "iEzsigntemplatepackagemembership_ASC", "iEzsigntemplatepackagemembership_DESC", "bEzsigntemplatepackageIsactive_ASC", "bEzsigntemplatepackageIsactive_DESC"]
    ...
    def ezsigntemplatepackage_get_object_v3(pki_ezsigntemplatepackage_id, opts = {})
      data, _status_code, _headers = ezsigntemplatepackage_get_object_v3_with_http_info(pki_ezsigntemplatepackage_id, opts)
      data
    end
    ...
    # @param pki_ezsigntemplatepackage_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatepackageGetObjectV3Response, Integer, Hash)>] EzsigntemplatepackageGetObjectV3Response data, response status code and response headers
    def ezsigntemplatepackage_get_object_v3_with_http_info(pki_ezsigntemplatepackage_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatepackageApi.ezsigntemplatepackage_get_object_v3 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatepackage_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatepackage_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatepackage_id' when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackage_get_object_v3"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatepackage_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatepackage_id" when calling ObjectEzsigntemplatepackageApi.ezsigntemplatepackage_get_object_v3, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/3/object/ezsigntemplatepackage/{pkiEzsigntemplatepackageID}'.sub('{pkiEzsigntemplatepackageID}', CGI.escape(pki_ezsigntemplatepackage_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatepackageGetObjectV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatepackageApi.ezsigntemplatepackage_get_object_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatepackageApi#ezsigntemplatepackage_get_object_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
