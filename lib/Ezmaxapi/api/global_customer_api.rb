  ...
  class GlobalCustomerApi
    ...
    def global_customer_get_endpoint_v1_with_http_info(pks_customer_code, opts = {})
      ...
      if @api_client.config.client_side_validation && pks_customer_code.to_s.length < 2
        fail ArgumentError, 'invalid value for "pks_customer_code" when calling GlobalCustomerApi.global_customer_get_endpoint_v1, the character length must be greater than or equal to 2.'
      end
