...
module EzmaxApi
  class ObjectEzsignbulksendtransmissionApi
    ...
    # @return [File]
    def ezsignbulksendtransmission_get_batch_file_v1(pki_ezsignbulksendtransmission_id, opts = {})
      data, _status_code, _headers = ezsignbulksendtransmission_get_batch_file_v1_with_http_info(pki_ezsignbulksendtransmission_id, opts)
      data
    end
    ...
    def ezsignbulksendtransmission_get_batch_file_v1_with_http_info(pki_ezsignbulksendtransmission_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignbulksendtransmissionApi.ezsignbulksendtransmission_get_batch_file_v1 ...'
      end
      ...
      if @api_client.config.client_side_validation && pki_ezsignbulksendtransmission_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignbulksendtransmission_id' when calling ObjectEzsignbulksendtransmissionApi.ezsignbulksendtransmission_get_batch_file_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsignbulksendtransmission_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignbulksendtransmission_id" when calling ObjectEzsignbulksendtransmissionApi.ezsignbulksendtransmission_get_batch_file_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/ezsignbulksendtransmission/{pkiEzsignbulksendtransmissionID}/getBatchFile'.sub('{' + 'pkiEzsignbulksendtransmissionID' + '}', CGI.escape(pki_ezsignbulksendtransmission_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ObjectEzsignbulksendtransmissionApi.ezsignbulksendtransmission_get_batch_file_v1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignbulksendtransmissionApi#ezsignbulksendtransmission_get_batch_file_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
