...
module EzmaxApi
  class ObjectEzsignfolderApi
    ...
    # 
    # @param pki_ezsignfolder_id [Integer] 
    # @param ezsignfolder_duplicate_v1_request [EzsignfolderDuplicateV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignfolderDuplicateV1Response]
    def ezsignfolder_duplicate_v1(pki_ezsignfolder_id, ezsignfolder_duplicate_v1_request, opts = {})
      data, _status_code, _headers = ezsignfolder_duplicate_v1_with_http_info(pki_ezsignfolder_id, ezsignfolder_duplicate_v1_request, opts)
      data
    end
    ...
    # @param ezsignfolder_duplicate_v1_request [EzsignfolderDuplicateV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderDuplicateV1Response, Integer, Hash)>] EzsignfolderDuplicateV1Response data, response status code and response headers
    def ezsignfolder_duplicate_v1_with_http_info(pki_ezsignfolder_id, ezsignfolder_duplicate_v1_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_duplicate_v1 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_duplicate_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_duplicate_v1, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsignfolder_duplicate_v1_request' is set
      if @api_client.config.client_side_validation && ezsignfolder_duplicate_v1_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignfolder_duplicate_v1_request' when calling ObjectEzsignfolderApi.ezsignfolder_duplicate_v1"
      end
      # resource path
      local_var_path = '/1/object/ezsignfolder/{pkiEzsignfolderID}/duplicate'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignfolder_duplicate_v1_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderDuplicateV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_duplicate_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_duplicate_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignfolder_get_actionable_elements_v2(pki_ezsignfolder_id, opts = {})
      data, _status_code, _headers = ezsignfolder_get_actionable_elements_v2_with_http_info(pki_ezsignfolder_id, opts)
      data
    end
    ...
    # @param pki_ezsignfolder_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderGetActionableElementsV2Response, Integer, Hash)>] EzsignfolderGetActionableElementsV2Response data, response status code and response headers
    def ezsignfolder_get_actionable_elements_v2_with_http_info(pki_ezsignfolder_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_get_actionable_elements_v2 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_get_actionable_elements_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_get_actionable_elements_v2, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/2/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderGetActionableElementsV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_get_actionable_elements_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_get_actionable_elements_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignfolder_get_actionable_elements_v3(pki_ezsignfolder_id, opts = {})
      data, _status_code, _headers = ezsignfolder_get_actionable_elements_v3_with_http_info(pki_ezsignfolder_id, opts)
      data
    end
    ...
    # @param pki_ezsignfolder_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderGetActionableElementsV3Response, Integer, Hash)>] EzsignfolderGetActionableElementsV3Response data, response status code and response headers
    def ezsignfolder_get_actionable_elements_v3_with_http_info(pki_ezsignfolder_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_get_actionable_elements_v3 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_get_actionable_elements_v3"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_get_actionable_elements_v3, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/3/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderGetActionableElementsV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_get_actionable_elements_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_get_actionable_elements_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignfolder_get_ezsignannotations_v1(pki_ezsignfolder_id, opts = {})
      data, _status_code, _headers = ezsignfolder_get_ezsignannotations_v1_with_http_info(pki_ezsignfolder_id, opts)
      data
    end
    ...
    # @param pki_ezsignfolder_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderGetEzsignannotationsV1Response, Integer, Hash)>] EzsignfolderGetEzsignannotationsV1Response data, response status code and response headers
    def ezsignfolder_get_ezsignannotations_v1_with_http_info(pki_ezsignfolder_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_get_ezsignannotations_v1 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignannotations_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignannotations_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignannotations'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderGetEzsignannotationsV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_get_ezsignannotations_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_get_ezsignannotations_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignfolder_get_ezsigndocuments_v2(pki_ezsignfolder_id, opts = {})
      data, _status_code, _headers = ezsignfolder_get_ezsigndocuments_v2_with_http_info(pki_ezsignfolder_id, opts)
      data
    end
    ...
    # @param pki_ezsignfolder_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderGetEzsigndocumentsV2Response, Integer, Hash)>] EzsignfolderGetEzsigndocumentsV2Response data, response status code and response headers
    def ezsignfolder_get_ezsigndocuments_v2_with_http_info(pki_ezsignfolder_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_get_ezsigndocuments_v2 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsigndocuments_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsigndocuments_v2, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsigndocuments'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderGetEzsigndocumentsV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_get_ezsigndocuments_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_get_ezsigndocuments_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignfolder_get_ezsignfoldersignerassociations_v2(pki_ezsignfolder_id, opts = {})
      data, _status_code, _headers = ezsignfolder_get_ezsignfoldersignerassociations_v2_with_http_info(pki_ezsignfolder_id, opts)
      data
    end
    ...
    # @param pki_ezsignfolder_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderGetEzsignfoldersignerassociationsV2Response, Integer, Hash)>] EzsignfolderGetEzsignfoldersignerassociationsV2Response data, response status code and response headers
    def ezsignfolder_get_ezsignfoldersignerassociations_v2_with_http_info(pki_ezsignfolder_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_get_ezsignfoldersignerassociations_v2 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignfoldersignerassociations_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignfoldersignerassociations_v2, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociations'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderGetEzsignfoldersignerassociationsV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_get_ezsignfoldersignerassociations_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_get_ezsignfoldersignerassociations_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignfolder_get_ezsignformfieldgroups_v1(pki_ezsignfolder_id, opts = {})
      data, _status_code, _headers = ezsignfolder_get_ezsignformfieldgroups_v1_with_http_info(pki_ezsignfolder_id, opts)
      data
    end
    ...
    # @param pki_ezsignfolder_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderGetEzsignformfieldgroupsV1Response, Integer, Hash)>] EzsignfolderGetEzsignformfieldgroupsV1Response data, response status code and response headers
    def ezsignfolder_get_ezsignformfieldgroups_v1_with_http_info(pki_ezsignfolder_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_get_ezsignformfieldgroups_v1 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignformfieldgroups_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignformfieldgroups_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignformfieldgroups'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderGetEzsignformfieldgroupsV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_get_ezsignformfieldgroups_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_get_ezsignformfieldgroups_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignfolder_get_ezsignsignatures_v1(pki_ezsignfolder_id, opts = {})
      data, _status_code, _headers = ezsignfolder_get_ezsignsignatures_v1_with_http_info(pki_ezsignfolder_id, opts)
      data
    end
    ...
    # @param pki_ezsignfolder_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderGetEzsignsignaturesV1Response, Integer, Hash)>] EzsignfolderGetEzsignsignaturesV1Response data, response status code and response headers
    def ezsignfolder_get_ezsignsignatures_v1_with_http_info(pki_ezsignfolder_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_get_ezsignsignatures_v1 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignsignatures_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignsignatures_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignsignatures'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderGetEzsignsignaturesV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_get_ezsignsignatures_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_get_ezsignsignatures_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # @param pki_ezsignfolder_id [Integer] 
    # @param ezsignfolder_import_ezsigntemplatepackage_v2_request [EzsignfolderImportEzsigntemplatepackageV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignfolderImportEzsigntemplatepackageV2Response]
    def ezsignfolder_import_ezsigntemplatepackage_v2(pki_ezsignfolder_id, ezsignfolder_import_ezsigntemplatepackage_v2_request, opts = {})
      data, _status_code, _headers = ezsignfolder_import_ezsigntemplatepackage_v2_with_http_info(pki_ezsignfolder_id, ezsignfolder_import_ezsigntemplatepackage_v2_request, opts)
      data
    end
    ...
    # @param ezsignfolder_import_ezsigntemplatepackage_v2_request [EzsignfolderImportEzsigntemplatepackageV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderImportEzsigntemplatepackageV2Response, Integer, Hash)>] EzsignfolderImportEzsigntemplatepackageV2Response data, response status code and response headers
    def ezsignfolder_import_ezsigntemplatepackage_v2_with_http_info(pki_ezsignfolder_id, ezsignfolder_import_ezsigntemplatepackage_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v2 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsignfolder_import_ezsigntemplatepackage_v2_request' is set
      if @api_client.config.client_side_validation && ezsignfolder_import_ezsigntemplatepackage_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignfolder_import_ezsigntemplatepackage_v2_request' when calling ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v2"
      end
      # resource path
      local_var_path = '/2/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignfolder_import_ezsigntemplatepackage_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderImportEzsigntemplatepackageV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_import_ezsigntemplatepackage_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # This endpoint imports all of the Ezsigntemplates from the Ezsigntemplatepackage into the Ezsignfolder as Ezsigndocuments.  This allows to automatically apply all the Ezsigntemplateformfieldgroups and Ezsigntemplatesignatures on the newly created Ezsigndocuments in a single step.
    # @param pki_ezsignfolder_id [Integer] 
    # @param ezsignfolder_import_ezsigntemplatepackage_v3_request [EzsignfolderImportEzsigntemplatepackageV3Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignfolderImportEzsigntemplatepackageV3Response]
    def ezsignfolder_import_ezsigntemplatepackage_v3(pki_ezsignfolder_id, ezsignfolder_import_ezsigntemplatepackage_v3_request, opts = {})
      data, _status_code, _headers = ezsignfolder_import_ezsigntemplatepackage_v3_with_http_info(pki_ezsignfolder_id, ezsignfolder_import_ezsigntemplatepackage_v3_request, opts)
      data
    end
    ...
    # @param ezsignfolder_import_ezsigntemplatepackage_v3_request [EzsignfolderImportEzsigntemplatepackageV3Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderImportEzsigntemplatepackageV3Response, Integer, Hash)>] EzsignfolderImportEzsigntemplatepackageV3Response data, response status code and response headers
    def ezsignfolder_import_ezsigntemplatepackage_v3_with_http_info(pki_ezsignfolder_id, ezsignfolder_import_ezsigntemplatepackage_v3_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v3 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v3"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v3, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsignfolder_import_ezsigntemplatepackage_v3_request' is set
      if @api_client.config.client_side_validation && ezsignfolder_import_ezsigntemplatepackage_v3_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignfolder_import_ezsigntemplatepackage_v3_request' when calling ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v3"
      end
      # resource path
      local_var_path = '/3/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage'.sub('{pkiEzsignfolderID}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignfolder_import_ezsigntemplatepackage_v3_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderImportEzsigntemplatepackageV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_import_ezsigntemplatepackage_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_import_ezsigntemplatepackage_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
