...
module EzmaxApi
  class ObjectEzsignfolderApi
    ...
    def ezsignfolder_edit_object_v1_with_http_info(pki_ezsignfolder_id, ezsignfolder_edit_object_v1_request, opts = {})
      ...
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_edit_object_v1, must be greater than or equal to 0.'
      end
    ...
    def ezsignfolder_get_ezsignfoldersignerassociationsmine_v1(pki_ezsignfolder_id, opts = {})
      data, _status_code, _headers = ezsignfolder_get_ezsignfoldersignerassociationsmine_v1_with_http_info(pki_ezsignfolder_id, opts)
      data
    end
    ...
    # @param pki_ezsignfolder_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderGetEzsignfoldersignerassociationsmineV1Response, Integer, Hash)>] EzsignfolderGetEzsignfoldersignerassociationsmineV1Response data, response status code and response headers
    def ezsignfolder_get_ezsignfoldersignerassociationsmine_v1_with_http_info(pki_ezsignfolder_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_get_ezsignfoldersignerassociationsmine_v1 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignfoldersignerassociationsmine_v1"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_get_ezsignfoldersignerassociationsmine_v1, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociationsmine'.sub('{' + 'pkiEzsignfolderID' + '}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderGetEzsignfoldersignerassociationsmineV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_get_ezsignfoldersignerassociationsmine_v1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_get_ezsignfoldersignerassociationsmine_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # 
    # @param pki_ezsignfolder_id [Integer] 
    # @param ezsignfolder_send_v2_request [EzsignfolderSendV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignfolderSendV2Response]
    def ezsignfolder_send_v2(pki_ezsignfolder_id, ezsignfolder_send_v2_request, opts = {})
      data, _status_code, _headers = ezsignfolder_send_v2_with_http_info(pki_ezsignfolder_id, ezsignfolder_send_v2_request, opts)
      data
    end
    ...
    # @param ezsignfolder_send_v2_request [EzsignfolderSendV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfolderSendV2Response, Integer, Hash)>] EzsignfolderSendV2Response data, response status code and response headers
    def ezsignfolder_send_v2_with_http_info(pki_ezsignfolder_id, ezsignfolder_send_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfolderApi.ezsignfolder_send_v2 ...'
      end
      # verify the required parameter 'pki_ezsignfolder_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfolder_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfolder_id' when calling ObjectEzsignfolderApi.ezsignfolder_send_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsignfolder_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfolder_id" when calling ObjectEzsignfolderApi.ezsignfolder_send_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsignfolder_send_v2_request' is set
      if @api_client.config.client_side_validation && ezsignfolder_send_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignfolder_send_v2_request' when calling ObjectEzsignfolderApi.ezsignfolder_send_v2"
      end
      # resource path
      local_var_path = '/2/object/ezsignfolder/{pkiEzsignfolderID}/send'.sub('{' + 'pkiEzsignfolderID' + '}', CGI.escape(pki_ezsignfolder_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignfolder_send_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfolderSendV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfolderApi.ezsignfolder_send_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfolderApi#ezsignfolder_send_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
