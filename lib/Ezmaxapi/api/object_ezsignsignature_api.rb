...
module EzmaxApi
  class ObjectEzsignsignatureApi
    ...
    # @param ezsignsignature_create_object_v4_request [EzsignsignatureCreateObjectV4Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignsignatureCreateObjectV4Response]
    def ezsignsignature_create_object_v4(ezsignsignature_create_object_v4_request, opts = {})
      data, _status_code, _headers = ezsignsignature_create_object_v4_with_http_info(ezsignsignature_create_object_v4_request, opts)
      data
    end
    ...
    # @param ezsignsignature_create_object_v4_request [EzsignsignatureCreateObjectV4Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignsignatureCreateObjectV4Response, Integer, Hash)>] EzsignsignatureCreateObjectV4Response data, response status code and response headers
    def ezsignsignature_create_object_v4_with_http_info(ezsignsignature_create_object_v4_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignsignatureApi.ezsignsignature_create_object_v4 ...'
      end
      # verify the required parameter 'ezsignsignature_create_object_v4_request' is set
      if @api_client.config.client_side_validation && ezsignsignature_create_object_v4_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignsignature_create_object_v4_request' when calling ObjectEzsignsignatureApi.ezsignsignature_create_object_v4"
      end
      # resource path
      local_var_path = '/4/object/ezsignsignature'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignsignature_create_object_v4_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignsignatureCreateObjectV4Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignsignatureApi.ezsignsignature_create_object_v4",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignsignatureApi#ezsignsignature_create_object_v4\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # 
    # @param pki_ezsignsignature_id [Integer] 
    # @param ezsignsignature_edit_object_v3_request [EzsignsignatureEditObjectV3Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignsignatureEditObjectV3Response]
    def ezsignsignature_edit_object_v3(pki_ezsignsignature_id, ezsignsignature_edit_object_v3_request, opts = {})
      data, _status_code, _headers = ezsignsignature_edit_object_v3_with_http_info(pki_ezsignsignature_id, ezsignsignature_edit_object_v3_request, opts)
      data
    end
    ...
    # @param ezsignsignature_edit_object_v3_request [EzsignsignatureEditObjectV3Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignsignatureEditObjectV3Response, Integer, Hash)>] EzsignsignatureEditObjectV3Response data, response status code and response headers
    def ezsignsignature_edit_object_v3_with_http_info(pki_ezsignsignature_id, ezsignsignature_edit_object_v3_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignsignatureApi.ezsignsignature_edit_object_v3 ...'
      end
      # verify the required parameter 'pki_ezsignsignature_id' is set
      if @api_client.config.client_side_validation && pki_ezsignsignature_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignsignature_id' when calling ObjectEzsignsignatureApi.ezsignsignature_edit_object_v3"
      end
      if @api_client.config.client_side_validation && pki_ezsignsignature_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignsignature_id" when calling ObjectEzsignsignatureApi.ezsignsignature_edit_object_v3, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsignsignature_edit_object_v3_request' is set
      if @api_client.config.client_side_validation && ezsignsignature_edit_object_v3_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignsignature_edit_object_v3_request' when calling ObjectEzsignsignatureApi.ezsignsignature_edit_object_v3"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignsignature_edit_object_v3_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignsignatureEditObjectV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignsignatureApi.ezsignsignature_edit_object_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignsignatureApi#ezsignsignature_edit_object_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignsignature_get_object_v4(pki_ezsignsignature_id, opts = {})
      data, _status_code, _headers = ezsignsignature_get_object_v4_with_http_info(pki_ezsignsignature_id, opts)
      data
    end
    ...
    # @param pki_ezsignsignature_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignsignatureGetObjectV4Response, Integer, Hash)>] EzsignsignatureGetObjectV4Response data, response status code and response headers
    def ezsignsignature_get_object_v4_with_http_info(pki_ezsignsignature_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignsignatureApi.ezsignsignature_get_object_v4 ...'
      end
      # verify the required parameter 'pki_ezsignsignature_id' is set
      if @api_client.config.client_side_validation && pki_ezsignsignature_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignsignature_id' when calling ObjectEzsignsignatureApi.ezsignsignature_get_object_v4"
      end
      if @api_client.config.client_side_validation && pki_ezsignsignature_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignsignature_id" when calling ObjectEzsignsignatureApi.ezsignsignature_get_object_v4, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/4/object/ezsignsignature/{pkiEzsignsignatureID}'.sub('{' + 'pkiEzsignsignatureID' + '}', CGI.escape(pki_ezsignsignature_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignsignatureGetObjectV4Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignsignatureApi.ezsignsignature_get_object_v4",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignsignatureApi#ezsignsignature_get_object_v4\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
