...
module EzmaxApi
  class ObjectEzsigntemplatesignerApi
    ...
    # Create a new Ezsigntemplatesigner
    # The endpoint allows to create one or many elements at once.
    # @param ezsigntemplatesigner_create_object_v2_request [EzsigntemplatesignerCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsigntemplatesignerCreateObjectV2Response]
    def ezsigntemplatesigner_create_object_v2(ezsigntemplatesigner_create_object_v2_request, opts = {})
      data, _status_code, _headers = ezsigntemplatesigner_create_object_v2_with_http_info(ezsigntemplatesigner_create_object_v2_request, opts)
      data
    end
    ...
    # @param ezsigntemplatesigner_create_object_v2_request [EzsigntemplatesignerCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatesignerCreateObjectV2Response, Integer, Hash)>] EzsigntemplatesignerCreateObjectV2Response data, response status code and response headers
    def ezsigntemplatesigner_create_object_v2_with_http_info(ezsigntemplatesigner_create_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_create_object_v2 ...'
      end
      # verify the required parameter 'ezsigntemplatesigner_create_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsigntemplatesigner_create_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsigntemplatesigner_create_object_v2_request' when calling ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_create_object_v2"
      end
      # resource path
      local_var_path = '/2/object/ezsigntemplatesigner'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsigntemplatesigner_create_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatesignerCreateObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_create_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatesignerApi#ezsigntemplatesigner_create_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    # 
    # @param pki_ezsigntemplatesigner_id [Integer] 
    # @param ezsigntemplatesigner_edit_object_v2_request [EzsigntemplatesignerEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsigntemplatesignerEditObjectV2Response]
    def ezsigntemplatesigner_edit_object_v2(pki_ezsigntemplatesigner_id, ezsigntemplatesigner_edit_object_v2_request, opts = {})
      data, _status_code, _headers = ezsigntemplatesigner_edit_object_v2_with_http_info(pki_ezsigntemplatesigner_id, ezsigntemplatesigner_edit_object_v2_request, opts)
      data
    end
    ...
    # @param ezsigntemplatesigner_edit_object_v2_request [EzsigntemplatesignerEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatesignerEditObjectV2Response, Integer, Hash)>] EzsigntemplatesignerEditObjectV2Response data, response status code and response headers
    def ezsigntemplatesigner_edit_object_v2_with_http_info(pki_ezsigntemplatesigner_id, ezsigntemplatesigner_edit_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_edit_object_v2 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatesigner_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatesigner_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatesigner_id' when calling ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_edit_object_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatesigner_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatesigner_id" when calling ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_edit_object_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsigntemplatesigner_edit_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsigntemplatesigner_edit_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsigntemplatesigner_edit_object_v2_request' when calling ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_edit_object_v2"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsigntemplatesigner_edit_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatesignerEditObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_edit_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatesignerApi#ezsigntemplatesigner_edit_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsigntemplatesigner_get_object_v3(pki_ezsigntemplatesigner_id, opts = {})
      data, _status_code, _headers = ezsigntemplatesigner_get_object_v3_with_http_info(pki_ezsigntemplatesigner_id, opts)
      data
    end
    ...
    # @param pki_ezsigntemplatesigner_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsigntemplatesignerGetObjectV3Response, Integer, Hash)>] EzsigntemplatesignerGetObjectV3Response data, response status code and response headers
    def ezsigntemplatesigner_get_object_v3_with_http_info(pki_ezsigntemplatesigner_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_get_object_v3 ...'
      end
      # verify the required parameter 'pki_ezsigntemplatesigner_id' is set
      if @api_client.config.client_side_validation && pki_ezsigntemplatesigner_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsigntemplatesigner_id' when calling ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_get_object_v3"
      end
      if @api_client.config.client_side_validation && pki_ezsigntemplatesigner_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsigntemplatesigner_id" when calling ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_get_object_v3, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/3/object/ezsigntemplatesigner/{pkiEzsigntemplatesignerID}'.sub('{pkiEzsigntemplatesignerID}', CGI.escape(pki_ezsigntemplatesigner_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsigntemplatesignerGetObjectV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsigntemplatesignerApi.ezsigntemplatesigner_get_object_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsigntemplatesignerApi#ezsigntemplatesigner_get_object_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
