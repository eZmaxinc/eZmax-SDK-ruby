...
module EzmaxApi
  class ObjectDiscussionApi
    ...
    # @param discussion_chat_v1_request [DiscussionChatV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [DiscussionChatV1200Response]
    def discussion_chat_v1(discussion_chat_v1_request, opts = {})
      data, _status_code, _headers = discussion_chat_v1_with_http_info(discussion_chat_v1_request, opts)
      data
    end
    ...
    # @param discussion_chat_v1_request [DiscussionChatV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(DiscussionChatV1200Response, Integer, Hash)>] DiscussionChatV1200Response data, response status code and response headers
    def discussion_chat_v1_with_http_info(discussion_chat_v1_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectDiscussionApi.discussion_chat_v1 ...'
      end
      # verify the required parameter 'discussion_chat_v1_request' is set
      if @api_client.config.client_side_validation && discussion_chat_v1_request.nil?
        fail ArgumentError, "Missing the required parameter 'discussion_chat_v1_request' when calling ObjectDiscussionApi.discussion_chat_v1"
      end
      # resource path
      local_var_path = '/1/object/discussion/chat'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(discussion_chat_v1_request)

      # return_type
      return_type = opts[:debug_return_type] || 'DiscussionChatV1200Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectDiscussionApi.discussion_chat_v1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectDiscussionApi#discussion_chat_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
