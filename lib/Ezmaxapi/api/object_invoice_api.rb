...
module EzmaxApi
  class ObjectInvoiceApi
    ...
    # @param invoice_batch_download_v1_request [InvoiceBatchDownloadV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [File]
    def invoice_batch_download_v1(pki_invoice_id, invoice_batch_download_v1_request, opts = {})
      data, _status_code, _headers = invoice_batch_download_v1_with_http_info(pki_invoice_id, invoice_batch_download_v1_request, opts)
      data
    end
    ...
    def invoice_batch_download_v1_with_http_info(pki_invoice_id, invoice_batch_download_v1_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectInvoiceApi.invoice_batch_download_v1 ...'
      end
      # verify the required parameter 'pki_invoice_id' is set
      if @api_client.config.client_side_validation && pki_invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_invoice_id' when calling ObjectInvoiceApi.invoice_batch_download_v1"
      end
      if @api_client.config.client_side_validation && pki_invoice_id < 0
        fail ArgumentError, 'invalid value for "pki_invoice_id" when calling ObjectInvoiceApi.invoice_batch_download_v1, must be greater than or equal to 0.'
      end

      # verify the required parameter 'invoice_batch_download_v1_request' is set
      if @api_client.config.client_side_validation && invoice_batch_download_v1_request.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_batch_download_v1_request' when calling ObjectInvoiceApi.invoice_batch_download_v1"
      end
      # resource path
      local_var_path = '/1/object/invoice/{pkiInvoiceID}/batchDownload'.sub('{pkiInvoiceID}', CGI.escape(pki_invoice_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(invoice_batch_download_v1_request)
      ...
      new_options = opts.merge(
        :operation => :"ObjectInvoiceApi.invoice_batch_download_v1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectInvoiceApi#invoice_batch_download_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    # 
    # @param pki_invoice_id [Integer] 
    # @param invoice_import_into_edmv1_request [InvoiceImportIntoEDMV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [InvoiceImportIntoEDMV1Response]
    def invoice_import_into_edmv1(pki_invoice_id, invoice_import_into_edmv1_request, opts = {})
      data, _status_code, _headers = invoice_import_into_edmv1_with_http_info(pki_invoice_id, invoice_import_into_edmv1_request, opts)
      data
    end
    ...
    # @param invoice_import_into_edmv1_request [InvoiceImportIntoEDMV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(InvoiceImportIntoEDMV1Response, Integer, Hash)>] InvoiceImportIntoEDMV1Response data, response status code and response headers
    def invoice_import_into_edmv1_with_http_info(pki_invoice_id, invoice_import_into_edmv1_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectInvoiceApi.invoice_import_into_edmv1 ...'
      end
      # verify the required parameter 'pki_invoice_id' is set
      if @api_client.config.client_side_validation && pki_invoice_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_invoice_id' when calling ObjectInvoiceApi.invoice_import_into_edmv1"
      end
      if @api_client.config.client_side_validation && pki_invoice_id < 0
        fail ArgumentError, 'invalid value for "pki_invoice_id" when calling ObjectInvoiceApi.invoice_import_into_edmv1, must be greater than or equal to 0.'
      end

      # verify the required parameter 'invoice_import_into_edmv1_request' is set
      if @api_client.config.client_side_validation && invoice_import_into_edmv1_request.nil?
        fail ArgumentError, "Missing the required parameter 'invoice_import_into_edmv1_request' when calling ObjectInvoiceApi.invoice_import_into_edmv1"
      end
      # resource path
      local_var_path = '/1/object/invoice/{pkiInvoiceID}/importIntoEDM'.sub('{pkiInvoiceID}', CGI.escape(pki_invoice_id.to_s))
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(invoice_import_into_edmv1_request)

      # return_type
      return_type = opts[:debug_return_type] || 'InvoiceImportIntoEDMV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectInvoiceApi.invoice_import_into_edmv1",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectInvoiceApi#invoice_import_into_edmv1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
