...
module EzmaxApi
  class ObjectWebhookApi
    ...
    # @param webhook_create_object_v1_request [WebhookCreateObjectV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [WebhookCreateObjectV1Response]
    def webhook_create_object_v1(webhook_create_object_v1_request, opts = {})
      data, _status_code, _headers = webhook_create_object_v1_with_http_info(webhook_create_object_v1_request, opts)
      data
    end
    ...
    # @param webhook_create_object_v1_request [WebhookCreateObjectV1Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(WebhookCreateObjectV1Response, Integer, Hash)>] WebhookCreateObjectV1Response data, response status code and response headers
    def webhook_create_object_v1_with_http_info(webhook_create_object_v1_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectWebhookApi.webhook_create_object_v1 ...'
      end
      # verify the required parameter 'webhook_create_object_v1_request' is set
      if @api_client.config.client_side_validation && webhook_create_object_v1_request.nil?
        fail ArgumentError, "Missing the required parameter 'webhook_create_object_v1_request' when calling ObjectWebhookApi.webhook_create_object_v1"
      end
      # resource path
      local_var_path = '/1/object/webhook'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(webhook_create_object_v1_request)

      # return_type
      return_type = opts[:debug_return_type] || 'WebhookCreateObjectV1Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectWebhookApi.webhook_create_object_v1",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectWebhookApi#webhook_create_object_v1\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
