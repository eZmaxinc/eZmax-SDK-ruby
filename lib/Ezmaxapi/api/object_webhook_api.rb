...
module EzmaxApi
  class ObjectWebhookApi
    ...
    def webhook_get_list_v1_with_http_info(opts = {})
      ...
      allowable_values = ["pkiWebhookID_ASC", "pkiWebhookID_DESC", "sWebhookDescription_ASC", "sWebhookDescription_DESC", "eWebhookEzsignevent_ASC", "eWebhookEzsignevent_DESC", "eWebhookManagementevent_ASC", "eWebhookManagementevent_DESC", "eWebhookRealestateevent_ASC", "eWebhookRealestateevent_DESC", "eWebhookModule_ASC", "eWebhookModule_DESC", "sWebhookEmailfailed_ASC", "sWebhookEmailfailed_DESC", "sWebhookEvent_ASC", "sWebhookEvent_DESC", "sWebhookUrl_ASC", "sWebhookUrl_DESC", "bWebhookIsactive_ASC", "bWebhookIsactive_DESC", "bWebhookIssigned_ASC", "bWebhookIssigned_DESC"]
