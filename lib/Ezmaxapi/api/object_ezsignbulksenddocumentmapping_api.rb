...
module EzmaxApi
  class ObjectEzsignbulksenddocumentmappingApi
    ...
    def ezsignbulksenddocumentmapping_get_object_v3(pki_ezsignbulksenddocumentmapping_id, opts = {})
      data, _status_code, _headers = ezsignbulksenddocumentmapping_get_object_v3_with_http_info(pki_ezsignbulksenddocumentmapping_id, opts)
      data
    end
    ...
    # @param pki_ezsignbulksenddocumentmapping_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignbulksenddocumentmappingGetObjectV3Response, Integer, Hash)>] EzsignbulksenddocumentmappingGetObjectV3Response data, response status code and response headers
    def ezsignbulksenddocumentmapping_get_object_v3_with_http_info(pki_ezsignbulksenddocumentmapping_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignbulksenddocumentmappingApi.ezsignbulksenddocumentmapping_get_object_v3 ...'
      end
      # verify the required parameter 'pki_ezsignbulksenddocumentmapping_id' is set
      if @api_client.config.client_side_validation && pki_ezsignbulksenddocumentmapping_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignbulksenddocumentmapping_id' when calling ObjectEzsignbulksenddocumentmappingApi.ezsignbulksenddocumentmapping_get_object_v3"
      end
      if @api_client.config.client_side_validation && pki_ezsignbulksenddocumentmapping_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignbulksenddocumentmapping_id" when calling ObjectEzsignbulksenddocumentmappingApi.ezsignbulksenddocumentmapping_get_object_v3, must be greater than or equal to 0.'
      end

      # resource path
      local_var_path = '/3/object/ezsignbulksenddocumentmapping/{pkiEzsignbulksenddocumentmappingID}'.sub('{pkiEzsignbulksenddocumentmappingID}', CGI.escape(pki_ezsignbulksenddocumentmapping_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignbulksenddocumentmappingGetObjectV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignbulksenddocumentmappingApi.ezsignbulksenddocumentmapping_get_object_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignbulksenddocumentmappingApi#ezsignbulksenddocumentmapping_get_object_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
