  ...
  class ModuleEzsignApi
    ...
    def ezsign_suggest_templates_v1_with_http_info(opts = {})
      ...
      if @api_client.config.client_side_validation && !opts[:'fki_ezsignfoldertype_id'].nil? && opts[:'fki_ezsignfoldertype_id'] > 65535
        fail ArgumentError, 'invalid value for "opts[:"fki_ezsignfoldertype_id"]" when calling ModuleEzsignApi.ezsign_suggest_templates_v1, must be smaller than or equal to 65535.'
      end
