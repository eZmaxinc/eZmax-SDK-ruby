...
module EzmaxApi
  class ObjectEzsignfoldertypeApi
    ...
    # @param ezsignfoldertype_create_object_v2_request [EzsignfoldertypeCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignfoldertypeCreateObjectV2Response]
    def ezsignfoldertype_create_object_v2(ezsignfoldertype_create_object_v2_request, opts = {})
      data, _status_code, _headers = ezsignfoldertype_create_object_v2_with_http_info(ezsignfoldertype_create_object_v2_request, opts)
      data
    end
    ...
    # @param ezsignfoldertype_create_object_v2_request [EzsignfoldertypeCreateObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfoldertypeCreateObjectV2Response, Integer, Hash)>] EzsignfoldertypeCreateObjectV2Response data, response status code and response headers
    def ezsignfoldertype_create_object_v2_with_http_info(ezsignfoldertype_create_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfoldertypeApi.ezsignfoldertype_create_object_v2 ...'
      end
      # verify the required parameter 'ezsignfoldertype_create_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsignfoldertype_create_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignfoldertype_create_object_v2_request' when calling ObjectEzsignfoldertypeApi.ezsignfoldertype_create_object_v2"
      end
      # resource path
      local_var_path = '/2/object/ezsignfoldertype'
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignfoldertype_create_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfoldertypeCreateObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfoldertypeApi.ezsignfoldertype_create_object_v2",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfoldertypeApi#ezsignfoldertype_create_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def ezsignfoldertype_edit_object_v1_with_http_info(pki_ezsignfoldertype_id, ezsignfoldertype_edit_object_v1_request, opts = {})
      ...
      if @api_client.config.client_side_validation && pki_ezsignfoldertype_id > 65535
        fail ArgumentError, 'invalid value for "pki_ezsignfoldertype_id" when calling ObjectEzsignfoldertypeApi.ezsignfoldertype_edit_object_v1, must be smaller than or equal to 65535.'
      end
    ...
    # 
    # @param pki_ezsignfoldertype_id [Integer] 
    # @param ezsignfoldertype_edit_object_v2_request [EzsignfoldertypeEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [EzsignfoldertypeEditObjectV2Response]
    def ezsignfoldertype_edit_object_v2(pki_ezsignfoldertype_id, ezsignfoldertype_edit_object_v2_request, opts = {})
      data, _status_code, _headers = ezsignfoldertype_edit_object_v2_with_http_info(pki_ezsignfoldertype_id, ezsignfoldertype_edit_object_v2_request, opts)
      data
    end
    ...
    # @param ezsignfoldertype_edit_object_v2_request [EzsignfoldertypeEditObjectV2Request] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfoldertypeEditObjectV2Response, Integer, Hash)>] EzsignfoldertypeEditObjectV2Response data, response status code and response headers
    def ezsignfoldertype_edit_object_v2_with_http_info(pki_ezsignfoldertype_id, ezsignfoldertype_edit_object_v2_request, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfoldertypeApi.ezsignfoldertype_edit_object_v2 ...'
      end
      # verify the required parameter 'pki_ezsignfoldertype_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfoldertype_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfoldertype_id' when calling ObjectEzsignfoldertypeApi.ezsignfoldertype_edit_object_v2"
      end
      if @api_client.config.client_side_validation && pki_ezsignfoldertype_id > 65535
        fail ArgumentError, 'invalid value for "pki_ezsignfoldertype_id" when calling ObjectEzsignfoldertypeApi.ezsignfoldertype_edit_object_v2, must be smaller than or equal to 65535.'
      end

      if @api_client.config.client_side_validation && pki_ezsignfoldertype_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfoldertype_id" when calling ObjectEzsignfoldertypeApi.ezsignfoldertype_edit_object_v2, must be greater than or equal to 0.'
      end

      # verify the required parameter 'ezsignfoldertype_edit_object_v2_request' is set
      if @api_client.config.client_side_validation && ezsignfoldertype_edit_object_v2_request.nil?
        fail ArgumentError, "Missing the required parameter 'ezsignfoldertype_edit_object_v2_request' when calling ObjectEzsignfoldertypeApi.ezsignfoldertype_edit_object_v2"
      end
      # resource path
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(ezsignfoldertype_edit_object_v2_request)

      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfoldertypeEditObjectV2Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfoldertypeApi.ezsignfoldertype_edit_object_v2",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:PUT, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfoldertypeApi#ezsignfoldertype_edit_object_v2\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def ezsignfoldertype_get_object_v3(pki_ezsignfoldertype_id, opts = {})
      data, _status_code, _headers = ezsignfoldertype_get_object_v3_with_http_info(pki_ezsignfoldertype_id, opts)
      data
    end
    ...
    # @param pki_ezsignfoldertype_id [Integer] 
    # @param [Hash] opts the optional parameters
    # @return [Array<(EzsignfoldertypeGetObjectV3Response, Integer, Hash)>] EzsignfoldertypeGetObjectV3Response data, response status code and response headers
    def ezsignfoldertype_get_object_v3_with_http_info(pki_ezsignfoldertype_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: ObjectEzsignfoldertypeApi.ezsignfoldertype_get_object_v3 ...'
      end
      # verify the required parameter 'pki_ezsignfoldertype_id' is set
      if @api_client.config.client_side_validation && pki_ezsignfoldertype_id.nil?
        fail ArgumentError, "Missing the required parameter 'pki_ezsignfoldertype_id' when calling ObjectEzsignfoldertypeApi.ezsignfoldertype_get_object_v3"
      end
      if @api_client.config.client_side_validation && pki_ezsignfoldertype_id > 65535
        fail ArgumentError, 'invalid value for "pki_ezsignfoldertype_id" when calling ObjectEzsignfoldertypeApi.ezsignfoldertype_get_object_v3, must be smaller than or equal to 65535.'
      end

      if @api_client.config.client_side_validation && pki_ezsignfoldertype_id < 0
        fail ArgumentError, 'invalid value for "pki_ezsignfoldertype_id" when calling ObjectEzsignfoldertypeApi.ezsignfoldertype_get_object_v3, must be greater than or equal to 0.'
      end
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'EzsignfoldertypeGetObjectV3Response'

      # auth_names
      auth_names = opts[:debug_auth_names] || ['Authorization']

      new_options = opts.merge(
        :operation => :"ObjectEzsignfoldertypeApi.ezsignfoldertype_get_object_v3",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:GET, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: ObjectEzsignfoldertypeApi#ezsignfoldertype_get_object_v3\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
