...
module EzmaxApi
  ...
  class BillingentityinternalAutocompleteElementResponse < ApiModelBase
    ...
    attr_accessor :b_billingentityinternal_isactive
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::BillingentityinternalAutocompleteElementResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::BillingentityinternalAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'b_billingentityinternal_isactive')
        self.b_billingentityinternal_isactive = attributes[:'b_billingentityinternal_isactive']
      else
        self.b_billingentityinternal_isactive = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @b_billingentityinternal_isactive.nil?
        invalid_properties.push('invalid value for "b_billingentityinternal_isactive", b_billingentityinternal_isactive cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @b_billingentityinternal_isactive.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_billingentityinternal_isactive Value to be assigned
    def b_billingentityinternal_isactive=(b_billingentityinternal_isactive)
      if b_billingentityinternal_isactive.nil?
        fail ArgumentError, 'b_billingentityinternal_isactive cannot be nil'
      end

      @b_billingentityinternal_isactive = b_billingentityinternal_isactive
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          b_billingentityinternal_isactive == o.b_billingentityinternal_isactive
    end
    ...
    def hash
      [pki_billingentityinternal_id, s_billingentityinternal_description_x, b_billingentityinternal_isactive].hash
    end
