...
module EzmaxApi
  ...
  class CommonResponseObjDebug < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CommonResponseObjDebug`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] s_memory_usage Value to be assigned
    def s_memory_usage=(s_memory_usage)
      if s_memory_usage.nil?
        fail ArgumentError, 's_memory_usage cannot be nil'
      end

      @s_memory_usage = s_memory_usage
    end

    # Custom attribute writer method with validation
    # @param [Object] s_run_time Value to be assigned
    def s_run_time=(s_run_time)
      if s_run_time.nil?
        fail ArgumentError, 's_run_time cannot be nil'
      end

      @s_run_time = s_run_time
    end

    # Custom attribute writer method with validation
    # @param [Object] i_sql_selects Value to be assigned
    def i_sql_selects=(i_sql_selects)
      if i_sql_selects.nil?
        fail ArgumentError, 'i_sql_selects cannot be nil'
      end

      @i_sql_selects = i_sql_selects
    end

    # Custom attribute writer method with validation
    # @param [Object] i_sql_queries Value to be assigned
    def i_sql_queries=(i_sql_queries)
      if i_sql_queries.nil?
        fail ArgumentError, 'i_sql_queries cannot be nil'
      end

      @i_sql_queries = i_sql_queries
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_sql_query Value to be assigned
    def a_obj_sql_query=(a_obj_sql_query)
      if a_obj_sql_query.nil?
        fail ArgumentError, 'a_obj_sql_query cannot be nil'
      end

      @a_obj_sql_query = a_obj_sql_query
    end
