...
module EzmaxApi
  ...
  class EzsignbulksendGetListV1ResponseMPayload < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignbulksendGetListV1ResponseMPayload`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezsignbulksend Value to be assigned
    def a_obj_ezsignbulksend=(a_obj_ezsignbulksend)
      if a_obj_ezsignbulksend.nil?
        fail ArgumentError, 'a_obj_ezsignbulksend cannot be nil'
      end

      @a_obj_ezsignbulksend = a_obj_ezsignbulksend
    end
    ...
    def hash
      [i_row_returned, i_row_filtered, a_obj_ezsignbulksend].hash
    end
