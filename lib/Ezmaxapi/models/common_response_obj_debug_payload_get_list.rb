...
module EzmaxApi
  ...
  class CommonResponseObjDebugPayloadGetList < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CommonResponseObjDebugPayloadGetList`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] a_filter Value to be assigned
    def a_filter=(a_filter)
      if a_filter.nil?
        fail ArgumentError, 'a_filter cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] a_order_by Value to be assigned
    def a_order_by=(a_order_by)
      if a_order_by.nil?
        fail ArgumentError, 'a_order_by cannot be nil'
      end
