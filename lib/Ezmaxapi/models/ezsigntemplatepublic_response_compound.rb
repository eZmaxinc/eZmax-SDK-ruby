...
module EzmaxApi
  ...
  class EzsigntemplatepublicResponseCompound < ApiModelBase
    ...
    attr_accessor :a_obj_ezsignfolderezsigntemplatepublic
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatepublicResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatepublicResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'a_obj_ezsignfolderezsigntemplatepublic')
        if (value = attributes[:'a_obj_ezsignfolderezsigntemplatepublic']).is_a?(Array)
          self.a_obj_ezsignfolderezsigntemplatepublic = value
        end
      else
        self.a_obj_ezsignfolderezsigntemplatepublic = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @a_obj_ezsignfolderezsigntemplatepublic.nil?
        invalid_properties.push('invalid value for "a_obj_ezsignfolderezsigntemplatepublic", a_obj_ezsignfolderezsigntemplatepublic cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @s_ezsigntemplatepublic_url !~ Regexp.new(/^https:\/\/[^\s\/$.?#].[^\s]*$/)
      ...
      return false if @a_obj_ezsignfolderezsigntemplatepublic.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_userlogintype_description_x Value to be assigned
    def s_userlogintype_description_x=(s_userlogintype_description_x)
      if s_userlogintype_description_x.nil?
        fail ArgumentError, 's_userlogintype_description_x cannot be nil'
      end

      @s_userlogintype_description_x = s_userlogintype_description_x
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezsigntemplatepublic_isactive Value to be assigned
    def b_ezsigntemplatepublic_isactive=(b_ezsigntemplatepublic_isactive)
      if b_ezsigntemplatepublic_isactive.nil?
        fail ArgumentError, 'b_ezsigntemplatepublic_isactive cannot be nil'
      end

      @b_ezsigntemplatepublic_isactive = b_ezsigntemplatepublic_isactive
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsigntemplatepublic_limittype Value to be assigned
    def e_ezsigntemplatepublic_limittype=(e_ezsigntemplatepublic_limittype)
      if e_ezsigntemplatepublic_limittype.nil?
        fail ArgumentError, 'e_ezsigntemplatepublic_limittype cannot be nil'
      end

      @e_ezsigntemplatepublic_limittype = e_ezsigntemplatepublic_limittype
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezsignfolderezsigntemplatepublic Value to be assigned
    def a_obj_ezsignfolderezsigntemplatepublic=(a_obj_ezsignfolderezsigntemplatepublic)
      if a_obj_ezsignfolderezsigntemplatepublic.nil?
        fail ArgumentError, 'a_obj_ezsignfolderezsigntemplatepublic cannot be nil'
      end

      @a_obj_ezsignfolderezsigntemplatepublic = a_obj_ezsignfolderezsigntemplatepublic
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          a_obj_ezsignfolderezsigntemplatepublic == o.a_obj_ezsignfolderezsigntemplatepublic
    end
    ...
    def hash
      [pki_ezsigntemplatepublic_id, fki_ezsignfoldertype_id, s_ezsignfoldertype_name_x, fki_userlogintype_id, s_userlogintype_description_x, fki_ezsigntemplate_id, fki_ezsigntemplatepackage_id, s_ezsigntemplatepublic_description, s_ezsigntemplatepublic_referenceid, b_ezsigntemplatepublic_isactive, t_ezsigntemplatepublic_note, e_ezsigntemplatepublic_limittype, i_ezsigntemplatepublic_limit, i_ezsigntemplatepublic_limitexceeded, dt_ezsigntemplatepublic_limitexceededsince, s_ezsigntemplatepublic_url, s_ezsigntemplatepublic_ezsigntemplatedescription, obj_audit, a_obj_ezsignfolderezsigntemplatepublic].hash
    end
