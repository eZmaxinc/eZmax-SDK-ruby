...
module EzmaxApi
  ...
  class EzsigndocumentResponseCompoundV3 < ApiModelBase
    ...
    attr_accessor :i_ezsigndocument_steptotal

    # The current step
    attr_accessor :i_ezsigndocument_stepcurrent
    ...
    def self.attribute_map
      {
        ...
        :'i_ezsigndocument_steptotal' => :'iEzsigndocumentSteptotal',
        :'i_ezsigndocument_stepcurrent' => :'iEzsigndocumentStepcurrent',
    ...
    def self.openapi_types
      {
        ...
        :'i_ezsigndocument_steptotal' => :'Integer',
        :'i_ezsigndocument_stepcurrent' => :'Integer',
        :'a_obj_ezsignfoldersignerassociationstatus' => :'Array<CustomEzsignfoldersignerassociationstatusResponseV3>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigndocumentResponseCompoundV3` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigndocumentResponseCompoundV3`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'i_ezsigndocument_steptotal')
        self.i_ezsigndocument_steptotal = attributes[:'i_ezsigndocument_steptotal']
      else
        self.i_ezsigndocument_steptotal = nil
      end

      if attributes.key?(:'i_ezsigndocument_stepcurrent')
        self.i_ezsigndocument_stepcurrent = attributes[:'i_ezsigndocument_stepcurrent']
      else
        self.i_ezsigndocument_stepcurrent = nil
      end
    ...
    def list_invalid_properties
      ...
      if @i_ezsigndocument_steptotal.nil?
        invalid_properties.push('invalid value for "i_ezsigndocument_steptotal", i_ezsigndocument_steptotal cannot be nil.')
      end

      if @i_ezsigndocument_stepcurrent.nil?
        invalid_properties.push('invalid value for "i_ezsigndocument_stepcurrent", i_ezsigndocument_stepcurrent cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @i_ezsigndocument_steptotal.nil?
      return false if @i_ezsigndocument_stepcurrent.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] i_ezsigndocument_steptotal Value to be assigned
    def i_ezsigndocument_steptotal=(i_ezsigndocument_steptotal)
      if i_ezsigndocument_steptotal.nil?
        fail ArgumentError, 'i_ezsigndocument_steptotal cannot be nil'
      end

      @i_ezsigndocument_steptotal = i_ezsigndocument_steptotal
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsigndocument_stepcurrent Value to be assigned
    def i_ezsigndocument_stepcurrent=(i_ezsigndocument_stepcurrent)
      if i_ezsigndocument_stepcurrent.nil?
        fail ArgumentError, 'i_ezsigndocument_stepcurrent cannot be nil'
      end

      @i_ezsigndocument_stepcurrent = i_ezsigndocument_stepcurrent
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezsignfoldersignerassociationstatus Value to be assigned
    def a_obj_ezsignfoldersignerassociationstatus=(a_obj_ezsignfoldersignerassociationstatus)
      if a_obj_ezsignfoldersignerassociationstatus.nil?
        fail ArgumentError, 'a_obj_ezsignfoldersignerassociationstatus cannot be nil'
      end

      @a_obj_ezsignfoldersignerassociationstatus = a_obj_ezsignfoldersignerassociationstatus
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          i_ezsigndocument_steptotal == o.i_ezsigndocument_steptotal &&
          i_ezsigndocument_stepcurrent == o.i_ezsigndocument_stepcurrent &&
