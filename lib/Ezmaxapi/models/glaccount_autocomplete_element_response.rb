...
module EzmaxApi
  ...
  class GlaccountAutocompleteElementResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::GlaccountAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_glaccount_description_x Value to be assigned
    def s_glaccount_description_x=(s_glaccount_description_x)
      if s_glaccount_description_x.nil?
        fail ArgumentError, 's_glaccount_description_x cannot be nil'
      end

      @s_glaccount_description_x = s_glaccount_description_x
    end

    # Custom attribute writer method with validation
    # @param [Object] b_glaccount_isactive Value to be assigned
    def b_glaccount_isactive=(b_glaccount_isactive)
      if b_glaccount_isactive.nil?
        fail ArgumentError, 'b_glaccount_isactive cannot be nil'
      end

      @b_glaccount_isactive = b_glaccount_isactive
    end
