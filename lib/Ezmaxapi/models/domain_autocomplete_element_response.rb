...
module EzmaxApi
  ...
  class DomainAutocompleteElementResponse < ApiModelBase
    ...
    attr_accessor :b_domain_isactive
    ...
    def self.attribute_map
      {
        ...
        :'b_domain_isactive' => :'bDomainIsactive'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::DomainAutocompleteElementResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::DomainAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'b_domain_isactive')
        self.b_domain_isactive = attributes[:'b_domain_isactive']
      else
        self.b_domain_isactive = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @b_domain_isactive.nil?
        invalid_properties.push('invalid value for "b_domain_isactive", b_domain_isactive cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @b_domain_isactive.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_domain_isactive Value to be assigned
    def b_domain_isactive=(b_domain_isactive)
      if b_domain_isactive.nil?
        fail ArgumentError, 'b_domain_isactive cannot be nil'
      end

      @b_domain_isactive = b_domain_isactive
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          b_domain_isactive == o.b_domain_isactive
    end
    ...
    def hash
      [pki_domain_id, s_domain_name, b_domain_isactive].hash
    end
