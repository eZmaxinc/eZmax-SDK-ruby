...
module EzmaxApi
  class FieldEEzsigndocumentStep
    ...
    PENDING_PREMATURELY_ENDED = "PendingPrematurelyEnded".freeze
    ...
    def self.all_vars
      @all_vars ||= [UNSENT, UNSIGNED, PARTIALLY_SIGNED, DECLINED_TO_SIGN, PENDING_PREMATURELY_ENDED, PREMATURELY_ENDED, PENDING_COMPLETION, COMPLETED, DISPOSED].freeze
    end
