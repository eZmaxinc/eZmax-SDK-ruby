...
module EzmaxApi
  class FieldESessionhistoryEndby
    ...
    def self.all_vars
      @all_vars ||= [DECRYPTION, HACK, EXPIRED, HIJACK, DOUBLE_LOGON, GARBAGE, LOGOFF, BAD_AUTH, LOCKED, INACTIVE, INVALID_USER, BAD_USER_TYPE, BAD_IP, FORCED_LOGOFF, SUSPENDED].freeze
    end
