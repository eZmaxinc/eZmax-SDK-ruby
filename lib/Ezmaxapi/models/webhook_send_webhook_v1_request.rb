...
module EzmaxApi
  ...
  class WebhookSendWebhookV1Request < ApiModelBase
    ...
    def hash
      [e_webhook_module, e_webhook_ezsignevent, e_webhook_managementevent, fki_ezsignfolder_id, fki_ezsigndocument_id, fki_ezsignsigner_id, fki_user_id, fki_userstaged_id].hash
    end
