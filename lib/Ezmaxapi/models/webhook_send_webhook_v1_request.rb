...
module EzmaxApi
  ...
  class WebhookSendWebhookV1Request < ApiModelBase
    ...
    attr_accessor :fki_userstaged_id
    ...
    def self.attribute_map
      {
        ...
        :'fki_userstaged_id' => :'fkiUserstagedID'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::WebhookSendWebhookV1Request` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::WebhookSendWebhookV1Request`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fki_userstaged_id')
        self.fki_userstaged_id = attributes[:'fki_userstaged_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@fki_userstaged_id.nil? && @fki_userstaged_id > 65535
        invalid_properties.push('invalid value for "fki_userstaged_id", must be smaller than or equal to 65535.')
      end

      if !@fki_userstaged_id.nil? && @fki_userstaged_id < 1
        invalid_properties.push('invalid value for "fki_userstaged_id", must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@fki_userstaged_id.nil? && @fki_userstaged_id > 65535
      return false if !@fki_userstaged_id.nil? && @fki_userstaged_id < 1
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] fki_userstaged_id Value to be assigned
    def fki_userstaged_id=(fki_userstaged_id)
      if fki_userstaged_id.nil?
        fail ArgumentError, 'fki_userstaged_id cannot be nil'
      end

      if fki_userstaged_id > 65535
        fail ArgumentError, 'invalid value for "fki_userstaged_id", must be smaller than or equal to 65535.'
      end

      if fki_userstaged_id < 1
        fail ArgumentError, 'invalid value for "fki_userstaged_id", must be greater than or equal to 1.'
      end

      @fki_userstaged_id = fki_userstaged_id
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fki_userstaged_id == o.fki_userstaged_id
    end
    ...
    def hash
      [e_webhook_module, e_webhook_ezsignevent, e_webhook_managementevent, e_webhook_realestateevent, fki_ezsignfolder_id, fki_ezsigndocument_id, fki_ezsignsigner_id, fki_user_id, fki_userstaged_id].hash
    end
