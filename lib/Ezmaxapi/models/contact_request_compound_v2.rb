...
module EzmaxApi
  ...
  class ContactRequestCompoundV2 < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'obj_contactinformations' => :'ContactinformationsRequestCompoundV2'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::ContactRequestCompoundV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::ContactRequestCompoundV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_contact_type Value to be assigned
    def e_contact_type=(e_contact_type)
      if e_contact_type.nil?
        fail ArgumentError, 'e_contact_type cannot be nil'
      end

      @e_contact_type = e_contact_type
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] obj_contactinformations Value to be assigned
    def obj_contactinformations=(obj_contactinformations)
      if obj_contactinformations.nil?
        fail ArgumentError, 'obj_contactinformations cannot be nil'
      end

      @obj_contactinformations = obj_contactinformations
    end
    ...
    def hash
      [fki_contacttitle_id, fki_language_id, e_contact_type, s_contact_firstname, s_contact_lastname, s_contact_company, dt_contact_birthdate, s_contact_occupation, t_contact_note, b_contact_isactive, obj_contactinformations].hash
    end
