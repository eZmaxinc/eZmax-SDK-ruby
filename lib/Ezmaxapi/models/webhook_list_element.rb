...
module EzmaxApi
  ...
  class WebhookListElement
    ...
    def hash
      [pki_webhook_id, s_webhook_description, s_webhook_url, s_webhook_event, s_webhook_emailfailed, e_webhook_module, e_webhook_ezsignevent, e_webhook_managementevent, b_webhook_isactive].hash
    end
