...
module EzmaxApi
  ...
  class WebhookListElement < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::WebhookListElement` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::WebhookListElement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_webhook_event Value to be assigned
    def s_webhook_event=(s_webhook_event)
      if s_webhook_event.nil?
        fail ArgumentError, 's_webhook_event cannot be nil'
      end

      @s_webhook_event = s_webhook_event
    end
    ...
    def hash
      [pki_webhook_id, s_webhook_description, s_webhook_url, s_webhook_event, s_webhook_emailfailed, e_webhook_module, e_webhook_ezsignevent, e_webhook_managementevent, e_webhook_realestateevent, b_webhook_isactive, b_webhook_issigned].hash
    end
