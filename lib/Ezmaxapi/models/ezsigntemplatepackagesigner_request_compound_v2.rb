...
module EzmaxApi
  ...
  class EzsigntemplatepackagesignerRequestCompoundV2 < ApiModelBase
    ...
    attr_accessor :e_ezsigntemplatepackagesigner_role
    ...
    def self.attribute_map
      {
        ...
        :'e_ezsigntemplatepackagesigner_role' => :'eEzsigntemplatepackagesignerRole',
    ...
    def self.openapi_types
      {
        ...
        :'e_ezsigntemplatepackagesigner_role' => :'FieldEEzsigntemplatepackagesignerRole',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatepackagesignerRequestCompoundV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatepackagesignerRequestCompoundV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'e_ezsigntemplatepackagesigner_role')
        self.e_ezsigntemplatepackagesigner_role = attributes[:'e_ezsigntemplatepackagesigner_role']
      end
    ...
    def list_invalid_properties
      ...
      if !@pki_ezsigntemplatepackagesigner_id.nil? && @pki_ezsigntemplatepackagesigner_id < 0
    ...
    def valid?
      ...
      return false if !@pki_ezsigntemplatepackagesigner_id.nil? && @pki_ezsigntemplatepackagesigner_id < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_ezsigntemplatepackagesigner_description Value to be assigned
    def s_ezsigntemplatepackagesigner_description=(s_ezsigntemplatepackagesigner_description)
      if s_ezsigntemplatepackagesigner_description.nil?
        fail ArgumentError, 's_ezsigntemplatepackagesigner_description cannot be nil'
      end

      @s_ezsigntemplatepackagesigner_description = s_ezsigntemplatepackagesigner_description
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          e_ezsigntemplatepackagesigner_role == o.e_ezsigntemplatepackagesigner_role &&
    ...
    def hash
      [pki_ezsigntemplatepackagesigner_id, fki_ezsigntemplatepackage_id, fki_ezdoctemplatedocument_id, fki_user_id, fki_usergroup_id, e_ezsigntemplatepackagesigner_role, e_ezsigntemplatepackagesigner_mapping, s_ezsigntemplatepackagesigner_description].hash
    end
