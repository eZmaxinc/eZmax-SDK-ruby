...
module EzmaxApi
  ...
  class AuthenticationexternalAutocompleteElementResponse < ApiModelBase
    ...
    attr_accessor :b_authenticationexternal_isactive
    ...
    def self.attribute_map
      {
        ...
        :'b_authenticationexternal_isactive' => :'bAuthenticationexternalIsactive'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'b_authenticationexternal_isactive' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::AuthenticationexternalAutocompleteElementResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::AuthenticationexternalAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'b_authenticationexternal_isactive')
        self.b_authenticationexternal_isactive = attributes[:'b_authenticationexternal_isactive']
      else
        self.b_authenticationexternal_isactive = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @b_authenticationexternal_isactive.nil?
        invalid_properties.push('invalid value for "b_authenticationexternal_isactive", b_authenticationexternal_isactive cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @b_authenticationexternal_isactive.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_authenticationexternal_isactive Value to be assigned
    def b_authenticationexternal_isactive=(b_authenticationexternal_isactive)
      if b_authenticationexternal_isactive.nil?
        fail ArgumentError, 'b_authenticationexternal_isactive cannot be nil'
      end

      @b_authenticationexternal_isactive = b_authenticationexternal_isactive
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          b_authenticationexternal_isactive == o.b_authenticationexternal_isactive
    end
    ...
    def hash
      [pki_authenticationexternal_id, s_authenticationexternal_description, b_authenticationexternal_isactive].hash
    end
