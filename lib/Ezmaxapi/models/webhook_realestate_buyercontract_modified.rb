...
module EzmaxApi
  ...
  class WebhookRealestateBuyercontractModified < ApiModelBase
    attr_accessor :obj_webhook

    # An array containing details of previous attempts that were made to deliver the message. The array is empty if it's the first attempt.
    attr_accessor :a_obj_attempt

    attr_accessor :obj_buyercontract
    ...
    def self.attribute_map
      {
        ...
        :'obj_buyercontract' => :'objBuyercontract'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'obj_buyercontract' => :'BuyercontractResponse'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::WebhookRealestateBuyercontractModified` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::WebhookRealestateBuyercontractModified`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'obj_buyercontract')
        self.obj_buyercontract = attributes[:'obj_buyercontract']
      else
        self.obj_buyercontract = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @obj_buyercontract.nil?
        invalid_properties.push('invalid value for "obj_buyercontract", obj_buyercontract cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @obj_buyercontract.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] obj_buyercontract Value to be assigned
    def obj_buyercontract=(obj_buyercontract)
      if obj_buyercontract.nil?
        fail ArgumentError, 'obj_buyercontract cannot be nil'
      end

      @obj_buyercontract = obj_buyercontract
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          obj_buyercontract == o.obj_buyercontract
    end
    ...
    def hash
      [obj_webhook, a_obj_attempt, obj_buyercontract].hash
    end
