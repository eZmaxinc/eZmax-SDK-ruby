...
module EzmaxApi
  ...
  class BrandingResponseCompound
    ...
    def hash
      [pki_branding_id, fki_email_id, obj_branding_description, s_branding_description_x, s_branding_name, s_email_address, e_branding_logo, i_branding_colortext, i_branding_colortextlinkbox, i_branding_colortextbutton, i_branding_colorbackground, i_branding_colorbackgroundbutton, i_branding_colorbackgroundsmallbox, b_branding_isactive, s_branding_logourl].hash
    end
