...
module EzmaxApi
  ...
  class AuthenticationexternalListElement < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::AuthenticationexternalListElement` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::AuthenticationexternalListElement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'b_authenticationexternal_connected')
        ...
        self.b_authenticationexternal_connected = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @b_authenticationexternal_connected.nil?
        invalid_properties.push('invalid value for "b_authenticationexternal_connected", b_authenticationexternal_connected cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @b_authenticationexternal_connected.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_authenticationexternal_type Value to be assigned
    def e_authenticationexternal_type=(e_authenticationexternal_type)
      if e_authenticationexternal_type.nil?
        fail ArgumentError, 'e_authenticationexternal_type cannot be nil'
      end

      @e_authenticationexternal_type = e_authenticationexternal_type
    end

    # Custom attribute writer method with validation
    # @param [Object] b_authenticationexternal_connected Value to be assigned
    def b_authenticationexternal_connected=(b_authenticationexternal_connected)
      if b_authenticationexternal_connected.nil?
        fail ArgumentError, 'b_authenticationexternal_connected cannot be nil'
      end

      @b_authenticationexternal_connected = b_authenticationexternal_connected
    end
    ...
    def hash
      [pki_authenticationexternal_id, s_authenticationexternal_description, e_authenticationexternal_type, b_authenticationexternal_connected].hash
    end
