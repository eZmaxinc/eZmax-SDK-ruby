...
module EzmaxApi
  ...
  class WebhookRequest
    ...
    def hash
      [pki_webhook_id, fki_authenticationexternal_id, fki_ezsignfoldertype_id, s_webhook_description, e_webhook_module, e_webhook_ezsignevent, e_webhook_managementevent, s_webhook_url, s_webhook_emailfailed, b_webhook_isactive, b_webhook_issigned, b_webhook_skipsslvalidation].hash
    end
