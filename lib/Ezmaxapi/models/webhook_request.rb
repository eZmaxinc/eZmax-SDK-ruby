...
module EzmaxApi
  ...
  class WebhookRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::WebhookRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [pki_webhook_id, fki_authenticationexternal_id, fki_ezsignfoldertype_id, s_webhook_description, e_webhook_module, e_webhook_ezsignevent, e_webhook_managementevent, e_webhook_realestateevent, s_webhook_url, s_webhook_emailfailed, b_webhook_isactive, b_webhook_issigned, b_webhook_skipsslvalidation].hash
    end
