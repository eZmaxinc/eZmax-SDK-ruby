...
module EzmaxApi
  ...
  class EzsigntemplatesignaturecustomdateResponseCompoundV2 < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatesignaturecustomdateResponseCompoundV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatesignaturecustomdateResponseCompoundV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pki_ezsigntemplatesignaturecustomdate_id')
        ...
        self.pki_ezsigntemplatesignaturecustomdate_id = nil
      end
      ...
      if attributes.key?(:'i_ezsigntemplatesignaturecustomdate_offsetx')
        ...
        self.i_ezsigntemplatesignaturecustomdate_offsetx = nil
      end
      ...
      if attributes.key?(:'i_ezsigntemplatesignaturecustomdate_offsety')
        ...
        self.i_ezsigntemplatesignaturecustomdate_offsety = nil
      end
    ...
    def list_invalid_properties
      ...
      if @pki_ezsigntemplatesignaturecustomdate_id.nil?
        invalid_properties.push('invalid value for "pki_ezsigntemplatesignaturecustomdate_id", pki_ezsigntemplatesignaturecustomdate_id cannot be nil.')
      end
      ...
      if @i_ezsigntemplatesignaturecustomdate_offsetx.nil?
        invalid_properties.push('invalid value for "i_ezsigntemplatesignaturecustomdate_offsetx", i_ezsigntemplatesignaturecustomdate_offsetx cannot be nil.')
      end

      if @i_ezsigntemplatesignaturecustomdate_offsety.nil?
        invalid_properties.push('invalid value for "i_ezsigntemplatesignaturecustomdate_offsety", i_ezsigntemplatesignaturecustomdate_offsety cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pki_ezsigntemplatesignaturecustomdate_id.nil?
      return false if @pki_ezsigntemplatesignaturecustomdate_id < 0
      return false if @i_ezsigntemplatesignaturecustomdate_offsetx.nil?
      return false if @i_ezsigntemplatesignaturecustomdate_offsety.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_ezsigntemplatesignaturecustomdate_format Value to be assigned
    def s_ezsigntemplatesignaturecustomdate_format=(s_ezsigntemplatesignaturecustomdate_format)
      if s_ezsigntemplatesignaturecustomdate_format.nil?
        fail ArgumentError, 's_ezsigntemplatesignaturecustomdate_format cannot be nil'
      end

      @s_ezsigntemplatesignaturecustomdate_format = s_ezsigntemplatesignaturecustomdate_format
    end
    ...
    def hash
      [pki_ezsigntemplatesignaturecustomdate_id, i_ezsigntemplatesignaturecustomdate_offsetx, i_ezsigntemplatesignaturecustomdate_offsety, s_ezsigntemplatesignaturecustomdate_format].hash
    end
