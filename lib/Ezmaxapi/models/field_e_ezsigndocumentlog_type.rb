...
module EzmaxApi
  class FieldEEzsigndocumentlogType
    ...
    def self.all_vars
      @all_vars ||= [CLONE, LOGIN, SENDCODE, BADCODE, GOODCODE, AUTHENTICATION, CREATEPAGE, DOWNLOAD, SEND, SIGN, UPLOAD, VIEW, COMPLETION, CHANGELIMITDATE, UNSIGN, IMPORT_FROM_INSTANET, SEND_EMAIL, FORM_COMPLETION, SIGNATURE_ATTACHMENT_ADD, SIGNATURE_ATTACHMENT_VALIDATION, SIGNATURE_ATTACHMENT_REFUSED, SIGNATURE_ATTACHMENT_DELETED, DECLINED_TO_SIGN, DELAYED_SEND_EMAIL, REGENERATE_PAGE, REGENERATE_PAGE_FORM, REASSIGN].freeze
    end
