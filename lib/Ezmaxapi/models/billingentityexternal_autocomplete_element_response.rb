...
module EzmaxApi
  ...
  class BillingentityexternalAutocompleteElementResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::BillingentityexternalAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_billingentityexternal_isactive Value to be assigned
    def b_billingentityexternal_isactive=(b_billingentityexternal_isactive)
      if b_billingentityexternal_isactive.nil?
        fail ArgumentError, 'b_billingentityexternal_isactive cannot be nil'
      end

      @b_billingentityexternal_isactive = b_billingentityexternal_isactive
    end
