...
module EzmaxApi
  ...
  class UsergroupdelegationRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::UsergroupdelegationRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::UsergroupdelegationRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@pki_usergroupdelegation_id.nil? && @pki_usergroupdelegation_id > 65535
        invalid_properties.push('invalid value for "pki_usergroupdelegation_id", must be smaller than or equal to 65535.')
      end

      if !@pki_usergroupdelegation_id.nil? && @pki_usergroupdelegation_id < 0
    ...
    def valid?
      ...
      return false if !@pki_usergroupdelegation_id.nil? && @pki_usergroupdelegation_id > 65535
      return false if !@pki_usergroupdelegation_id.nil? && @pki_usergroupdelegation_id < 0
    ...
    def hash
      [pki_usergroupdelegation_id, fki_usergroup_id, fki_user_id].hash
    end
