...
module EzmaxApi
  # A User List Element
  class UserListElement < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::UserListElement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [pki_user_id, fki_agent_id, fki_broker_id, s_user_firstname, s_user_lastname, s_user_loginname, b_user_isactive, b_user_suspended, e_user_type, e_user_origin, e_user_ezsignaccess, dt_user_ezsignprepaidexpiration, s_email_address, s_user_jobtitle].hash
    end
