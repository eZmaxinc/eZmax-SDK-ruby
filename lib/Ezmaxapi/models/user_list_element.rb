...
module EzmaxApi
  ...
  class UserListElement < ApiModelBase
    ...
    def hash
      [pki_user_id, s_user_firstname, s_user_lastname, s_user_loginname, b_user_isactive, b_user_suspended, e_user_type, e_user_origin, e_user_ezsignaccess, dt_user_ezsignprepaidexpiration, s_email_address, s_user_jobtitle].hash
    end
