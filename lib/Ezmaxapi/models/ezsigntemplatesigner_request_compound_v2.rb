...
module EzmaxApi
  ...
  class EzsigntemplatesignerRequestCompoundV2 < ApiModelBase
    ...
    attr_accessor :e_ezsigntemplatesigner_role
    ...
    def self.attribute_map
      {
        ...
        :'e_ezsigntemplatesigner_role' => :'eEzsigntemplatesignerRole',
    ...
    def self.openapi_types
      {
        ...
        :'e_ezsigntemplatesigner_role' => :'FieldEEzsigntemplatesignerRole',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatesignerRequestCompoundV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatesignerRequestCompoundV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'e_ezsigntemplatesigner_role')
        self.e_ezsigntemplatesigner_role = attributes[:'e_ezsigntemplatesigner_role']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          e_ezsigntemplatesigner_role == o.e_ezsigntemplatesigner_role &&
    ...
    def hash
      [pki_ezsigntemplatesigner_id, fki_ezsigntemplate_id, fki_user_id, fki_usergroup_id, fki_ezdoctemplatedocument_id, e_ezsigntemplatesigner_role, e_ezsigntemplatesigner_mapping, s_ezsigntemplatesigner_description].hash
    end
