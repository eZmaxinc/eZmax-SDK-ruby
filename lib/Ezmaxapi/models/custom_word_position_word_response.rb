...
module EzmaxApi
  ...
  class CustomWordPositionWordResponse < ApiModelBase
    # The searched word
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomWordPositionWordResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'a_obj_word_position_occurence')
        ...
        self.a_obj_word_position_occurence = nil
      end
    end
    ...
    # @param [Object] s_word Value to be assigned
    def s_word=(s_word)
      if s_word.nil?
        fail ArgumentError, 's_word cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] a_obj_word_position_occurence Value to be assigned
    def a_obj_word_position_occurence=(a_obj_word_position_occurence)
      if a_obj_word_position_occurence.nil?
        fail ArgumentError, 'a_obj_word_position_occurence cannot be nil'
      end

      @a_obj_word_position_occurence = a_obj_word_position_occurence
    end
