...
module EzmaxApi
  ...
  class CustomEzsigndocumentRequest < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'a_obj_ezsigndocumentdependency' => :'Array<EzsigndocumentdependencyRequestCompound>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::CustomEzsigndocumentRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomEzsigndocumentRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'a_obj_ezsigndocumentdependency')
        ...
        self.a_obj_ezsigndocumentdependency = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @a_obj_ezsigndocumentdependency.nil?
        invalid_properties.push('invalid value for "a_obj_ezsigndocumentdependency", a_obj_ezsigndocumentdependency cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @a_obj_ezsigndocumentdependency.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezsigndocumentdependency Value to be assigned
    def a_obj_ezsigndocumentdependency=(a_obj_ezsigndocumentdependency)
      if a_obj_ezsigndocumentdependency.nil?
        fail ArgumentError, 'a_obj_ezsigndocumentdependency cannot be nil'
      end

      @a_obj_ezsigndocumentdependency = a_obj_ezsigndocumentdependency
    end
    ...
    def hash
      [pki_ezsigndocument_id, a_obj_ezsigndocumentdependency].hash
    end
