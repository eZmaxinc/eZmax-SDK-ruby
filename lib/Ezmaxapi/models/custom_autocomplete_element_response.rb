...
module EzmaxApi
  ...
  class CustomAutocompleteElementResponse
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'b_active')
        self.b_active = attributes[:'b_active']
      else
        self.b_active = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @b_active.nil?
        invalid_properties.push('invalid value for "b_active", b_active cannot be nil.')
      end
    ...
    def hash
      [s_category, s_label, s_value, m_value, b_active].hash
    end
