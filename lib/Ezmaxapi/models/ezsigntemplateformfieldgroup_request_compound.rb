...
module EzmaxApi
  ...
  class EzsigntemplateformfieldgroupRequestCompound
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplateformfieldgroupRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'e_ezsigntemplateformfieldgroup_signerrequirement')
        ...
        self.e_ezsigntemplateformfieldgroup_signerrequirement = nil
      end
    ...
    def list_invalid_properties
      ...
      if @e_ezsigntemplateformfieldgroup_signerrequirement.nil?
        invalid_properties.push('invalid value for "e_ezsigntemplateformfieldgroup_signerrequirement", e_ezsigntemplateformfieldgroup_signerrequirement cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @e_ezsigntemplateformfieldgroup_signerrequirement.nil?
