...
module EzmaxApi
  ...
  class EzsigntemplateformfieldgroupRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplateformfieldgroupRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplateformfieldgroupRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @s_ezsigntemplateformfieldgroup_label.to_s.length < 1
        invalid_properties.push('invalid value for "s_ezsigntemplateformfieldgroup_label", the character length must be greater than or equal to 1.')
      end
      ...
      if !@s_ezsigntemplateformfieldgroup_textvalidationcustommessage.nil? && @s_ezsigntemplateformfieldgroup_textvalidationcustommessage.to_s.length < 0
        invalid_properties.push('invalid value for "s_ezsigntemplateformfieldgroup_textvalidationcustommessage", the character length must be greater than or equal to 0.')
      end
    ...
    def s_ezsigntemplateformfieldgroup_label=(s_ezsigntemplateformfieldgroup_label)
      ...
      if s_ezsigntemplateformfieldgroup_label.to_s.length < 1
        fail ArgumentError, 'invalid value for "s_ezsigntemplateformfieldgroup_label", the character length must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_ezsigntemplateformfieldgroup_defaultvalue Value to be assigned
    def s_ezsigntemplateformfieldgroup_defaultvalue=(s_ezsigntemplateformfieldgroup_defaultvalue)
      if s_ezsigntemplateformfieldgroup_defaultvalue.nil?
        fail ArgumentError, 's_ezsigntemplateformfieldgroup_defaultvalue cannot be nil'
      end

      @s_ezsigntemplateformfieldgroup_defaultvalue = s_ezsigntemplateformfieldgroup_defaultvalue
    end
    ...
    def s_ezsigntemplateformfieldgroup_textvalidationcustommessage=(s_ezsigntemplateformfieldgroup_textvalidationcustommessage)
      ...
      if s_ezsigntemplateformfieldgroup_textvalidationcustommessage.to_s.length < 0
        fail ArgumentError, 'invalid value for "s_ezsigntemplateformfieldgroup_textvalidationcustommessage", the character length must be greater than or equal to 0.'
      end
