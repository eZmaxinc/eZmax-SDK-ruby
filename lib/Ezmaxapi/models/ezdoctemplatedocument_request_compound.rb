...
module EzmaxApi
  ...
  class EzdoctemplatedocumentRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzdoctemplatedocumentRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzdoctemplatedocumentRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@pki_ezdoctemplatedocument_id.nil? && @pki_ezdoctemplatedocument_id > 65535
        invalid_properties.push('invalid value for "pki_ezdoctemplatedocument_id", must be smaller than or equal to 65535.')
      end

      if !@pki_ezdoctemplatedocument_id.nil? && @pki_ezdoctemplatedocument_id < 0
      ...
      if !@fki_ezdoctemplatefieldtypecategory_id.nil? && @fki_ezdoctemplatefieldtypecategory_id > 255
        invalid_properties.push('invalid value for "fki_ezdoctemplatefieldtypecategory_id", must be smaller than or equal to 255.')
      end

      if !@fki_ezdoctemplatefieldtypecategory_id.nil? && @fki_ezdoctemplatefieldtypecategory_id < 0
    ...
    def valid?
      ...
      return false if !@pki_ezdoctemplatedocument_id.nil? && @pki_ezdoctemplatedocument_id > 65535
      return false if !@pki_ezdoctemplatedocument_id.nil? && @pki_ezdoctemplatedocument_id < 0
      ...
      return false if !@fki_ezdoctemplatefieldtypecategory_id.nil? && @fki_ezdoctemplatefieldtypecategory_id > 255
      return false if !@fki_ezdoctemplatefieldtypecategory_id.nil? && @fki_ezdoctemplatefieldtypecategory_id < 0
    ...
    def hash
      [pki_ezdoctemplatedocument_id, fki_language_id, fki_ezsignfoldertype_id, fki_ezdoctemplatetype_id, fki_ezdoctemplatefieldtypecategory_id, e_ezdoctemplatedocument_privacylevel, b_ezdoctemplatedocument_isactive, obj_ezdoctemplatedocument_name].hash
    end
