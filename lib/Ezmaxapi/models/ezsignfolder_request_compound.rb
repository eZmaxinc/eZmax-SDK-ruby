...
module EzmaxApi
  ...
  class EzsignfolderRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignfolderRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsignfolder_sendreminderfrequency Value to be assigned
    def e_ezsignfolder_sendreminderfrequency=(e_ezsignfolder_sendreminderfrequency)
      if e_ezsignfolder_sendreminderfrequency.nil?
        fail ArgumentError, 'e_ezsignfolder_sendreminderfrequency cannot be nil'
      end
    ...
    def hash
      [pki_ezsignfolder_id, fki_ezsignfoldertype_id, fki_timezone_id, fki_ezsigntsarequirement_id, s_ezsignfolder_description, t_ezsignfolder_note, e_ezsignfolder_sendreminderfrequency, s_ezsignfolder_externalid].hash
    end
