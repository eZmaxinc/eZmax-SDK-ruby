...
module EzmaxApi
  # A Discussion Object
  class DiscussionResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::DiscussionResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::DiscussionResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'a_obj_discussionmembership')
        if (value = attributes[:'a_obj_discussionmembership']).is_a?(Array)
          self.a_obj_discussionmembership = value
        end
      else
        self.a_obj_discussionmembership = nil
      end

      if attributes.key?(:'a_obj_discussionmessage')
        if (value = attributes[:'a_obj_discussionmessage']).is_a?(Array)
          self.a_obj_discussionmessage = value
        end
      else
        self.a_obj_discussionmessage = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @a_obj_discussionmessage.nil?
        invalid_properties.push('invalid value for "a_obj_discussionmessage", a_obj_discussionmessage cannot be nil.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_discussion_closed Value to be assigned
    def b_discussion_closed=(b_discussion_closed)
      if b_discussion_closed.nil?
        fail ArgumentError, 'b_discussion_closed cannot be nil'
      end

      @b_discussion_closed = b_discussion_closed
    end

    # Custom attribute writer method with validation
    # @param [Object] i_discussionmessage_count Value to be assigned
    def i_discussionmessage_count=(i_discussionmessage_count)
      if i_discussionmessage_count.nil?
        fail ArgumentError, 'i_discussionmessage_count cannot be nil'
      end

      @i_discussionmessage_count = i_discussionmessage_count
    end

    # Custom attribute writer method with validation
    # @param [Object] i_discussionmessage_countunread Value to be assigned
    def i_discussionmessage_countunread=(i_discussionmessage_countunread)
      if i_discussionmessage_countunread.nil?
        fail ArgumentError, 'i_discussionmessage_countunread cannot be nil'
      end

      @i_discussionmessage_countunread = i_discussionmessage_countunread
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_discussionmembership Value to be assigned
    def a_obj_discussionmembership=(a_obj_discussionmembership)
      if a_obj_discussionmembership.nil?
        fail ArgumentError, 'a_obj_discussionmembership cannot be nil'
      end

      @a_obj_discussionmembership = a_obj_discussionmembership
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_discussionmessage Value to be assigned
    def a_obj_discussionmessage=(a_obj_discussionmessage)
      if a_obj_discussionmessage.nil?
        fail ArgumentError, 'a_obj_discussionmessage cannot be nil'
      end

      @a_obj_discussionmessage = a_obj_discussionmessage
    end
