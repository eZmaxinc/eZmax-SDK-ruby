...
module EzmaxApi
  ...
  class ActivesessionResponseCompound < ApiModelBase
    ...
    attr_accessor :dt_user_npsrequest
    ...
    attr_accessor :b_activesession_maillinglistrequest
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::ActivesessionResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dt_user_npsrequest')
        self.dt_user_npsrequest = attributes[:'dt_user_npsrequest']
      end
      ...
      if attributes.key?(:'b_activesession_maillinglistrequest')
        self.b_activesession_maillinglistrequest = attributes[:'b_activesession_maillinglistrequest']
      end
    end
    ...
    def list_invalid_properties
      ...
      pattern = Regexp.new(/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/)
      if !@dt_user_npsrequest.nil? && @dt_user_npsrequest !~ pattern
        invalid_properties.push("invalid value for \"dt_user_npsrequest\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if !@dt_user_npsrequest.nil? && @dt_user_npsrequest !~ Regexp.new(/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/)
    ...
    # Custom attribute writer method with validation
    # @param [Object] dt_user_npsrequest Value to be assigned
    def dt_user_npsrequest=(dt_user_npsrequest)
      if dt_user_npsrequest.nil?
        fail ArgumentError, 'dt_user_npsrequest cannot be nil'
      end

      pattern = Regexp.new(/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1])$/)
      if dt_user_npsrequest !~ pattern
        fail ArgumentError, "invalid value for \"dt_user_npsrequest\", must conform to the pattern #{pattern}."
      end

      @dt_user_npsrequest = dt_user_npsrequest
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dt_user_npsrequest == o.dt_user_npsrequest &&
          ...
          b_activesession_maillinglistrequest == o.b_activesession_maillinglistrequest
    end
