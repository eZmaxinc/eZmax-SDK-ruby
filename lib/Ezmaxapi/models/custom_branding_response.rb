...
module EzmaxApi
  ...
  class CustomBrandingResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::CustomBrandingResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomBrandingResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_branding_logointerfaceurl')
        ...
        self.s_branding_logointerfaceurl = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @s_branding_logointerfaceurl.nil?
        invalid_properties.push('invalid value for "s_branding_logointerfaceurl", s_branding_logointerfaceurl cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @s_branding_logointerfaceurl.nil?
      return false if @s_branding_logointerfaceurl !~ Regexp.new(/^(https|http):\/\/[^\s\/$.?#].[^\s]*$/)
      true
    end
    ...
    def hash
      [i_branding_color, s_branding_logointerfaceurl].hash
    end
