...
module EzmaxApi
  ...
  class ProvinceAutocompleteElementResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::ProvinceAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_province_isactive Value to be assigned
    def b_province_isactive=(b_province_isactive)
      if b_province_isactive.nil?
        fail ArgumentError, 'b_province_isactive cannot be nil'
      end

      @b_province_isactive = b_province_isactive
    end
