...
module EzmaxApi
  ...
  class EzsignfolderResponseV3 < ApiModelBase
    ...
    attr_accessor :i_ezsignfolder_stepcurrent
    ...
    attr_accessor :e_ezsignfolder_messageorder
    ...
    def self.attribute_map
      {
        ...
        :'i_ezsignfolder_stepcurrent' => :'iEzsignfolderStepcurrent',
    ...
    def self.openapi_types
      {
        ...
        :'i_ezsignfolder_stepcurrent' => :'Integer',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignfolderResponseV3` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignfolderResponseV3`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'i_ezsignfolder_stepcurrent')
        self.i_ezsignfolder_stepcurrent = attributes[:'i_ezsignfolder_stepcurrent']
      end
      ...
      if attributes.key?(:'e_ezsignfolder_messageorder')
        self.e_ezsignfolder_messageorder = attributes[:'e_ezsignfolder_messageorder']
      else
        self.e_ezsignfolder_messageorder = 'GlobalFirst'
      end
    ...
    def list_invalid_properties
      ...
      if !@i_ezsignfolder_stepcurrent.nil? && @i_ezsignfolder_stepcurrent > 255
        invalid_properties.push('invalid value for "i_ezsignfolder_stepcurrent", must be smaller than or equal to 255.')
      end

      if !@i_ezsignfolder_stepcurrent.nil? && @i_ezsignfolder_stepcurrent < 0
        invalid_properties.push('invalid value for "i_ezsignfolder_stepcurrent", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@i_ezsignfolder_stepcurrent.nil? && @i_ezsignfolder_stepcurrent > 255
      return false if !@i_ezsignfolder_stepcurrent.nil? && @i_ezsignfolder_stepcurrent < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] i_ezsignfolder_stepcurrent Value to be assigned
    def i_ezsignfolder_stepcurrent=(i_ezsignfolder_stepcurrent)
      if i_ezsignfolder_stepcurrent.nil?
        fail ArgumentError, 'i_ezsignfolder_stepcurrent cannot be nil'
      end

      if i_ezsignfolder_stepcurrent > 255
        fail ArgumentError, 'invalid value for "i_ezsignfolder_stepcurrent", must be smaller than or equal to 255.'
      end

      if i_ezsignfolder_stepcurrent < 0
        fail ArgumentError, 'invalid value for "i_ezsignfolder_stepcurrent", must be greater than or equal to 0.'
      end

      @i_ezsignfolder_stepcurrent = i_ezsignfolder_stepcurrent
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          i_ezsignfolder_stepcurrent == o.i_ezsignfolder_stepcurrent &&
          ...
          e_ezsignfolder_messageorder == o.e_ezsignfolder_messageorder &&
