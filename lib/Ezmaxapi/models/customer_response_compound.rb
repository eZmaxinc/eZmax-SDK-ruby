...
module EzmaxApi
  # A Customer Object
  class CustomerResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::CustomerResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomerResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      return false if @t_customer_comment !~ Regexp.new(/^.{0,65535}$/)
    ...
    # Custom attribute writer method with validation
    # @param [Object] fki_image_id Value to be assigned
    def fki_image_id=(fki_image_id)
      if fki_image_id.nil?
        fail ArgumentError, 'fki_image_id cannot be nil'
      end

      @fki_image_id = fki_image_id
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_customer_variableexpensefinanced Value to be assigned
    def b_customer_variableexpensefinanced=(b_customer_variableexpensefinanced)
      if b_customer_variableexpensefinanced.nil?
        fail ArgumentError, 'b_customer_variableexpensefinanced cannot be nil'
      end

      @b_customer_variableexpensefinanced = b_customer_variableexpensefinanced
    end

    # Custom attribute writer method with validation
    # @param [Object] b_customer_variableexpensefinancedtaxes Value to be assigned
    def b_customer_variableexpensefinancedtaxes=(b_customer_variableexpensefinancedtaxes)
      if b_customer_variableexpensefinancedtaxes.nil?
        fail ArgumentError, 'b_customer_variableexpensefinancedtaxes cannot be nil'
      end

      @b_customer_variableexpensefinancedtaxes = b_customer_variableexpensefinancedtaxes
    end

    # Custom attribute writer method with validation
    # @param [Object] b_customer_supplychargefinanced Value to be assigned
    def b_customer_supplychargefinanced=(b_customer_supplychargefinanced)
      if b_customer_supplychargefinanced.nil?
        fail ArgumentError, 'b_customer_supplychargefinanced cannot be nil'
      end

      @b_customer_supplychargefinanced = b_customer_supplychargefinanced
    end

    # Custom attribute writer method with validation
    # @param [Object] b_customer_supplychargefinancedtaxes Value to be assigned
    def b_customer_supplychargefinancedtaxes=(b_customer_supplychargefinancedtaxes)
      if b_customer_supplychargefinancedtaxes.nil?
        fail ArgumentError, 'b_customer_supplychargefinancedtaxes cannot be nil'
      end

      @b_customer_supplychargefinancedtaxes = b_customer_supplychargefinancedtaxes
    end

    # Custom attribute writer method with validation
    # @param [Object] b_customer_attendance Value to be assigned
    def b_customer_attendance=(b_customer_attendance)
      if b_customer_attendance.nil?
        fail ArgumentError, 'b_customer_attendance cannot be nil'
      end

      @b_customer_attendance = b_customer_attendance
    end

    # Custom attribute writer method with validation
    # @param [Object] e_customer_type Value to be assigned
    def e_customer_type=(e_customer_type)
      if e_customer_type.nil?
        fail ArgumentError, 'e_customer_type cannot be nil'
      end

      @e_customer_type = e_customer_type
    end

    # Custom attribute writer method with validation
    # @param [Object] e_customer_marketingcorrespondence Value to be assigned
    def e_customer_marketingcorrespondence=(e_customer_marketingcorrespondence)
      if e_customer_marketingcorrespondence.nil?
        fail ArgumentError, 'e_customer_marketingcorrespondence cannot be nil'
      end

      @e_customer_marketingcorrespondence = e_customer_marketingcorrespondence
    end

    # Custom attribute writer method with validation
    # @param [Object] b_customer_blackcopycarbon Value to be assigned
    def b_customer_blackcopycarbon=(b_customer_blackcopycarbon)
      if b_customer_blackcopycarbon.nil?
        fail ArgumentError, 'b_customer_blackcopycarbon cannot be nil'
      end

      @b_customer_blackcopycarbon = b_customer_blackcopycarbon
    end

    # Custom attribute writer method with validation
    # @param [Object] b_customer_unsubscribeinfo Value to be assigned
    def b_customer_unsubscribeinfo=(b_customer_unsubscribeinfo)
      if b_customer_unsubscribeinfo.nil?
        fail ArgumentError, 'b_customer_unsubscribeinfo cannot be nil'
      end

      @b_customer_unsubscribeinfo = b_customer_unsubscribeinfo
    end
