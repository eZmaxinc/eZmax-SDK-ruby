...
module EzmaxApi
  ...
  class EzsigntemplateelementdependencyRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplateelementdependencyRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplateelementdependencyRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@pki_ezsigntemplateelementdependency_id.nil? && @pki_ezsigntemplateelementdependency_id > 16777215
        invalid_properties.push('invalid value for "pki_ezsigntemplateelementdependency_id", must be smaller than or equal to 16777215.')
      end
      ...
      if !@s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel.nil? && @s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel.to_s.length < 1
        invalid_properties.push('invalid value for "s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel", the character length must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if !@pki_ezsigntemplateelementdependency_id.nil? && @pki_ezsigntemplateelementdependency_id > 16777215
    ...
    def pki_ezsigntemplateelementdependency_id=(pki_ezsigntemplateelementdependency_id)
      ...
      if pki_ezsigntemplateelementdependency_id > 16777215
        fail ArgumentError, 'invalid value for "pki_ezsigntemplateelementdependency_id", must be smaller than or equal to 16777215.'
      end
    ...
    def s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel=(s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel)
      ...
      if s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel.to_s.length < 1
        fail ArgumentError, 'invalid value for "s_ezsigntemplateelementdependency_ezsigntemplateformfieldgrouplabel", the character length must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsigntemplateelementdependency_validation Value to be assigned
    def e_ezsigntemplateelementdependency_validation=(e_ezsigntemplateelementdependency_validation)
      if e_ezsigntemplateelementdependency_validation.nil?
        fail ArgumentError, 'e_ezsigntemplateelementdependency_validation cannot be nil'
      end

      @e_ezsigntemplateelementdependency_validation = e_ezsigntemplateelementdependency_validation
    end
