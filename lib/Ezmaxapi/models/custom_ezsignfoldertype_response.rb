...
module EzmaxApi
  ...
  class CustomEzsignfoldertypeResponse
    ...
    def hash
      [pki_ezsignfoldertype_id, s_ezsignfoldertype_name_x, b_ezsignfoldertype_includeproofsigner, b_ezsignfoldertype_includeproofuser, b_ezsignfoldertype_delegate, b_ezsignfoldertype_reassign].hash
    end
