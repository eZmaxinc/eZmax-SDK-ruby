...
module EzmaxApi
  ...
  class BrandingRequest
    ...
    attr_accessor :s_branding_logointerface_base64
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::BrandingRequest` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::BrandingRequest`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_branding_logointerface_base64')
        self.s_branding_logointerface_base64 = attributes[:'s_branding_logointerface_base64']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          s_branding_logointerface_base64 == o.s_branding_logointerface_base64 &&
    ...
    def hash
      [pki_branding_id, obj_branding_description, e_branding_logo, s_branding_base64, e_branding_logointerface, s_branding_logointerface_base64, i_branding_colortext, i_branding_colortextlinkbox, i_branding_colortextbutton, i_branding_colorbackground, i_branding_colorbackgroundbutton, i_branding_colorbackgroundsmallbox, i_branding_interfacecolor, s_branding_name, s_email_address, b_branding_isactive].hash
    end
