...
module EzmaxApi
  ...
  class EzsigntemplateformfieldResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplateformfieldResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplateformfieldResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_ezsigntemplateformfield_label Value to be assigned
    def s_ezsigntemplateformfield_label=(s_ezsigntemplateformfield_label)
      if s_ezsigntemplateformfield_label.nil?
        fail ArgumentError, 's_ezsigntemplateformfield_label cannot be nil'
      end

      @s_ezsigntemplateformfield_label = s_ezsigntemplateformfield_label
    end
