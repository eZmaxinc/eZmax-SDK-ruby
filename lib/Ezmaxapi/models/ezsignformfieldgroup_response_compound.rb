...
module EzmaxApi
  ...
  class EzsignformfieldgroupResponseCompound < ApiModelBase
    ...
    attr_accessor :dt_ezsignformfieldgroup_completed
    ...
    def self.attribute_map
      {
        ...
        :'dt_ezsignformfieldgroup_completed' => :'dtEzsignformfieldgroupCompleted',
    ...
    def self.openapi_types
      {
        ...
        :'dt_ezsignformfieldgroup_completed' => :'String',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignformfieldgroupResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'dt_ezsignformfieldgroup_completed')
        self.dt_ezsignformfieldgroup_completed = attributes[:'dt_ezsignformfieldgroup_completed']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          dt_ezsignformfieldgroup_completed == o.dt_ezsignformfieldgroup_completed &&
    ...
    def hash
      [pki_ezsignformfieldgroup_id, fki_ezsigndocument_id, e_ezsignformfieldgroup_type, e_ezsignformfieldgroup_signerrequirement, s_ezsignformfieldgroup_label, i_ezsignformfieldgroup_step, s_ezsignformfieldgroup_defaultvalue, i_ezsignformfieldgroup_filledmin, i_ezsignformfieldgroup_filledmax, b_ezsignformfieldgroup_readonly, i_ezsignformfieldgroup_maxlength, b_ezsignformfieldgroup_encrypted, e_ezsignformfieldgroup_textvalidation, s_ezsignformfieldgroup_regexp, s_ezsignformfieldgroup_textvalidationcustommessage, t_ezsignformfieldgroup_tooltip, e_ezsignformfieldgroup_tooltipposition, dt_ezsignformfieldgroup_completed, a_obj_ezsignformfield, a_obj_dropdown_element, a_obj_ezsignformfieldgroupsigner].hash
    end
