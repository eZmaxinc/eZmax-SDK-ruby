...
module EzmaxApi
  class FieldEEzsigntemplatesignatureTooltipposition
    ...
    def build_from_hash(value)
      return value if FieldEEzsigntemplatesignatureTooltipposition.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FieldEEzsigntemplatesignatureTooltipposition"
    end
  end
end
