...
module EzmaxApi
  ...
  class EzsigntemplatepackageRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatepackageRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatepackageRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@pki_ezsigntemplatepackage_id.nil? && @pki_ezsigntemplatepackage_id < 0
    ...
    def valid?
      ...
      return false if !@pki_ezsigntemplatepackage_id.nil? && @pki_ezsigntemplatepackage_id < 0
    ...
    def hash
      [pki_ezsigntemplatepackage_id, fki_ezsignfoldertype_id, fki_ezdoctemplatedocument_id, fki_language_id, s_ezsigntemplatepackage_description, b_ezsigntemplatepackage_adminonly, b_ezsigntemplatepackage_isactive].hash
    end
