...
module EzmaxApi
  ...
  class EzsigntemplatepackageRequestCompound
    ...
    def hash
      [pki_ezsigntemplatepackage_id, fki_ezsignfoldertype_id, fki_language_id, s_ezsigntemplatepackage_description, b_ezsigntemplatepackage_adminonly, b_ezsigntemplatepackage_isactive].hash
    end
