...
module EzmaxApi
  ...
  class EzsigntemplatedocumentResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatedocumentResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_ezsigntemplatedocument_name Value to be assigned
    def s_ezsigntemplatedocument_name=(s_ezsigntemplatedocument_name)
      if s_ezsigntemplatedocument_name.nil?
        fail ArgumentError, 's_ezsigntemplatedocument_name cannot be nil'
      end

      @s_ezsigntemplatedocument_name = s_ezsigntemplatedocument_name
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] i_ezsigntemplatedocument_signaturetotal Value to be assigned
    def i_ezsigntemplatedocument_signaturetotal=(i_ezsigntemplatedocument_signaturetotal)
      if i_ezsigntemplatedocument_signaturetotal.nil?
        fail ArgumentError, 'i_ezsigntemplatedocument_signaturetotal cannot be nil'
      end

      @i_ezsigntemplatedocument_signaturetotal = i_ezsigntemplatedocument_signaturetotal
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsigntemplatedocument_formfieldtotal Value to be assigned
    def i_ezsigntemplatedocument_formfieldtotal=(i_ezsigntemplatedocument_formfieldtotal)
      if i_ezsigntemplatedocument_formfieldtotal.nil?
        fail ArgumentError, 'i_ezsigntemplatedocument_formfieldtotal cannot be nil'
      end

      @i_ezsigntemplatedocument_formfieldtotal = i_ezsigntemplatedocument_formfieldtotal
    end

    # Custom attribute writer method with validation
    # @param [Object] b_ezsigntemplatedocument_hassignedsignatures Value to be assigned
    def b_ezsigntemplatedocument_hassignedsignatures=(b_ezsigntemplatedocument_hassignedsignatures)
      if b_ezsigntemplatedocument_hassignedsignatures.nil?
        fail ArgumentError, 'b_ezsigntemplatedocument_hassignedsignatures cannot be nil'
      end

      @b_ezsigntemplatedocument_hassignedsignatures = b_ezsigntemplatedocument_hassignedsignatures
    end
