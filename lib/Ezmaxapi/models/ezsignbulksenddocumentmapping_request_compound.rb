...
module EzmaxApi
  ...
  class EzsignbulksenddocumentmappingRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignbulksenddocumentmappingRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignbulksenddocumentmappingRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@pki_ezsignbulksenddocumentmapping_id.nil? && @pki_ezsignbulksenddocumentmapping_id < 0
    ...
    def valid?
      ...
      return false if !@pki_ezsignbulksenddocumentmapping_id.nil? && @pki_ezsignbulksenddocumentmapping_id < 0
    ...
    def hash
      [pki_ezsignbulksenddocumentmapping_id, fki_ezsignbulksend_id, fki_ezsigntemplatepackage_id, fki_ezsigntemplate_id].hash
    end
