...
module EzmaxApi
  ...
  class UserResponseCompound < ApiModelBase
    ...
    attr_accessor :dt_user_lastlogondate

    # The date at which the User's password was last changed
    attr_accessor :dt_user_passwordchanged
    ...
    attr_accessor :b_user_suspended
    ...
    attr_accessor :b_user_ezsigntemplaterolegrouping
    ...
    def self.attribute_map
      {
        ...
        :'b_user_suspended' => :'bUserSuspended',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::UserResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::UserResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_timezone_name')
        self.s_timezone_name = attributes[:'s_timezone_name']
      else
        self.s_timezone_name = nil
      end
      ...
      if attributes.key?(:'dt_user_lastlogondate')
        self.dt_user_lastlogondate = attributes[:'dt_user_lastlogondate']
      end

      if attributes.key?(:'dt_user_passwordchanged')
        self.dt_user_passwordchanged = attributes[:'dt_user_passwordchanged']
      end
      ...
      if attributes.key?(:'b_user_suspended')
        self.b_user_suspended = attributes[:'b_user_suspended']
      end
      ...
      if attributes.key?(:'b_user_changepassword')
        ...
        self.b_user_changepassword = nil
      end

      if attributes.key?(:'b_user_ezsigntemplaterolegrouping')
        self.b_user_ezsigntemplaterolegrouping = attributes[:'b_user_ezsigntemplaterolegrouping']
      end
    ...
    def list_invalid_properties
      ...
      if @s_timezone_name.nil?
        invalid_properties.push('invalid value for "s_timezone_name", s_timezone_name cannot be nil.')
      end
      ...
      if !@dt_user_lastlogondate.nil? && @dt_user_lastlogondate !~ pattern
        invalid_properties.push("invalid value for \"dt_user_lastlogondate\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/)
      if !@dt_user_passwordchanged.nil? && @dt_user_passwordchanged !~ pattern
        invalid_properties.push("invalid value for \"dt_user_passwordchanged\", must conform to the pattern #{pattern}.")
      end
      ...
      if @b_user_changepassword.nil?
        invalid_properties.push('invalid value for "b_user_changepassword", b_user_changepassword cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @s_timezone_name.nil?
      ...
      return false if @b_user_changepassword.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_timezone_name Value to be assigned
    def s_timezone_name=(s_timezone_name)
      if s_timezone_name.nil?
        fail ArgumentError, 's_timezone_name cannot be nil'
      end

      @s_timezone_name = s_timezone_name
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_user_origin Value to be assigned
    def e_user_origin=(e_user_origin)
      if e_user_origin.nil?
        fail ArgumentError, 'e_user_origin cannot be nil'
      end

      @e_user_origin = e_user_origin
    end
    ...
    def dt_user_lastlogondate=(dt_user_lastlogondate)
      if dt_user_lastlogondate.nil?
        fail ArgumentError, 'dt_user_lastlogondate cannot be nil'
      end

      pattern = Regexp.new(/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/)
      if dt_user_lastlogondate !~ pattern
        fail ArgumentError, "invalid value for \"dt_user_lastlogondate\", must conform to the pattern #{pattern}."
      end

      @dt_user_lastlogondate = dt_user_lastlogondate
    end

    # Custom attribute writer method with validation
    # @param [Object] dt_user_passwordchanged Value to be assigned
    def dt_user_passwordchanged=(dt_user_passwordchanged)
      if dt_user_passwordchanged.nil?
        fail ArgumentError, 'dt_user_passwordchanged cannot be nil'
      end

      pattern = Regexp.new(/^[0-9]{4}-(0[1-9]|1[0-2])-(0[1-9]|[1-2][0-9]|3[0-1]) ([01]?[0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])$/)
      if dt_user_passwordchanged !~ pattern
        fail ArgumentError, "invalid value for \"dt_user_passwordchanged\", must conform to the pattern #{pattern}."
      end

      @dt_user_passwordchanged = dt_user_passwordchanged
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_user_changepassword Value to be assigned
    def b_user_changepassword=(b_user_changepassword)
      if b_user_changepassword.nil?
        fail ArgumentError, 'b_user_changepassword cannot be nil'
      end

      @b_user_changepassword = b_user_changepassword
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          s_timezone_name == o.s_timezone_name &&
          ...
          b_user_suspended == o.b_user_suspended &&
          ...
          b_user_ezsigntemplaterolegrouping == o.b_user_ezsigntemplaterolegrouping &&
    ...
    def hash
      [pki_user_id, fki_agent_id, fki_broker_id, fki_assistant_id, fki_employee_id, fki_ezmaxpartner_id, fki_company_id_default, s_company_name_x, fki_department_id_default, s_department_name_x, fki_timezone_id, s_timezone_name, fki_language_id, s_language_name_x, obj_email, fki_billingentityinternal_id, s_billingentityinternal_description_x, obj_phone_home, obj_phone_sms, fki_secretquestion_id, fki_module_id_form, s_module_name_x, e_user_origin, e_user_type, e_user_logintype, s_user_firstname, s_user_lastname, s_user_loginname, s_user_jobtitle, e_user_ezsignaccess, dt_user_lastlogondate, dt_user_passwordchanged, dt_user_ezsignprepaidexpiration, b_user_isactive, b_user_suspended, b_user_validatebyadministration, b_user_validatebydirector, b_user_attachmentautoverified, b_user_changepassword, b_user_ezsigntemplaterolegrouping, obj_audit].hash
    end
