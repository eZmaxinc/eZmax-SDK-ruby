...
module EzmaxApi
  ...
  class EzsignsigningreasonRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignsigningreasonRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignsigningreasonRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@pki_ezsignsigningreason_id.nil? && @pki_ezsignsigningreason_id > 255
        invalid_properties.push('invalid value for "pki_ezsignsigningreason_id", must be smaller than or equal to 255.')
      end

      if !@pki_ezsignsigningreason_id.nil? && @pki_ezsignsigningreason_id < 0
    ...
    def valid?
      ...
      return false if !@pki_ezsignsigningreason_id.nil? && @pki_ezsignsigningreason_id > 255
      return false if !@pki_ezsignsigningreason_id.nil? && @pki_ezsignsigningreason_id < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] obj_ezsignsigningreason_description Value to be assigned
    def obj_ezsignsigningreason_description=(obj_ezsignsigningreason_description)
      if obj_ezsignsigningreason_description.nil?
        fail ArgumentError, 'obj_ezsignsigningreason_description cannot be nil'
      end

      @obj_ezsignsigningreason_description = obj_ezsignsigningreason_description
    end

    # Custom attribute writer method with validation
    # @param [Object] b_ezsignsigningreason_isactive Value to be assigned
    def b_ezsignsigningreason_isactive=(b_ezsignsigningreason_isactive)
      if b_ezsignsigningreason_isactive.nil?
        fail ArgumentError, 'b_ezsignsigningreason_isactive cannot be nil'
      end

      @b_ezsignsigningreason_isactive = b_ezsignsigningreason_isactive
    end
