...
module EzmaxApi
  ...
  class ActivesessionGetCurrentV2ResponseMPayload < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::ActivesessionGetCurrentV2ResponseMPayload`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] obj_activesession Value to be assigned
    def obj_activesession=(obj_activesession)
      if obj_activesession.nil?
        fail ArgumentError, 'obj_activesession cannot be nil'
      end

      @obj_activesession = obj_activesession
    end
