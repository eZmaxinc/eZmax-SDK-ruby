...
module EzmaxApi
  ...
  class CommonResponseFilter < ApiModelBase
    ...
    attr_accessor :a_auto_type_having
    ...
    def self.attribute_map
      {
        ...
        :'a_auto_type_having' => :'a_AutoTypeHaving',
        :'a_enum' => :'a_Enum'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'a_auto_type_having' => :'Hash<String, String>',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CommonResponseFilter`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'a_auto_type_having')
        if (value = attributes[:'a_auto_type_having']).is_a?(Hash)
          self.a_auto_type_having = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          a_auto_type_having == o.a_auto_type_having &&
          a_enum == o.a_enum
    end
    ...
    def hash
      [a_auto_type, a_auto_type_having, a_enum].hash
    end
