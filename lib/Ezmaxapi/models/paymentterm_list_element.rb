...
module EzmaxApi
  ...
  class PaymenttermListElement < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::PaymenttermListElement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] pki_paymentterm_id Value to be assigned
    def pki_paymentterm_id=(pki_paymentterm_id)
      if pki_paymentterm_id.nil?
        fail ArgumentError, 'pki_paymentterm_id cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_paymentterm_type Value to be assigned
    def e_paymentterm_type=(e_paymentterm_type)
      if e_paymentterm_type.nil?
        fail ArgumentError, 'e_paymentterm_type cannot be nil'
      end

      @e_paymentterm_type = e_paymentterm_type
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_paymentterm_isactive Value to be assigned
    def b_paymentterm_isactive=(b_paymentterm_isactive)
      if b_paymentterm_isactive.nil?
        fail ArgumentError, 'b_paymentterm_isactive cannot be nil'
      end

      @b_paymentterm_isactive = b_paymentterm_isactive
    end
