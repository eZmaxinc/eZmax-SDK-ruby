...
module EzmaxApi
  # A Module Object
  class ModuleResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::ModuleResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::ModuleResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_module_internalname Value to be assigned
    def e_module_internalname=(e_module_internalname)
      if e_module_internalname.nil?
        fail ArgumentError, 'e_module_internalname cannot be nil'
      end

      @e_module_internalname = e_module_internalname
    end

    # Custom attribute writer method with validation
    # @param [Object] s_module_name_x Value to be assigned
    def s_module_name_x=(s_module_name_x)
      if s_module_name_x.nil?
        fail ArgumentError, 's_module_name_x cannot be nil'
      end

      @s_module_name_x = s_module_name_x
    end

    # Custom attribute writer method with validation
    # @param [Object] b_module_registered Value to be assigned
    def b_module_registered=(b_module_registered)
      if b_module_registered.nil?
        fail ArgumentError, 'b_module_registered cannot be nil'
      end

      @b_module_registered = b_module_registered
    end

    # Custom attribute writer method with validation
    # @param [Object] b_module_registeredapi Value to be assigned
    def b_module_registeredapi=(b_module_registeredapi)
      if b_module_registeredapi.nil?
        fail ArgumentError, 'b_module_registeredapi cannot be nil'
      end

      @b_module_registeredapi = b_module_registeredapi
    end
    ...
    def hash
      [pki_module_id, fki_modulegroup_id, e_module_internalname, s_module_name_x, b_module_registered, b_module_registeredapi].hash
    end
