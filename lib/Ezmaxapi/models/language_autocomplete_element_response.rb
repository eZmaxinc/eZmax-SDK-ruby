...
module EzmaxApi
  ...
  class LanguageAutocompleteElementResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::LanguageAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_language_isactive Value to be assigned
    def b_language_isactive=(b_language_isactive)
      if b_language_isactive.nil?
        fail ArgumentError, 'b_language_isactive cannot be nil'
      end

      @b_language_isactive = b_language_isactive
    end
