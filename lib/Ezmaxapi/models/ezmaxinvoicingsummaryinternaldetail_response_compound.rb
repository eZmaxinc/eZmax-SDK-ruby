...
module EzmaxApi
  ...
  class EzmaxinvoicingsummaryinternaldetailResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzmaxinvoicingsummaryinternaldetailResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzmaxinvoicingsummaryinternaldetailResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezmaxinvoicingsummaryinternaldetail_adjustment Value to be assigned
    def b_ezmaxinvoicingsummaryinternaldetail_adjustment=(b_ezmaxinvoicingsummaryinternaldetail_adjustment)
      if b_ezmaxinvoicingsummaryinternaldetail_adjustment.nil?
        fail ArgumentError, 'b_ezmaxinvoicingsummaryinternaldetail_adjustment cannot be nil'
      end

      @b_ezmaxinvoicingsummaryinternaldetail_adjustment = b_ezmaxinvoicingsummaryinternaldetail_adjustment
    end
