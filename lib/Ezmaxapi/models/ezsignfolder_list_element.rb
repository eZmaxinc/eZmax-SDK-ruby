...
module EzmaxApi
  ...
  class EzsignfolderListElement < ApiModelBase
    ...
    attr_accessor :dt_ezsignfolder_archive

    # The date and time at which the Ezsignfolder was disposed.
    attr_accessor :dt_ezsignfolder_dispose
    ...
    attr_accessor :b_ezsignfolder_ismyown
    ...
    def self.openapi_types
      {
        ...
        :'fki_ezsignbulksendtransmission_id' => :'Integer',
        :'s_ezsignbulksendtransmission_description' => :'String',
        :'fki_ezsigntemplatepublic_id' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignfolderListElement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fki_ezsignbulksendtransmission_id')
        self.fki_ezsignbulksendtransmission_id = attributes[:'fki_ezsignbulksendtransmission_id']
      end
      ...
      if attributes.key?(:'fki_ezsigntemplatepublic_id')
        self.fki_ezsigntemplatepublic_id = attributes[:'fki_ezsigntemplatepublic_id']
      end
      ...
      if attributes.key?(:'e_ezsignfolder_source')
        self.e_ezsignfolder_source = attributes[:'e_ezsignfolder_source']
      else
        self.e_ezsignfolder_source = nil
      end
      ...
      if attributes.key?(:'dt_ezsignfolder_archive')
        self.dt_ezsignfolder_archive = attributes[:'dt_ezsignfolder_archive']
      end

      if attributes.key?(:'dt_ezsignfolder_dispose')
        self.dt_ezsignfolder_dispose = attributes[:'dt_ezsignfolder_dispose']
      end
      ...
      if attributes.key?(:'b_ezsignfolder_ismyown')
        self.b_ezsignfolder_ismyown = attributes[:'b_ezsignfolder_ismyown']
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@fki_ezsignbulksend_id.nil? && @fki_ezsignbulksend_id < 0
        invalid_properties.push('invalid value for "fki_ezsignbulksend_id", must be greater than or equal to 0.')
      end

      if !@fki_ezsignbulksendtransmission_id.nil? && @fki_ezsignbulksendtransmission_id < 0
        invalid_properties.push('invalid value for "fki_ezsignbulksendtransmission_id", must be greater than or equal to 0.')
      end

      if !@fki_ezsigntemplatepublic_id.nil? && @fki_ezsigntemplatepublic_id > 65535
        invalid_properties.push('invalid value for "fki_ezsigntemplatepublic_id", must be smaller than or equal to 65535.')
      end

      if !@fki_ezsigntemplatepublic_id.nil? && @fki_ezsigntemplatepublic_id < 0
        invalid_properties.push('invalid value for "fki_ezsigntemplatepublic_id", must be greater than or equal to 0.')
      end

      pattern = Regexp.new(/^.{0,80}$/)
      if !@s_ezsigntemplatepublic_description.nil? && @s_ezsigntemplatepublic_description !~ pattern
        invalid_properties.push("invalid value for \"s_ezsigntemplatepublic_description\", must conform to the pattern #{pattern}.")
      end

      if @e_ezsignfolder_source.nil?
        invalid_properties.push('invalid value for "e_ezsignfolder_source", e_ezsignfolder_source cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@fki_ezsignbulksend_id.nil? && @fki_ezsignbulksend_id < 0
      return false if !@fki_ezsignbulksendtransmission_id.nil? && @fki_ezsignbulksendtransmission_id < 0
      return false if !@fki_ezsigntemplatepublic_id.nil? && @fki_ezsigntemplatepublic_id > 65535
      return false if !@fki_ezsigntemplatepublic_id.nil? && @fki_ezsigntemplatepublic_id < 0
      return false if !@s_ezsigntemplatepublic_description.nil? && @s_ezsigntemplatepublic_description !~ Regexp.new(/^.{0,80}$/)
      return false if @e_ezsignfolder_source.nil?
    ...
    # Custom attribute writer method with validation
    # @param [Object] fki_ezsignbulksendtransmission_id Value to be assigned
    def fki_ezsignbulksendtransmission_id=(fki_ezsignbulksendtransmission_id)
      if fki_ezsignbulksendtransmission_id.nil?
        fail ArgumentError, 'fki_ezsignbulksendtransmission_id cannot be nil'
      end

      if fki_ezsignbulksendtransmission_id < 0
        fail ArgumentError, 'invalid value for "fki_ezsignbulksendtransmission_id", must be greater than or equal to 0.'
      end

      @fki_ezsignbulksendtransmission_id = fki_ezsignbulksendtransmission_id
    end

    # Custom attribute writer method with validation
    # @param [Object] fki_ezsigntemplatepublic_id Value to be assigned
    def fki_ezsigntemplatepublic_id=(fki_ezsigntemplatepublic_id)
      if fki_ezsigntemplatepublic_id.nil?
        fail ArgumentError, 'fki_ezsigntemplatepublic_id cannot be nil'
      end

      if fki_ezsigntemplatepublic_id > 65535
        fail ArgumentError, 'invalid value for "fki_ezsigntemplatepublic_id", must be smaller than or equal to 65535.'
      end

      if fki_ezsigntemplatepublic_id < 0
        fail ArgumentError, 'invalid value for "fki_ezsigntemplatepublic_id", must be greater than or equal to 0.'
      end

      @fki_ezsigntemplatepublic_id = fki_ezsigntemplatepublic_id
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsignfolder_source Value to be assigned
    def e_ezsignfolder_source=(e_ezsignfolder_source)
      if e_ezsignfolder_source.nil?
        fail ArgumentError, 'e_ezsignfolder_source cannot be nil'
      end

      @e_ezsignfolder_source = e_ezsignfolder_source
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_ezsignfoldertype_name_x Value to be assigned
    def s_ezsignfoldertype_name_x=(s_ezsignfoldertype_name_x)
      if s_ezsignfoldertype_name_x.nil?
        fail ArgumentError, 's_ezsignfoldertype_name_x cannot be nil'
      end

      @s_ezsignfoldertype_name_x = s_ezsignfoldertype_name_x
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsignfolder_step Value to be assigned
    def e_ezsignfolder_step=(e_ezsignfolder_step)
      if e_ezsignfolder_step.nil?
        fail ArgumentError, 'e_ezsignfolder_step cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] i_ezsigndocument Value to be assigned
    def i_ezsigndocument=(i_ezsigndocument)
      if i_ezsigndocument.nil?
        fail ArgumentError, 'i_ezsigndocument cannot be nil'
      end

      @i_ezsigndocument = i_ezsigndocument
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsigndocument_edm Value to be assigned
    def i_ezsigndocument_edm=(i_ezsigndocument_edm)
      if i_ezsigndocument_edm.nil?
        fail ArgumentError, 'i_ezsigndocument_edm cannot be nil'
      end

      @i_ezsigndocument_edm = i_ezsigndocument_edm
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsignsignature Value to be assigned
    def i_ezsignsignature=(i_ezsignsignature)
      if i_ezsignsignature.nil?
        fail ArgumentError, 'i_ezsignsignature cannot be nil'
      end

      @i_ezsignsignature = i_ezsignsignature
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsignsignature_signed Value to be assigned
    def i_ezsignsignature_signed=(i_ezsignsignature_signed)
      if i_ezsignsignature_signed.nil?
        fail ArgumentError, 'i_ezsignsignature_signed cannot be nil'
      end

      @i_ezsignsignature_signed = i_ezsignsignature_signed
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsignformfieldgroup Value to be assigned
    def i_ezsignformfieldgroup=(i_ezsignformfieldgroup)
      if i_ezsignformfieldgroup.nil?
        fail ArgumentError, 'i_ezsignformfieldgroup cannot be nil'
      end

      @i_ezsignformfieldgroup = i_ezsignformfieldgroup
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsignformfieldgroup_completed Value to be assigned
    def i_ezsignformfieldgroup_completed=(i_ezsignformfieldgroup_completed)
      if i_ezsignformfieldgroup_completed.nil?
        fail ArgumentError, 'i_ezsignformfieldgroup_completed cannot be nil'
      end

      @i_ezsignformfieldgroup_completed = i_ezsignformfieldgroup_completed
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fki_ezsignbulksendtransmission_id == o.fki_ezsignbulksendtransmission_id &&
          s_ezsignbulksendtransmission_description == o.s_ezsignbulksendtransmission_description &&
          fki_ezsigntemplatepublic_id == o.fki_ezsigntemplatepublic_id &&
          s_ezsigntemplatepublic_description == o.s_ezsigntemplatepublic_description &&
          e_ezsignfolder_source == o.e_ezsignfolder_source &&
          ...
          dt_ezsignfolder_archive == o.dt_ezsignfolder_archive &&
          dt_ezsignfolder_dispose == o.dt_ezsignfolder_dispose &&
          b_ezsignfolder_signer == o.b_ezsignfolder_signer &&
          b_ezsignfolder_ismyown == o.b_ezsignfolder_ismyown
    end
    ...
    def hash
      [pki_ezsignfolder_id, fki_ezsignfoldertype_id, fki_ezsignbulksend_id, s_ezsignbulksend_description, fki_ezsignbulksendtransmission_id, s_ezsignbulksendtransmission_description, fki_ezsigntemplatepublic_id, s_ezsigntemplatepublic_description, e_ezsignfolder_source, e_ezsignfoldertype_privacylevel, s_ezsignfoldertype_name_x, s_ezsignfolder_description, e_ezsignfolder_step, e_ezsignfolder_completion, dt_created_date, dt_ezsignfolder_delayedsenddate, dt_ezsignfolder_sentdate, dt_ezsignfolder_duedate, i_ezsigndocument, i_ezsigndocument_edm, i_ezsignsignature, i_ezsignsignature_signed, i_ezsignformfieldgroup, i_ezsignformfieldgroup_completed, b_ezsignform_hasdependencies, d_ezsignfolder_completedpercentage, d_ezsignfolder_formcompletedpercentage, d_ezsignfolder_signaturecompletedpercentage, dt_ezsignfolder_close, dt_ezsignfolder_archive, dt_ezsignfolder_dispose, b_ezsignfolder_signer, b_ezsignfolder_ismyown].hash
    end
