...
module EzmaxApi
  ...
  class EzsignfolderListElement < ApiModelBase
    ...
    def hash
      [pki_ezsignfolder_id, fki_ezsignfoldertype_id, e_ezsignfoldertype_privacylevel, s_ezsignfoldertype_name_x, s_ezsignfolder_description, e_ezsignfolder_step, e_ezsignfolder_completion, dt_created_date, dt_ezsignfolder_delayedsenddate, dt_ezsignfolder_sentdate, dt_ezsignfolder_duedate, i_ezsigndocument, i_ezsigndocument_edm, i_ezsignsignature, i_ezsignsignature_signed, i_ezsignformfieldgroup, i_ezsignformfieldgroup_completed, b_ezsignform_hasdependencies, d_ezsignfolder_completedpercentage, d_ezsignfolder_formcompletedpercentage, d_ezsignfolder_signaturecompletedpercentage, dt_ezsignfolder_close, dt_ezsignfolder_archive, dt_ezsignfolder_dispose, b_ezsignfolder_signer].hash
    end
