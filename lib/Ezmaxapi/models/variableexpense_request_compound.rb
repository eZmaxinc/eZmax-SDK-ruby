...
module EzmaxApi
  ...
  class VariableexpenseRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::VariableexpenseRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::VariableexpenseRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_variableexpense_code')
        ...
        self.s_variableexpense_code = nil
      end
    ...
    def list_invalid_properties
      ...
      if !@pki_variableexpense_id.nil? && @pki_variableexpense_id > 255
        invalid_properties.push('invalid value for "pki_variableexpense_id", must be smaller than or equal to 255.')
      end

      if !@pki_variableexpense_id.nil? && @pki_variableexpense_id < 1
      ...
      if @s_variableexpense_code.nil?
        invalid_properties.push('invalid value for "s_variableexpense_code", s_variableexpense_code cannot be nil.')
      end
      ...
      if @e_variableexpense_taxable.nil?
        invalid_properties.push('invalid value for "e_variableexpense_taxable", e_variableexpense_taxable cannot be nil.')
      end

      if @b_variableexpense_isactive.nil?
        invalid_properties.push('invalid value for "b_variableexpense_isactive", b_variableexpense_isactive cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if !@pki_variableexpense_id.nil? && @pki_variableexpense_id > 255
      return false if !@pki_variableexpense_id.nil? && @pki_variableexpense_id < 1
      return false if @s_variableexpense_code.nil?
      return false if @s_variableexpense_code !~ Regexp.new(/^.{0,5}$/)
      return false if @obj_variableexpense_description.nil?
      return false if @e_variableexpense_taxable.nil?
      return false if @b_variableexpense_isactive.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] obj_variableexpense_description Value to be assigned
    def obj_variableexpense_description=(obj_variableexpense_description)
      if obj_variableexpense_description.nil?
        fail ArgumentError, 'obj_variableexpense_description cannot be nil'
      end

      @obj_variableexpense_description = obj_variableexpense_description
    end

    # Custom attribute writer method with validation
    # @param [Object] e_variableexpense_taxable Value to be assigned
    def e_variableexpense_taxable=(e_variableexpense_taxable)
      if e_variableexpense_taxable.nil?
        fail ArgumentError, 'e_variableexpense_taxable cannot be nil'
      end

      @e_variableexpense_taxable = e_variableexpense_taxable
    end

    # Custom attribute writer method with validation
    # @param [Object] b_variableexpense_isactive Value to be assigned
    def b_variableexpense_isactive=(b_variableexpense_isactive)
      if b_variableexpense_isactive.nil?
        fail ArgumentError, 'b_variableexpense_isactive cannot be nil'
      end

      @b_variableexpense_isactive = b_variableexpense_isactive
    end
