...
module EzmaxApi
  ...
  class ActivesessionResponseCompoundUser < ApiModelBase
    ...
    attr_accessor :b_user_addmeinezsignfolder
    ...
    attr_accessor :i_user_frontendgoal
    ...
    def self.attribute_map
      {
        ...
        :'b_user_addmeinezsignfolder' => :'bUserAddmeinezsignfolder',
        ...
        :'i_user_frontendgoal' => :'iUserFrontendgoal'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'b_user_addmeinezsignfolder' => :'Boolean',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'b_user_addmeinezsignfolder')
        self.b_user_addmeinezsignfolder = attributes[:'b_user_addmeinezsignfolder']
      else
        self.b_user_addmeinezsignfolder = nil
      end
      ...
      if attributes.key?(:'i_user_frontendgoal')
        self.i_user_frontendgoal = attributes[:'i_user_frontendgoal']
      else
        self.i_user_frontendgoal = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @b_user_addmeinezsignfolder.nil?
        invalid_properties.push('invalid value for "b_user_addmeinezsignfolder", b_user_addmeinezsignfolder cannot be nil.')
      end
      ...
      if @i_user_frontendgoal.nil?
        invalid_properties.push('invalid value for "i_user_frontendgoal", i_user_frontendgoal cannot be nil.')
      end

      if @i_user_frontendgoal < 0
        invalid_properties.push('invalid value for "i_user_frontendgoal", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if @b_user_addmeinezsignfolder.nil?
      ...
      return false if @i_user_frontendgoal.nil?
      return false if @i_user_frontendgoal < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_user_addmeinezsignfolder Value to be assigned
    def b_user_addmeinezsignfolder=(b_user_addmeinezsignfolder)
      if b_user_addmeinezsignfolder.nil?
        fail ArgumentError, 'b_user_addmeinezsignfolder cannot be nil'
      end

      @b_user_addmeinezsignfolder = b_user_addmeinezsignfolder
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] i_user_frontendgoal Value to be assigned
    def i_user_frontendgoal=(i_user_frontendgoal)
      if i_user_frontendgoal.nil?
        fail ArgumentError, 'i_user_frontendgoal cannot be nil'
      end

      if i_user_frontendgoal < 0
        fail ArgumentError, 'invalid value for "i_user_frontendgoal", must be greater than or equal to 0.'
      end

      @i_user_frontendgoal = i_user_frontendgoal
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          b_user_addmeinezsignfolder == o.b_user_addmeinezsignfolder &&
          ...
          i_user_frontendgoal == o.i_user_frontendgoal
    end
    ...
    def hash
      [pki_user_id, fki_timezone_id, s_avatar_url, s_user_firstname, s_user_lastname, s_email_address, b_user_addmeinezsignfolder, e_user_ezsignsendreminderfrequency, i_user_interfacecolor, b_user_interfacedark, i_user_listresult, i_user_frontendgoal].hash
    end
