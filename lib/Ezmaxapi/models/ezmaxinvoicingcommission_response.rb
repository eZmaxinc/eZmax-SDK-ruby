...
module EzmaxApi
  ...
  class EzmaxinvoicingcommissionResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzmaxinvoicingcommissionResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzmaxinvoicingcommissionResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] dt_ezmaxinvoicingcommission_start Value to be assigned
    def dt_ezmaxinvoicingcommission_start=(dt_ezmaxinvoicingcommission_start)
      if dt_ezmaxinvoicingcommission_start.nil?
        fail ArgumentError, 'dt_ezmaxinvoicingcommission_start cannot be nil'
      end

      @dt_ezmaxinvoicingcommission_start = dt_ezmaxinvoicingcommission_start
    end

    # Custom attribute writer method with validation
    # @param [Object] dt_ezmaxinvoicingcommission_end Value to be assigned
    def dt_ezmaxinvoicingcommission_end=(dt_ezmaxinvoicingcommission_end)
      if dt_ezmaxinvoicingcommission_end.nil?
        fail ArgumentError, 'dt_ezmaxinvoicingcommission_end cannot be nil'
      end

      @dt_ezmaxinvoicingcommission_end = dt_ezmaxinvoicingcommission_end
    end
    ...
    def hash
      [pki_ezmaxinvoicingcommission_id, fki_ezmaxinvoicingsummaryglobal_id, fki_ezmaxpartner_id, fki_ezmaxrepresentative_id, dt_ezmaxinvoicingcommission_start, dt_ezmaxinvoicingcommission_end, i_ezmaxinvoicingcommission_days, d_ezmaxinvoicingcommission_amount].hash
    end
