...
module EzmaxApi
  class FieldEEzsignsignatureTooltipposition
    ...
    def build_from_hash(value)
      return value if FieldEEzsignsignatureTooltipposition.all_vars.include?(value)
      raise "Invalid ENUM value #{value} for class #FieldEEzsignsignatureTooltipposition"
    end
  end
end
