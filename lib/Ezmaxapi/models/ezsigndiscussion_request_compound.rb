...
module EzmaxApi
  ...
  class EzsigndiscussionRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigndiscussionRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigndiscussionRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] i_ezsigndiscussion_pagenumber Value to be assigned
    def i_ezsigndiscussion_pagenumber=(i_ezsigndiscussion_pagenumber)
      if i_ezsigndiscussion_pagenumber.nil?
        fail ArgumentError, 'i_ezsigndiscussion_pagenumber cannot be nil'
      end

      @i_ezsigndiscussion_pagenumber = i_ezsigndiscussion_pagenumber
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] obj_discussion Value to be assigned
    def obj_discussion=(obj_discussion)
      if obj_discussion.nil?
        fail ArgumentError, 'obj_discussion cannot be nil'
      end

      @obj_discussion = obj_discussion
    end
