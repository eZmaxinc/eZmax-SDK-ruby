...
module EzmaxApi
  ...
  class EzsigntemplateListElement < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplateListElement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezsigntemplate_incomplete Value to be assigned
    def b_ezsigntemplate_incomplete=(b_ezsigntemplate_incomplete)
      if b_ezsigntemplate_incomplete.nil?
        fail ArgumentError, 'b_ezsigntemplate_incomplete cannot be nil'
      end

      @b_ezsigntemplate_incomplete = b_ezsigntemplate_incomplete
    end
    ...
    def hash
      [pki_ezsigntemplate_id, fki_ezsignfoldertype_id, fki_language_id, s_ezsigntemplate_description, i_ezsigntemplatedocument_pagetotal, i_ezsigntemplate_signaturetotal, i_ezsigntemplate_formfieldtotal, b_ezsigntemplate_incomplete, s_ezsignfoldertype_name_x, e_ezsigntemplate_type].hash
    end
