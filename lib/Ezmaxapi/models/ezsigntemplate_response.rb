...
module EzmaxApi
  ...
  class EzsigntemplateResponse
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplateResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [pki_ezsigntemplate_id, fki_ezsigntemplatedocument_id, fki_ezsignfoldertype_id, fki_language_id, s_language_name_x, s_ezsigntemplate_description, s_ezsigntemplate_filenamepattern, b_ezsigntemplate_adminonly, s_ezsignfoldertype_name_x, obj_audit, b_ezsigntemplate_editallowed, e_ezsigntemplate_type].hash
    end
