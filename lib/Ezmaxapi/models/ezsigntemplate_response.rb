...
module EzmaxApi
  ...
  class EzsigntemplateResponse
    ...
    def hash
      [pki_ezsigntemplate_id, fki_ezsigntemplatedocument_id, fki_ezsignfoldertype_id, fki_language_id, s_language_name_x, s_ezsigntemplate_description, b_ezsigntemplate_adminonly, s_ezsignfoldertype_name_x, obj_audit].hash
    end
