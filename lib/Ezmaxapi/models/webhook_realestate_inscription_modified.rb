...
module EzmaxApi
  ...
  class WebhookRealestateInscriptionModified < ApiModelBase
    attr_accessor :obj_webhook

    # An array containing details of previous attempts that were made to deliver the message. The array is empty if it's the first attempt.
    attr_accessor :a_obj_attempt

    attr_accessor :obj_inscription
    ...
    def self.attribute_map
      {
        ...
        :'obj_inscription' => :'objInscription'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'obj_inscription' => :'InscriptionResponse'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::WebhookRealestateInscriptionModified` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::WebhookRealestateInscriptionModified`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'obj_inscription')
        self.obj_inscription = attributes[:'obj_inscription']
      else
        self.obj_inscription = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @obj_inscription.nil?
        invalid_properties.push('invalid value for "obj_inscription", obj_inscription cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @obj_inscription.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] obj_inscription Value to be assigned
    def obj_inscription=(obj_inscription)
      if obj_inscription.nil?
        fail ArgumentError, 'obj_inscription cannot be nil'
      end

      @obj_inscription = obj_inscription
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          obj_inscription == o.obj_inscription
    end
    ...
    def hash
      [obj_webhook, a_obj_attempt, obj_inscription].hash
    end
