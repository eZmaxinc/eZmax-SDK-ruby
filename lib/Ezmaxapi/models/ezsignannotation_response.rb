...
module EzmaxApi
  ...
  class EzsignannotationResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignannotationResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignannotationResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] pki_ezsignannotation_id Value to be assigned
    def pki_ezsignannotation_id=(pki_ezsignannotation_id)
      if pki_ezsignannotation_id.nil?
        fail ArgumentError, 'pki_ezsignannotation_id cannot be nil'
      end

      @pki_ezsignannotation_id = pki_ezsignannotation_id
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsignannotation_type Value to be assigned
    def e_ezsignannotation_type=(e_ezsignannotation_type)
      if e_ezsignannotation_type.nil?
        fail ArgumentError, 'e_ezsignannotation_type cannot be nil'
      end

      @e_ezsignannotation_type = e_ezsignannotation_type
    end
    ...
    def hash
      [pki_ezsignannotation_id, fki_ezsigndocument_id, e_ezsignannotation_horizontalalignment, e_ezsignannotation_verticalalignment, e_ezsignannotation_type, i_ezsignannotation_x, i_ezsignannotation_y, i_ezsignannotation_width, i_ezsignannotation_height, s_ezsignannotation_text, i_ezsignpage_pagenumber].hash
    end
