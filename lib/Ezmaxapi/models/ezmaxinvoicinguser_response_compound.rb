...
module EzmaxApi
  ...
  class EzmaxinvoicinguserResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzmaxinvoicinguserResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzmaxinvoicinguserResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezmaxinvoicinguser_ezsignaccount Value to be assigned
    def b_ezmaxinvoicinguser_ezsignaccount=(b_ezmaxinvoicinguser_ezsignaccount)
      if b_ezmaxinvoicinguser_ezsignaccount.nil?
        fail ArgumentError, 'b_ezmaxinvoicinguser_ezsignaccount cannot be nil'
      end

      @b_ezmaxinvoicinguser_ezsignaccount = b_ezmaxinvoicinguser_ezsignaccount
    end

    # Custom attribute writer method with validation
    # @param [Object] b_ezmaxinvoicinguser_billableezsign Value to be assigned
    def b_ezmaxinvoicinguser_billableezsign=(b_ezmaxinvoicinguser_billableezsign)
      if b_ezmaxinvoicinguser_billableezsign.nil?
        fail ArgumentError, 'b_ezmaxinvoicinguser_billableezsign cannot be nil'
      end

      @b_ezmaxinvoicinguser_billableezsign = b_ezmaxinvoicinguser_billableezsign
    end

    # Custom attribute writer method with validation
    # @param [Object] e_ezmaxinvoicinguser_variationezsign Value to be assigned
    def e_ezmaxinvoicinguser_variationezsign=(e_ezmaxinvoicinguser_variationezsign)
      if e_ezmaxinvoicinguser_variationezsign.nil?
        fail ArgumentError, 'e_ezmaxinvoicinguser_variationezsign cannot be nil'
      end

      @e_ezmaxinvoicinguser_variationezsign = e_ezmaxinvoicinguser_variationezsign
    end
