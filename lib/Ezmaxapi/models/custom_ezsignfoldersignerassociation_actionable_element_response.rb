  ...
  class CustomEzsignfoldersignerassociationActionableElementResponse < EzsignfoldersignerassociationResponseCompound
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomEzsignfoldersignerassociationActionableElementResponse`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          b_ezsignfoldersignerassociation_hasactionableelements_future == o.b_ezsignfoldersignerassociation_hasactionableelements_future && super(o)
    end
    ...
    def hash
      [b_ezsignfoldersignerassociation_hasactionableelements_current, b_ezsignfoldersignerassociation_hasactionableelements_future].hash
    end
