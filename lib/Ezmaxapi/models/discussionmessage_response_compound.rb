...
module EzmaxApi
  ...
  class DiscussionmessageResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::DiscussionmessageResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_discussionmessage_status Value to be assigned
    def e_discussionmessage_status=(e_discussionmessage_status)
      if e_discussionmessage_status.nil?
        fail ArgumentError, 'e_discussionmessage_status cannot be nil'
      end

      @e_discussionmessage_status = e_discussionmessage_status
    end
