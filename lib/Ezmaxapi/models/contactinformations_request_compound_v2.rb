...
module EzmaxApi
  ...
  class ContactinformationsRequestCompoundV2 < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::ContactinformationsRequestCompoundV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] e_contactinformations_type Value to be assigned
    def e_contactinformations_type=(e_contactinformations_type)
      if e_contactinformations_type.nil?
        fail ArgumentError, 'e_contactinformations_type cannot be nil'
      end

      @e_contactinformations_type = e_contactinformations_type
    end

    # Custom attribute writer method with validation
    # @param [Object] i_address_default Value to be assigned
    def i_address_default=(i_address_default)
      if i_address_default.nil?
        fail ArgumentError, 'i_address_default cannot be nil'
      end

      @i_address_default = i_address_default
    end

    # Custom attribute writer method with validation
    # @param [Object] i_phone_default Value to be assigned
    def i_phone_default=(i_phone_default)
      if i_phone_default.nil?
        fail ArgumentError, 'i_phone_default cannot be nil'
      end

      @i_phone_default = i_phone_default
    end

    # Custom attribute writer method with validation
    # @param [Object] i_email_default Value to be assigned
    def i_email_default=(i_email_default)
      if i_email_default.nil?
        fail ArgumentError, 'i_email_default cannot be nil'
      end

      @i_email_default = i_email_default
    end

    # Custom attribute writer method with validation
    # @param [Object] i_website_default Value to be assigned
    def i_website_default=(i_website_default)
      if i_website_default.nil?
        fail ArgumentError, 'i_website_default cannot be nil'
      end

      @i_website_default = i_website_default
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_address Value to be assigned
    def a_obj_address=(a_obj_address)
      if a_obj_address.nil?
        fail ArgumentError, 'a_obj_address cannot be nil'
      end

      @a_obj_address = a_obj_address
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_phone Value to be assigned
    def a_obj_phone=(a_obj_phone)
      if a_obj_phone.nil?
        fail ArgumentError, 'a_obj_phone cannot be nil'
      end

      @a_obj_phone = a_obj_phone
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_email Value to be assigned
    def a_obj_email=(a_obj_email)
      if a_obj_email.nil?
        fail ArgumentError, 'a_obj_email cannot be nil'
      end

      @a_obj_email = a_obj_email
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_website Value to be assigned
    def a_obj_website=(a_obj_website)
      if a_obj_website.nil?
        fail ArgumentError, 'a_obj_website cannot be nil'
      end

      @a_obj_website = a_obj_website
    end
