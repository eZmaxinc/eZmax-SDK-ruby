...
module EzmaxApi
  ...
  class EzsignformfieldResponseCompound < ApiModelBase
    ...
    attr_accessor :e_ezsignformfield_horizontalalignment
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignformfieldResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignformfieldResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pki_ezsignformfield_id')
        ...
        self.pki_ezsignformfield_id = nil
      end
      ...
      if attributes.key?(:'e_ezsignformfield_horizontalalignment')
        self.e_ezsignformfield_horizontalalignment = attributes[:'e_ezsignformfield_horizontalalignment']
      end
    ...
    def list_invalid_properties
      ...
      if @pki_ezsignformfield_id.nil?
        invalid_properties.push('invalid value for "pki_ezsignformfield_id", pki_ezsignformfield_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pki_ezsignformfield_id.nil?
      return false if @pki_ezsignformfield_id < 0
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          e_ezsignformfield_horizontalalignment == o.e_ezsignformfield_horizontalalignment &&
    ...
    def hash
      [pki_ezsignformfield_id, i_ezsignpage_pagenumber, s_ezsignformfield_label, s_ezsignformfield_value, i_ezsignformfield_x, i_ezsignformfield_y, i_ezsignformfield_width, i_ezsignformfield_height, b_ezsignformfield_autocomplete, b_ezsignformfield_selected, s_ezsignformfield_enteredvalue, e_ezsignformfield_dependencyrequirement, e_ezsignformfield_horizontalalignment, obj_textstylestatic, a_obj_ezsignelementdependency].hash
    end
