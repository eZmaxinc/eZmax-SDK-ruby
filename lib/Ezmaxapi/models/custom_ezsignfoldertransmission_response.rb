...
module EzmaxApi
  ...
  class CustomEzsignfoldertransmissionResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomEzsignfoldertransmissionResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezsignfoldertransmission_signer Value to be assigned
    def a_obj_ezsignfoldertransmission_signer=(a_obj_ezsignfoldertransmission_signer)
      if a_obj_ezsignfoldertransmission_signer.nil?
        fail ArgumentError, 'a_obj_ezsignfoldertransmission_signer cannot be nil'
      end

      @a_obj_ezsignfoldertransmission_signer = a_obj_ezsignfoldertransmission_signer
    end
    ...
    def hash
      [pki_ezsignfolder_id, s_ezsignfolder_description, e_ezsignfolder_step, i_ezsignfolder_signaturetotal, i_ezsignfolder_formfieldtotal, i_ezsignfolder_signaturesigned, a_obj_ezsignfoldertransmission_signer].hash
    end
