...
module EzmaxApi
  ...
  class BillingentityinternalRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::BillingentityinternalRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::BillingentityinternalRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'a_obj_billingentityinternalproduct')
        if (value = attributes[:'a_obj_billingentityinternalproduct']).is_a?(Array)
          self.a_obj_billingentityinternalproduct = value
        end
      else
        self.a_obj_billingentityinternalproduct = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@pki_billingentityinternal_id.nil? && @pki_billingentityinternal_id < 0
    ...
    def valid?
      ...
      return false if !@pki_billingentityinternal_id.nil? && @pki_billingentityinternal_id < 0
    ...
    # Custom attribute writer method with validation
    # @param [Object] obj_billingentityinternal_description Value to be assigned
    def obj_billingentityinternal_description=(obj_billingentityinternal_description)
      if obj_billingentityinternal_description.nil?
        fail ArgumentError, 'obj_billingentityinternal_description cannot be nil'
      end

      @obj_billingentityinternal_description = obj_billingentityinternal_description
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_billingentityinternalproduct Value to be assigned
    def a_obj_billingentityinternalproduct=(a_obj_billingentityinternalproduct)
      if a_obj_billingentityinternalproduct.nil?
        fail ArgumentError, 'a_obj_billingentityinternalproduct cannot be nil'
      end

      @a_obj_billingentityinternalproduct = a_obj_billingentityinternalproduct
    end
