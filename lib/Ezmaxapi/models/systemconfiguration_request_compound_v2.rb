...
module EzmaxApi
  ...
  class SystemconfigurationRequestCompoundV2 < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::SystemconfigurationRequestCompoundV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::SystemconfigurationRequestCompoundV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'i_systemconfiguration_ezsignreminderhoursend')
        ...
        self.i_systemconfiguration_ezsignreminderhoursend = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @i_systemconfiguration_ezsignreminderhoursend.nil?
        invalid_properties.push('invalid value for "i_systemconfiguration_ezsignreminderhoursend", i_systemconfiguration_ezsignreminderhoursend cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @i_systemconfiguration_ezsignreminderhoursend.nil?
      return false if @i_systemconfiguration_ezsignreminderhoursend > 23
      return false if @i_systemconfiguration_ezsignreminderhoursend < 0
      true
    end
    ...
    def hash
      [pki_systemconfiguration_id, fki_branding_id, e_systemconfiguration_newexternaluseraction, e_systemconfiguration_language1, e_systemconfiguration_language2, e_systemconfiguration_ezsignofficeplan, b_systemconfiguration_ezsignpaidbyoffice, b_systemconfiguration_ezsignpersonnal, b_systemconfiguration_sspr, dt_systemconfiguration_readonlyexpirationstart, dt_systemconfiguration_readonlyexpirationend, i_systemconfiguration_ezsignreminderhoursend].hash
    end
