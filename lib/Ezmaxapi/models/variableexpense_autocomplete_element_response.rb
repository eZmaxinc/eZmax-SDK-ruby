...
module EzmaxApi
  ...
  class VariableexpenseAutocompleteElementResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::VariableexpenseAutocompleteElementResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::VariableexpenseAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_variableexpense_description_x')
        ...
        self.s_variableexpense_description_x = nil
      end
    ...
    def list_invalid_properties
      ...
      if @s_variableexpense_description_x.nil?
        invalid_properties.push('invalid value for "s_variableexpense_description_x", s_variableexpense_description_x cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @s_variableexpense_description_x.nil?
      return false if @s_variableexpense_description_x !~ Regexp.new(/^.{0,40}$/)
    ...
    def hash
      [s_variableexpense_description_x, pki_variableexpense_id, b_variableexpense_isactive].hash
    end
