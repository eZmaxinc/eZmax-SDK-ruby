...
module EzmaxApi
  ...
  class EzsigntemplatepackageResponseCompoundV3 < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'a_obj_ezsigntemplatepackagesigner' => :'Array<EzsigntemplatepackagesignerResponseCompoundV3>',
        :'a_obj_ezsigntemplatepackagemembership' => :'Array<EzsigntemplatepackagemembershipResponseCompoundV3>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatepackageResponseCompoundV3` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatepackageResponseCompoundV3`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezsigntemplatepackage_adminonly Value to be assigned
    def b_ezsigntemplatepackage_adminonly=(b_ezsigntemplatepackage_adminonly)
      if b_ezsigntemplatepackage_adminonly.nil?
        fail ArgumentError, 'b_ezsigntemplatepackage_adminonly cannot be nil'
      end

      @b_ezsigntemplatepackage_adminonly = b_ezsigntemplatepackage_adminonly
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezsigntemplatepackage_isactive Value to be assigned
    def b_ezsigntemplatepackage_isactive=(b_ezsigntemplatepackage_isactive)
      if b_ezsigntemplatepackage_isactive.nil?
        fail ArgumentError, 'b_ezsigntemplatepackage_isactive cannot be nil'
      end

      @b_ezsigntemplatepackage_isactive = b_ezsigntemplatepackage_isactive
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezsigntemplatepackage_editallowed Value to be assigned
    def b_ezsigntemplatepackage_editallowed=(b_ezsigntemplatepackage_editallowed)
      if b_ezsigntemplatepackage_editallowed.nil?
        fail ArgumentError, 'b_ezsigntemplatepackage_editallowed cannot be nil'
      end

      @b_ezsigntemplatepackage_editallowed = b_ezsigntemplatepackage_editallowed
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezsigntemplatepackagesigner Value to be assigned
    def a_obj_ezsigntemplatepackagesigner=(a_obj_ezsigntemplatepackagesigner)
      if a_obj_ezsigntemplatepackagesigner.nil?
        fail ArgumentError, 'a_obj_ezsigntemplatepackagesigner cannot be nil'
      end

      @a_obj_ezsigntemplatepackagesigner = a_obj_ezsigntemplatepackagesigner
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezsigntemplatepackagemembership Value to be assigned
    def a_obj_ezsigntemplatepackagemembership=(a_obj_ezsigntemplatepackagemembership)
      if a_obj_ezsigntemplatepackagemembership.nil?
        fail ArgumentError, 'a_obj_ezsigntemplatepackagemembership cannot be nil'
      end

      @a_obj_ezsigntemplatepackagemembership = a_obj_ezsigntemplatepackagemembership
    end
    ...
    def hash
      [pki_ezsigntemplatepackage_id, fki_ezsignfoldertype_id, fki_ezdoctemplatedocument_id, fki_language_id, s_ezdoctemplatedocument_name_x, s_language_name_x, s_ezsigntemplatepackage_description, b_ezsigntemplatepackage_adminonly, b_ezsigntemplatepackage_needvalidation, b_ezsigntemplatepackage_isactive, s_ezsignfoldertype_name_x, b_ezsigntemplatepackage_editallowed, a_obj_ezsigntemplatepackagesigner, a_obj_ezsigntemplatepackagemembership].hash
    end
