...
module EzmaxApi
  ...
  class EzsigntemplateglobalAutocompleteElementResponse < ApiModelBase
    ...
    attr_accessor :b_ezsigntemplateglobal_isactive
    ...
    def self.attribute_map
      {
        ...
        :'b_ezsigntemplateglobal_isactive' => :'bEzsigntemplateglobalIsactive'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'b_ezsigntemplateglobal_isactive' => :'Boolean'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplateglobalAutocompleteElementResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplateglobalAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'b_ezsigntemplateglobal_isactive')
        self.b_ezsigntemplateglobal_isactive = attributes[:'b_ezsigntemplateglobal_isactive']
      else
        self.b_ezsigntemplateglobal_isactive = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @b_ezsigntemplateglobal_isactive.nil?
        invalid_properties.push('invalid value for "b_ezsigntemplateglobal_isactive", b_ezsigntemplateglobal_isactive cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @b_ezsigntemplateglobal_isactive.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezsigntemplateglobal_isactive Value to be assigned
    def b_ezsigntemplateglobal_isactive=(b_ezsigntemplateglobal_isactive)
      if b_ezsigntemplateglobal_isactive.nil?
        fail ArgumentError, 'b_ezsigntemplateglobal_isactive cannot be nil'
      end

      @b_ezsigntemplateglobal_isactive = b_ezsigntemplateglobal_isactive
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          b_ezsigntemplateglobal_isactive == o.b_ezsigntemplateglobal_isactive
    end
    ...
    def hash
      [pki_ezsigntemplateglobal_id, s_ezsigntemplateglobal_description, b_ezsigntemplateglobal_isactive].hash
    end
