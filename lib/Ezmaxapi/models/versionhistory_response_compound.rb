...
module EzmaxApi
  ...
  class VersionhistoryResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::VersionhistoryResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] obj_versionhistory_detail Value to be assigned
    def obj_versionhistory_detail=(obj_versionhistory_detail)
      if obj_versionhistory_detail.nil?
        fail ArgumentError, 'obj_versionhistory_detail cannot be nil'
      end

      @obj_versionhistory_detail = obj_versionhistory_detail
    end

    # Custom attribute writer method with validation
    # @param [Object] dt_versionhistory_date Value to be assigned
    def dt_versionhistory_date=(dt_versionhistory_date)
      if dt_versionhistory_date.nil?
        fail ArgumentError, 'dt_versionhistory_date cannot be nil'
      end

      @dt_versionhistory_date = dt_versionhistory_date
    end

    # Custom attribute writer method with validation
    # @param [Object] e_versionhistory_type Value to be assigned
    def e_versionhistory_type=(e_versionhistory_type)
      if e_versionhistory_type.nil?
        fail ArgumentError, 'e_versionhistory_type cannot be nil'
      end

      @e_versionhistory_type = e_versionhistory_type
    end

    # Custom attribute writer method with validation
    # @param [Object] b_versionhistory_draft Value to be assigned
    def b_versionhistory_draft=(b_versionhistory_draft)
      if b_versionhistory_draft.nil?
        fail ArgumentError, 'b_versionhistory_draft cannot be nil'
      end

      @b_versionhistory_draft = b_versionhistory_draft
    end
