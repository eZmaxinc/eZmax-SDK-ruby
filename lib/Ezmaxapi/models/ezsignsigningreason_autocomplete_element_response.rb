...
module EzmaxApi
  ...
  class EzsignsigningreasonAutocompleteElementResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignsigningreasonAutocompleteElementResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignsigningreasonAutocompleteElementResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_ezsignsigningreason_description_x')
        ...
        self.s_ezsignsigningreason_description_x = nil
      end
    ...
    def list_invalid_properties
      ...
      if @s_ezsignsigningreason_description_x.nil?
        invalid_properties.push('invalid value for "s_ezsignsigningreason_description_x", s_ezsignsigningreason_description_x cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @s_ezsignsigningreason_description_x.nil?
      return false if @s_ezsignsigningreason_description_x !~ Regexp.new(/^.{0,50}$/)
    ...
    def hash
      [pki_ezsignsigningreason_id, s_ezsignsigningreason_description_x, b_ezsignsigningreason_isactive].hash
    end
