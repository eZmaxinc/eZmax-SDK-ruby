...
module EzmaxApi
  ...
  class EzmaxinvoicingagentResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzmaxinvoicingagentResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezmaxinvoicingagent_ezsignaccount Value to be assigned
    def b_ezmaxinvoicingagent_ezsignaccount=(b_ezmaxinvoicingagent_ezsignaccount)
      if b_ezmaxinvoicingagent_ezsignaccount.nil?
        fail ArgumentError, 'b_ezmaxinvoicingagent_ezsignaccount cannot be nil'
      end

      @b_ezmaxinvoicingagent_ezsignaccount = b_ezmaxinvoicingagent_ezsignaccount
    end

    # Custom attribute writer method with validation
    # @param [Object] b_ezmaxinvoicingagent_billableezmax Value to be assigned
    def b_ezmaxinvoicingagent_billableezmax=(b_ezmaxinvoicingagent_billableezmax)
      if b_ezmaxinvoicingagent_billableezmax.nil?
        fail ArgumentError, 'b_ezmaxinvoicingagent_billableezmax cannot be nil'
      end

      @b_ezmaxinvoicingagent_billableezmax = b_ezmaxinvoicingagent_billableezmax
    end

    # Custom attribute writer method with validation
    # @param [Object] e_ezmaxinvoicingagent_variationezmax Value to be assigned
    def e_ezmaxinvoicingagent_variationezmax=(e_ezmaxinvoicingagent_variationezmax)
      if e_ezmaxinvoicingagent_variationezmax.nil?
        fail ArgumentError, 'e_ezmaxinvoicingagent_variationezmax cannot be nil'
      end

      @e_ezmaxinvoicingagent_variationezmax = e_ezmaxinvoicingagent_variationezmax
    end

    # Custom attribute writer method with validation
    # @param [Object] b_ezmaxinvoicingagent_billableezsign Value to be assigned
    def b_ezmaxinvoicingagent_billableezsign=(b_ezmaxinvoicingagent_billableezsign)
      if b_ezmaxinvoicingagent_billableezsign.nil?
        fail ArgumentError, 'b_ezmaxinvoicingagent_billableezsign cannot be nil'
      end

      @b_ezmaxinvoicingagent_billableezsign = b_ezmaxinvoicingagent_billableezsign
    end

    # Custom attribute writer method with validation
    # @param [Object] e_ezmaxinvoicingagent_variationezsign Value to be assigned
    def e_ezmaxinvoicingagent_variationezsign=(e_ezmaxinvoicingagent_variationezsign)
      if e_ezmaxinvoicingagent_variationezsign.nil?
        fail ArgumentError, 'e_ezmaxinvoicingagent_variationezsign cannot be nil'
      end

      @e_ezmaxinvoicingagent_variationezsign = e_ezmaxinvoicingagent_variationezsign
    end
