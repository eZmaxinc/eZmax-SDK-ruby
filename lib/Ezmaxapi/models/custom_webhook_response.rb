...
module EzmaxApi
  ...
  class CustomWebhookResponse < ApiModelBase
    ...
    # @param [Object] pki_webhook_id Value to be assigned
    def pki_webhook_id=(pki_webhook_id)
      if pki_webhook_id.nil?
        fail ArgumentError, 'pki_webhook_id cannot be nil'
      end
