...
module EzmaxApi
  ...
  class CustomWebhookResponse < ApiModelBase
    ...
    attr_accessor :e_webhook_ezmaxpartnerevent

    attr_accessor :e_webhook_ezsignevent

    attr_accessor :e_webhook_managementevent

    attr_accessor :e_webhook_realestateevent
    ...
    attr_accessor :s_webhook_authentificationexternalerror
    ...
    attr_accessor :fki_ezmaxpartnerproductstagewebhook_id
    ...
    def self.attribute_map
      {
        ...
        :'s_webhook_authentificationexternalerror' => :'sWebhookAuthentificationexternalerror',
    ...
    def self.openapi_types
      {
        ...
        :'s_webhook_authentificationexternalerror' => :'String',
        ...
        :'fki_ezmaxpartnerproductstagewebhook_id' => :'Integer'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomWebhookResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'e_webhook_ezmaxpartnerevent')
        self.e_webhook_ezmaxpartnerevent = attributes[:'e_webhook_ezmaxpartnerevent']
      end
      ...
      if attributes.key?(:'e_webhook_realestateevent')
        self.e_webhook_realestateevent = attributes[:'e_webhook_realestateevent']
      end
      ...
      if attributes.key?(:'s_webhook_authentificationexternalerror')
        self.s_webhook_authentificationexternalerror = attributes[:'s_webhook_authentificationexternalerror']
      end
      ...
      if attributes.key?(:'fki_ezmaxpartnerproductstagewebhook_id')
        self.fki_ezmaxpartnerproductstagewebhook_id = attributes[:'fki_ezmaxpartnerproductstagewebhook_id']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @pks_customer_code.to_s.length < 2
        invalid_properties.push('invalid value for "pks_customer_code", the character length must be greater than or equal to 2.')
      end
      ...
      if !@fki_ezmaxpartnerproductstagewebhook_id.nil? && @fki_ezmaxpartnerproductstagewebhook_id > 65535
        invalid_properties.push('invalid value for "fki_ezmaxpartnerproductstagewebhook_id", must be smaller than or equal to 65535.')
      end

      if !@fki_ezmaxpartnerproductstagewebhook_id.nil? && @fki_ezmaxpartnerproductstagewebhook_id < 0
        invalid_properties.push('invalid value for "fki_ezmaxpartnerproductstagewebhook_id", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@fki_ezmaxpartnerproductstagewebhook_id.nil? && @fki_ezmaxpartnerproductstagewebhook_id > 65535
      return false if !@fki_ezmaxpartnerproductstagewebhook_id.nil? && @fki_ezmaxpartnerproductstagewebhook_id < 0
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_webhook_description Value to be assigned
    def s_webhook_description=(s_webhook_description)
      if s_webhook_description.nil?
        fail ArgumentError, 's_webhook_description cannot be nil'
      end

      @s_webhook_description = s_webhook_description
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_webhook_module Value to be assigned
    def e_webhook_module=(e_webhook_module)
      if e_webhook_module.nil?
        fail ArgumentError, 'e_webhook_module cannot be nil'
      end

      @e_webhook_module = e_webhook_module
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_webhook_emailfailed Value to be assigned
    def s_webhook_emailfailed=(s_webhook_emailfailed)
      if s_webhook_emailfailed.nil?
        fail ArgumentError, 's_webhook_emailfailed cannot be nil'
      end

      @s_webhook_emailfailed = s_webhook_emailfailed
    end

    # Custom attribute writer method with validation
    # @param [Object] b_webhook_isactive Value to be assigned
    def b_webhook_isactive=(b_webhook_isactive)
      if b_webhook_isactive.nil?
        fail ArgumentError, 'b_webhook_isactive cannot be nil'
      end

      @b_webhook_isactive = b_webhook_isactive
    end

    # Custom attribute writer method with validation
    # @param [Object] b_webhook_issigned Value to be assigned
    def b_webhook_issigned=(b_webhook_issigned)
      if b_webhook_issigned.nil?
        fail ArgumentError, 'b_webhook_issigned cannot be nil'
      end

      @b_webhook_issigned = b_webhook_issigned
    end

    # Custom attribute writer method with validation
    # @param [Object] b_webhook_skipsslvalidation Value to be assigned
    def b_webhook_skipsslvalidation=(b_webhook_skipsslvalidation)
      if b_webhook_skipsslvalidation.nil?
        fail ArgumentError, 'b_webhook_skipsslvalidation cannot be nil'
      end

      @b_webhook_skipsslvalidation = b_webhook_skipsslvalidation
    end
    ...
    def pks_customer_code=(pks_customer_code)
      ...
      if pks_customer_code.to_s.length < 2
        fail ArgumentError, 'invalid value for "pks_customer_code", the character length must be greater than or equal to 2.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_webhook_test Value to be assigned
    def b_webhook_test=(b_webhook_test)
      if b_webhook_test.nil?
        fail ArgumentError, 'b_webhook_test cannot be nil'
      end

      @b_webhook_test = b_webhook_test
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] fki_ezmaxpartnerproductstagewebhook_id Value to be assigned
    def fki_ezmaxpartnerproductstagewebhook_id=(fki_ezmaxpartnerproductstagewebhook_id)
      if fki_ezmaxpartnerproductstagewebhook_id.nil?
        fail ArgumentError, 'fki_ezmaxpartnerproductstagewebhook_id cannot be nil'
      end

      if fki_ezmaxpartnerproductstagewebhook_id > 65535
        fail ArgumentError, 'invalid value for "fki_ezmaxpartnerproductstagewebhook_id", must be smaller than or equal to 65535.'
      end

      if fki_ezmaxpartnerproductstagewebhook_id < 0
        fail ArgumentError, 'invalid value for "fki_ezmaxpartnerproductstagewebhook_id", must be greater than or equal to 0.'
      end

      @fki_ezmaxpartnerproductstagewebhook_id = fki_ezmaxpartnerproductstagewebhook_id
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          e_webhook_ezmaxpartnerevent == o.e_webhook_ezmaxpartnerevent &&
          e_webhook_ezsignevent == o.e_webhook_ezsignevent &&
          e_webhook_managementevent == o.e_webhook_managementevent &&
          e_webhook_realestateevent == o.e_webhook_realestateevent &&
          ...
          s_webhook_authentificationexternalerror == o.s_webhook_authentificationexternalerror &&
          ...
          fki_ezmaxpartnerproductstagewebhook_id == o.fki_ezmaxpartnerproductstagewebhook_id
    end
    ...
    def hash
      [pki_webhook_id, fki_authenticationexternal_id, s_webhook_description, fki_ezsignfoldertype_id, s_ezsignfoldertype_name_x, e_webhook_module, e_webhook_ezmaxpartnerevent, e_webhook_ezsignevent, e_webhook_managementevent, e_webhook_realestateevent, s_webhook_url, s_webhook_emailfailed, s_webhook_apikey, s_webhook_secret, b_webhook_isactive, b_webhook_issigned, b_webhook_skipsslvalidation, s_authenticationexternal_description, obj_audit, s_webhook_event, s_webhook_authentificationexternalerror, a_obj_webhookheader, pks_customer_code, b_webhook_test, e_webhook_emittype, fki_ezmaxpartnerproductstagewebhook_id].hash
    end
