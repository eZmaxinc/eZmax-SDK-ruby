...
module EzmaxApi
  ...
  class EzsigndocumentApplyEzsigntemplateV2Request < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigndocumentApplyEzsigntemplateV2Request` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigndocumentApplyEzsigntemplateV2Request`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @a_s_ezsigntemplatesigner.length < 1
        invalid_properties.push('invalid value for "a_s_ezsigntemplatesigner", number of items must be greater than or equal to 1.')
      end
    ...
    def valid?
      ...
      return false if @a_s_ezsigntemplatesigner.length < 1
    ...
    def a_s_ezsigntemplatesigner=(a_s_ezsigntemplatesigner)
      ...
      if a_s_ezsigntemplatesigner.length < 1
        fail ArgumentError, 'invalid value for "a_s_ezsigntemplatesigner", number of items must be greater than or equal to 1.'
      end
    ...
    def hash
      [fki_ezsigntemplate_id, a_s_ezsigntemplatesigner, a_pki_ezsignfoldersignerassociation_id].hash
    end
