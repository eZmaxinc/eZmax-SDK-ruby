...
module EzmaxApi
  ...
  class CustomEzmaxinvoicingEzsignfolderResponse < ApiModelBase
    ...
    def hash
      [fki_ezsignfolder_id, fki_billingentityinternal_id, s_ezsignfolder_description, b_ezsigntsarequirement_billable, b_ezsignfolder_mfaused, b_ezsignfolder_allowed].hash
    end
