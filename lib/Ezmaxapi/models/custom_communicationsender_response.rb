...
module EzmaxApi
  ...
  class CustomCommunicationsenderResponse
    ...
    def valid?
      ...
      e_communicationsender_objecttype_validator = EnumAttributeValidator.new('String', ["Agent", "Broker", "User", "Mailboxshared"])
    ...
    def e_communicationsender_objecttype=(e_communicationsender_objecttype)
      validator = EnumAttributeValidator.new('String', ["Agent", "Broker", "User", "Mailboxshared"])
    ...
    def hash
      [fki_agent_id, fki_broker_id, fki_user_id, fki_mailboxshared_id, e_communicationsender_objecttype, obj_contact_name, s_email_address, s_phone_e164].hash
    end
