...
module EzmaxApi
  ...
  class EzsigntemplateglobalResponseCompound < ApiModelBase
    ...
    attr_accessor :a_obj_ezsigntemplateglobalannotation
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'a_obj_ezsigntemplateglobalannotation')
        if (value = attributes[:'a_obj_ezsigntemplateglobalannotation']).is_a?(Array)
          self.a_obj_ezsigntemplateglobalannotation = value
        end
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          a_obj_ezsigntemplateglobalannotation == o.a_obj_ezsigntemplateglobalannotation
    end
