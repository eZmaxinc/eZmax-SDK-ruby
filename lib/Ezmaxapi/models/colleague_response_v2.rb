...
module EzmaxApi
  # A Colleague Object
  class ColleagueResponseV2 < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::ColleagueResponseV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::ColleagueResponseV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_colleague_ezsignemail Value to be assigned
    def b_colleague_ezsignemail=(b_colleague_ezsignemail)
      if b_colleague_ezsignemail.nil?
        fail ArgumentError, 'b_colleague_ezsignemail cannot be nil'
      end

      @b_colleague_ezsignemail = b_colleague_ezsignemail
    end

    # Custom attribute writer method with validation
    # @param [Object] b_colleague_financial Value to be assigned
    def b_colleague_financial=(b_colleague_financial)
      if b_colleague_financial.nil?
        fail ArgumentError, 'b_colleague_financial cannot be nil'
      end

      @b_colleague_financial = b_colleague_financial
    end

    # Custom attribute writer method with validation
    # @param [Object] b_colleague_usecloneemail Value to be assigned
    def b_colleague_usecloneemail=(b_colleague_usecloneemail)
      if b_colleague_usecloneemail.nil?
        fail ArgumentError, 'b_colleague_usecloneemail cannot be nil'
      end

      @b_colleague_usecloneemail = b_colleague_usecloneemail
    end

    # Custom attribute writer method with validation
    # @param [Object] b_colleague_attachment Value to be assigned
    def b_colleague_attachment=(b_colleague_attachment)
      if b_colleague_attachment.nil?
        fail ArgumentError, 'b_colleague_attachment cannot be nil'
      end

      @b_colleague_attachment = b_colleague_attachment
    end

    # Custom attribute writer method with validation
    # @param [Object] b_colleague_canafe Value to be assigned
    def b_colleague_canafe=(b_colleague_canafe)
      if b_colleague_canafe.nil?
        fail ArgumentError, 'b_colleague_canafe cannot be nil'
      end

      @b_colleague_canafe = b_colleague_canafe
    end

    # Custom attribute writer method with validation
    # @param [Object] b_colleague_permission Value to be assigned
    def b_colleague_permission=(b_colleague_permission)
      if b_colleague_permission.nil?
        fail ArgumentError, 'b_colleague_permission cannot be nil'
      end

      @b_colleague_permission = b_colleague_permission
    end

    # Custom attribute writer method with validation
    # @param [Object] b_colleague_realestatecompleted Value to be assigned
    def b_colleague_realestatecompleted=(b_colleague_realestatecompleted)
      if b_colleague_realestatecompleted.nil?
        fail ArgumentError, 'b_colleague_realestatecompleted cannot be nil'
      end

      @b_colleague_realestatecompleted = b_colleague_realestatecompleted
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_colleague_ezsign Value to be assigned
    def e_colleague_ezsign=(e_colleague_ezsign)
      if e_colleague_ezsign.nil?
        fail ArgumentError, 'e_colleague_ezsign cannot be nil'
      end

      @e_colleague_ezsign = e_colleague_ezsign
    end

    # Custom attribute writer method with validation
    # @param [Object] e_colleague_realestateinprogress Value to be assigned
    def e_colleague_realestateinprogress=(e_colleague_realestateinprogress)
      if e_colleague_realestateinprogress.nil?
        fail ArgumentError, 'e_colleague_realestateinprogress cannot be nil'
      end

      @e_colleague_realestateinprogress = e_colleague_realestateinprogress
    end

    # Custom attribute writer method with validation
    # @param [Object] obj_user_name Value to be assigned
    def obj_user_name=(obj_user_name)
      if obj_user_name.nil?
        fail ArgumentError, 'obj_user_name cannot be nil'
      end
