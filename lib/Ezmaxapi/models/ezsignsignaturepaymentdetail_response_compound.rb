...
module EzmaxApi
  ...
  class EzsignsignaturepaymentdetailResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignsignaturepaymentdetailResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignsignaturepaymentdetailResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pki_ezsignsignaturepaymentdetail_id')
        ...
        self.pki_ezsignsignaturepaymentdetail_id = nil
      end
    ...
    def list_invalid_properties
      ...
      if @pki_ezsignsignaturepaymentdetail_id.nil?
        invalid_properties.push('invalid value for "pki_ezsignsignaturepaymentdetail_id", pki_ezsignsignaturepaymentdetail_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pki_ezsignsignaturepaymentdetail_id.nil?
      return false if @pki_ezsignsignaturepaymentdetail_id > 65535
      return false if @pki_ezsignsignaturepaymentdetail_id < 0
