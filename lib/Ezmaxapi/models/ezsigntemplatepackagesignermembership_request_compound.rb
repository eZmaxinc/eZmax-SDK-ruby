...
module EzmaxApi
  ...
  class EzsigntemplatepackagesignermembershipRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatepackagesignermembershipRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatepackagesignermembershipRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@pki_ezsigntemplatepackagesignermembership_id.nil? && @pki_ezsigntemplatepackagesignermembership_id < 0
    ...
    def valid?
      ...
      return false if !@pki_ezsigntemplatepackagesignermembership_id.nil? && @pki_ezsigntemplatepackagesignermembership_id < 0
