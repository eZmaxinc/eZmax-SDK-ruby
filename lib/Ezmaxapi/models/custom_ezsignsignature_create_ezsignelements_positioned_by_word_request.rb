...
module EzmaxApi
  ...
  class CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest < ApiModelBase
    ...
    attr_accessor :fki_paymentgateway_id
    ...
    attr_accessor :e_ezsignsignature_signaturepad

    attr_accessor :e_ezsignsignature_signaturepadrequired
    ...
    attr_accessor :s_ezsignsignature_creditcardamountdescription

    # The amount of the Creditcard signature
    attr_accessor :d_ezsignsignature_creditcardamount

    # Whether we can enter a custom amount while signing an Ezsignsignature 'Creditcard' or not
    attr_accessor :b_ezsignsignature_creditcardcustomamount
    ...
    attr_accessor :a_obj_ezsignsignaturepaymentdetail
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomEzsignsignatureCreateEzsignelementsPositionedByWordRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fki_paymentgateway_id')
        self.fki_paymentgateway_id = attributes[:'fki_paymentgateway_id']
      end
      ...
      if attributes.key?(:'e_ezsignsignature_signaturepad')
        self.e_ezsignsignature_signaturepad = attributes[:'e_ezsignsignature_signaturepad']
      end

      if attributes.key?(:'e_ezsignsignature_signaturepadrequired')
        self.e_ezsignsignature_signaturepadrequired = attributes[:'e_ezsignsignature_signaturepadrequired']
      end
      ...
      if attributes.key?(:'s_ezsignsignature_creditcardamountdescription')
        self.s_ezsignsignature_creditcardamountdescription = attributes[:'s_ezsignsignature_creditcardamountdescription']
      end

      if attributes.key?(:'d_ezsignsignature_creditcardamount')
        self.d_ezsignsignature_creditcardamount = attributes[:'d_ezsignsignature_creditcardamount']
      end

      if attributes.key?(:'b_ezsignsignature_creditcardcustomamount')
        self.b_ezsignsignature_creditcardcustomamount = attributes[:'b_ezsignsignature_creditcardcustomamount']
      end
      ...
      if attributes.key?(:'a_obj_ezsignsignaturepaymentdetail')
        if (value = attributes[:'a_obj_ezsignsignaturepaymentdetail']).is_a?(Array)
          self.a_obj_ezsignsignaturepaymentdetail = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if !@fki_paymentgateway_id.nil? && @fki_paymentgateway_id > 255
        invalid_properties.push('invalid value for "fki_paymentgateway_id", must be smaller than or equal to 255.')
      end

      if !@fki_paymentgateway_id.nil? && @fki_paymentgateway_id < 0
        invalid_properties.push('invalid value for "fki_paymentgateway_id", must be greater than or equal to 0.')
      end
      ...
      if !@s_ezsignsignature_textvalidationcustommessage.nil? && @s_ezsignsignature_textvalidationcustommessage.to_s.length < 0
        invalid_properties.push('invalid value for "s_ezsignsignature_textvalidationcustommessage", the character length must be greater than or equal to 0.')
      end
      ...
      if !@s_ezsignsignature_creditcardamountdescription.nil? && @s_ezsignsignature_creditcardamountdescription !~ pattern
        invalid_properties.push("invalid value for \"s_ezsignsignature_creditcardamountdescription\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/^[\d]{1,9}?\.[\d]{2}$/)
      if !@d_ezsignsignature_creditcardamount.nil? && @d_ezsignsignature_creditcardamount !~ pattern
        invalid_properties.push("invalid value for \"d_ezsignsignature_creditcardamount\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if !@fki_paymentgateway_id.nil? && @fki_paymentgateway_id > 255
      return false if !@fki_paymentgateway_id.nil? && @fki_paymentgateway_id < 0
      ...
      return false if !@s_ezsignsignature_creditcardamountdescription.nil? && @s_ezsignsignature_creditcardamountdescription !~ Regexp.new(/^.{1,50}$/)
      return false if !@d_ezsignsignature_creditcardamount.nil? && @d_ezsignsignature_creditcardamount !~ Regexp.new(/^[\d]{1,9}?\.[\d]{2}$/)
    ...
    # Custom attribute writer method with validation
    # @param [Object] fki_paymentgateway_id Value to be assigned
    def fki_paymentgateway_id=(fki_paymentgateway_id)
      if fki_paymentgateway_id.nil?
        fail ArgumentError, 'fki_paymentgateway_id cannot be nil'
      end

      if fki_paymentgateway_id > 255
        fail ArgumentError, 'invalid value for "fki_paymentgateway_id", must be smaller than or equal to 255.'
      end

      if fki_paymentgateway_id < 0
        fail ArgumentError, 'invalid value for "fki_paymentgateway_id", must be greater than or equal to 0.'
      end

      @fki_paymentgateway_id = fki_paymentgateway_id
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] i_ezsignsignature_step Value to be assigned
    def i_ezsignsignature_step=(i_ezsignsignature_step)
      if i_ezsignsignature_step.nil?
        fail ArgumentError, 'i_ezsignsignature_step cannot be nil'
      end

      @i_ezsignsignature_step = i_ezsignsignature_step
    end

    # Custom attribute writer method with validation
    # @param [Object] e_ezsignsignature_type Value to be assigned
    def e_ezsignsignature_type=(e_ezsignsignature_type)
      if e_ezsignsignature_type.nil?
        fail ArgumentError, 'e_ezsignsignature_type cannot be nil'
      end

      @e_ezsignsignature_type = e_ezsignsignature_type
    end
    ...
    def s_ezsignsignature_textvalidationcustommessage=(s_ezsignsignature_textvalidationcustommessage)
      ...
      if s_ezsignsignature_textvalidationcustommessage.to_s.length < 0
        fail ArgumentError, 'invalid value for "s_ezsignsignature_textvalidationcustommessage", the character length must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_ezsignsignature_creditcardamountdescription Value to be assigned
    def s_ezsignsignature_creditcardamountdescription=(s_ezsignsignature_creditcardamountdescription)
      if s_ezsignsignature_creditcardamountdescription.nil?
        fail ArgumentError, 's_ezsignsignature_creditcardamountdescription cannot be nil'
      end

      pattern = Regexp.new(/^.{1,50}$/)
      if s_ezsignsignature_creditcardamountdescription !~ pattern
        fail ArgumentError, "invalid value for \"s_ezsignsignature_creditcardamountdescription\", must conform to the pattern #{pattern}."
      end

      @s_ezsignsignature_creditcardamountdescription = s_ezsignsignature_creditcardamountdescription
    end

    # Custom attribute writer method with validation
    # @param [Object] d_ezsignsignature_creditcardamount Value to be assigned
    def d_ezsignsignature_creditcardamount=(d_ezsignsignature_creditcardamount)
      if d_ezsignsignature_creditcardamount.nil?
        fail ArgumentError, 'd_ezsignsignature_creditcardamount cannot be nil'
      end

      pattern = Regexp.new(/^[\d]{1,9}?\.[\d]{2}$/)
      if d_ezsignsignature_creditcardamount !~ pattern
        fail ArgumentError, "invalid value for \"d_ezsignsignature_creditcardamount\", must conform to the pattern #{pattern}."
      end

      @d_ezsignsignature_creditcardamount = d_ezsignsignature_creditcardamount
    end

    # Custom attribute writer method with validation
    # @param [Object] obj_createezsignelementspositionedbyword Value to be assigned
    def obj_createezsignelementspositionedbyword=(obj_createezsignelementspositionedbyword)
      if obj_createezsignelementspositionedbyword.nil?
        fail ArgumentError, 'obj_createezsignelementspositionedbyword cannot be nil'
      end

      @obj_createezsignelementspositionedbyword = obj_createezsignelementspositionedbyword
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fki_paymentgateway_id == o.fki_paymentgateway_id &&
          ...
          e_ezsignsignature_signaturepad == o.e_ezsignsignature_signaturepad &&
          e_ezsignsignature_signaturepadrequired == o.e_ezsignsignature_signaturepadrequired &&
          ...
          s_ezsignsignature_creditcardamountdescription == o.s_ezsignsignature_creditcardamountdescription &&
          d_ezsignsignature_creditcardamount == o.d_ezsignsignature_creditcardamount &&
          b_ezsignsignature_creditcardcustomamount == o.b_ezsignsignature_creditcardcustomamount &&
          ...
          a_obj_ezsignsignaturepaymentdetail == o.a_obj_ezsignsignaturepaymentdetail &&
    ...
    def hash
      [pki_ezsignsignature_id, fki_ezsignfoldersignerassociation_id, fki_paymentgateway_id, i_ezsignpage_pagenumber, i_ezsignsignature_x, i_ezsignsignature_y, i_ezsignsignature_width, i_ezsignsignature_height, i_ezsignsignature_step, e_ezsignsignature_type, e_ezsignsignature_signaturepad, e_ezsignsignature_signaturepadrequired, fki_ezsigndocument_id, t_ezsignsignature_tooltip, e_ezsignsignature_tooltipposition, e_ezsignsignature_font, fki_ezsignfoldersignerassociation_id_validation, b_ezsignsignature_handwritten, b_ezsignsignature_reason, b_ezsignsignature_required, e_ezsignsignature_attachmentnamesource, s_ezsignsignature_attachmentdescription, e_ezsignsignature_consultationtrigger, i_ezsignsignature_validationstep, i_ezsignsignature_maxlength, s_ezsignsignature_defaultvalue, e_ezsignsignature_textvalidation, s_ezsignsignature_textvalidationcustommessage, s_ezsignsignature_regexp, e_ezsignsignature_dependencyrequirement, s_ezsignsignature_creditcardamountdescription, d_ezsignsignature_creditcardamount, b_ezsignsignature_creditcardcustomamount, b_ezsignsignature_customdate, a_obj_ezsignsignaturecustomdate, a_obj_ezsignelementdependency, a_obj_ezsignsignaturepaymentdetail, obj_createezsignelementspositionedbyword].hash
    end
