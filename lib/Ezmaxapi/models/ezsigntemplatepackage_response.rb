...
module EzmaxApi
  ...
  class EzsigntemplatepackageResponse
    ...
    def hash
      [pki_ezsigntemplatepackage_id, fki_ezsignfoldertype_id, fki_language_id, s_language_name_x, s_ezsigntemplatepackage_description, b_ezsigntemplatepackage_adminonly, b_ezsigntemplatepackage_needvalidation, b_ezsigntemplatepackage_isactive, s_ezsignfoldertype_name_x].hash
    end
