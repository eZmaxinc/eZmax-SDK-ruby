...
module EzmaxApi
  ...
  class EzsigntemplatesignatureRequestCompoundV2 < ApiModelBase
    ...
    attr_accessor :b_ezsigntemplatesignature_creditcardcustomamount
    ...
    attr_accessor :e_ezsigntemplatesignature_signaturepad

    attr_accessor :e_ezsigntemplatesignature_signaturepadrequired
    ...
    attr_accessor :s_ezsigntemplatesignature_creditcardamountdescription

    # The amount of the Creditcard signature
    attr_accessor :d_ezsigntemplatesignature_creditcardamount
    ...
    attr_accessor :a_obj_ezsigntemplatesignaturepaymentdetail
    ...
    def self.attribute_map
      {
        ...
        :'b_ezsigntemplatesignature_creditcardcustomamount' => :'bEzsigntemplatesignatureCreditcardcustomamount',
        ...
        :'s_ezsigntemplatesignature_creditcardamountdescription' => :'sEzsigntemplatesignatureCreditcardamountdescription',
        :'d_ezsigntemplatesignature_creditcardamount' => :'dEzsigntemplatesignatureCreditcardamount',
        ...
        :'a_obj_ezsigntemplatesignaturepaymentdetail' => :'a_objEzsigntemplatesignaturepaymentdetail'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'b_ezsigntemplatesignature_creditcardcustomamount' => :'Boolean',
        ...
        :'s_ezsigntemplatesignature_creditcardamountdescription' => :'String',
        :'d_ezsigntemplatesignature_creditcardamount' => :'String',
        ...
        :'a_obj_ezsigntemplatesignaturepaymentdetail' => :'Array<EzsigntemplatesignaturepaymentdetailRequestCompound>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatesignatureRequestCompoundV2` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatesignatureRequestCompoundV2`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'b_ezsigntemplatesignature_creditcardcustomamount')
        self.b_ezsigntemplatesignature_creditcardcustomamount = attributes[:'b_ezsigntemplatesignature_creditcardcustomamount']
      end
      ...
      if attributes.key?(:'e_ezsigntemplatesignature_signaturepad')
        self.e_ezsigntemplatesignature_signaturepad = attributes[:'e_ezsigntemplatesignature_signaturepad']
      end

      if attributes.key?(:'e_ezsigntemplatesignature_signaturepadrequired')
        self.e_ezsigntemplatesignature_signaturepadrequired = attributes[:'e_ezsigntemplatesignature_signaturepadrequired']
      end
      ...
      if attributes.key?(:'s_ezsigntemplatesignature_creditcardamountdescription')
        self.s_ezsigntemplatesignature_creditcardamountdescription = attributes[:'s_ezsigntemplatesignature_creditcardamountdescription']
      end

      if attributes.key?(:'d_ezsigntemplatesignature_creditcardamount')
        self.d_ezsigntemplatesignature_creditcardamount = attributes[:'d_ezsigntemplatesignature_creditcardamount']
      end
      ...
      if attributes.key?(:'a_obj_ezsigntemplatesignaturepaymentdetail')
        if (value = attributes[:'a_obj_ezsigntemplatesignaturepaymentdetail']).is_a?(Array)
          self.a_obj_ezsigntemplatesignaturepaymentdetail = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@s_ezsigntemplatesignature_textvalidationcustommessage.nil? && @s_ezsigntemplatesignature_textvalidationcustommessage.to_s.length < 0
        invalid_properties.push('invalid value for "s_ezsigntemplatesignature_textvalidationcustommessage", the character length must be greater than or equal to 0.')
      end
      ...
      if !@s_ezsigntemplatesignature_creditcardamountdescription.nil? && @s_ezsigntemplatesignature_creditcardamountdescription !~ pattern
        invalid_properties.push("invalid value for \"s_ezsigntemplatesignature_creditcardamountdescription\", must conform to the pattern #{pattern}.")
      end

      pattern = Regexp.new(/^-{0,1}[\d]{1,9}?\.[\d]{2}$/)
      if !@d_ezsigntemplatesignature_creditcardamount.nil? && @d_ezsigntemplatesignature_creditcardamount !~ pattern
        invalid_properties.push("invalid value for \"d_ezsigntemplatesignature_creditcardamount\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if !@s_ezsigntemplatesignature_creditcardamountdescription.nil? && @s_ezsigntemplatesignature_creditcardamountdescription !~ Regexp.new(/^.{1,50}$/)
      return false if !@d_ezsigntemplatesignature_creditcardamount.nil? && @d_ezsigntemplatesignature_creditcardamount !~ Regexp.new(/^-{0,1}[\d]{1,9}?\.[\d]{2}$/)
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsigntemplatesignature_type Value to be assigned
    def e_ezsigntemplatesignature_type=(e_ezsigntemplatesignature_type)
      if e_ezsigntemplatesignature_type.nil?
        fail ArgumentError, 'e_ezsigntemplatesignature_type cannot be nil'
      end

      @e_ezsigntemplatesignature_type = e_ezsigntemplatesignature_type
    end
    ...
    def s_ezsigntemplatesignature_textvalidationcustommessage=(s_ezsigntemplatesignature_textvalidationcustommessage)
      ...
      if s_ezsigntemplatesignature_textvalidationcustommessage.to_s.length < 0
        fail ArgumentError, 'invalid value for "s_ezsigntemplatesignature_textvalidationcustommessage", the character length must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_ezsigntemplatesignature_creditcardamountdescription Value to be assigned
    def s_ezsigntemplatesignature_creditcardamountdescription=(s_ezsigntemplatesignature_creditcardamountdescription)
      if s_ezsigntemplatesignature_creditcardamountdescription.nil?
        fail ArgumentError, 's_ezsigntemplatesignature_creditcardamountdescription cannot be nil'
      end

      pattern = Regexp.new(/^.{1,50}$/)
      if s_ezsigntemplatesignature_creditcardamountdescription !~ pattern
        fail ArgumentError, "invalid value for \"s_ezsigntemplatesignature_creditcardamountdescription\", must conform to the pattern #{pattern}."
      end

      @s_ezsigntemplatesignature_creditcardamountdescription = s_ezsigntemplatesignature_creditcardamountdescription
    end

    # Custom attribute writer method with validation
    # @param [Object] d_ezsigntemplatesignature_creditcardamount Value to be assigned
    def d_ezsigntemplatesignature_creditcardamount=(d_ezsigntemplatesignature_creditcardamount)
      if d_ezsigntemplatesignature_creditcardamount.nil?
        fail ArgumentError, 'd_ezsigntemplatesignature_creditcardamount cannot be nil'
      end

      pattern = Regexp.new(/^-{0,1}[\d]{1,9}?\.[\d]{2}$/)
      if d_ezsigntemplatesignature_creditcardamount !~ pattern
        fail ArgumentError, "invalid value for \"d_ezsigntemplatesignature_creditcardamount\", must conform to the pattern #{pattern}."
      end

      @d_ezsigntemplatesignature_creditcardamount = d_ezsigntemplatesignature_creditcardamount
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          b_ezsigntemplatesignature_creditcardcustomamount == o.b_ezsigntemplatesignature_creditcardcustomamount &&
          ...
          e_ezsigntemplatesignature_signaturepad == o.e_ezsigntemplatesignature_signaturepad &&
          e_ezsigntemplatesignature_signaturepadrequired == o.e_ezsigntemplatesignature_signaturepadrequired &&
          ...
          s_ezsigntemplatesignature_creditcardamountdescription == o.s_ezsigntemplatesignature_creditcardamountdescription &&
          d_ezsigntemplatesignature_creditcardamount == o.d_ezsigntemplatesignature_creditcardamount &&
          ...
          a_obj_ezsigntemplatesignaturepaymentdetail == o.a_obj_ezsigntemplatesignaturepaymentdetail
    end
    ...
    def hash
      [pki_ezsigntemplatesignature_id, fki_ezsigntemplatedocument_id, fki_ezsigntemplatesigner_id, fki_ezsigntemplatesigner_id_validation, fki_paymentgateway_id, b_ezsigntemplatesignature_handwritten, b_ezsigntemplatesignature_reason, b_ezsigntemplatesignature_creditcardcustomamount, e_ezsigntemplatesignature_positioning, i_ezsigntemplatedocumentpage_pagenumber, i_ezsigntemplatesignature_x, i_ezsigntemplatesignature_y, i_ezsigntemplatesignature_width, i_ezsigntemplatesignature_height, i_ezsigntemplatesignature_step, e_ezsigntemplatesignature_type, e_ezsigntemplatesignature_signaturepad, e_ezsigntemplatesignature_signaturepadrequired, e_ezsigntemplatesignature_consultationtrigger, t_ezsigntemplatesignature_tooltip, e_ezsigntemplatesignature_tooltipposition, e_ezsigntemplatesignature_font, b_ezsigntemplatesignature_required, e_ezsigntemplatesignature_attachmentnamesource, s_ezsigntemplatesignature_attachmentdescription, i_ezsigntemplatesignature_validationstep, i_ezsigntemplatesignature_maxlength, s_ezsigntemplatesignature_defaultvalue, s_ezsigntemplatesignature_regexp, e_ezsigntemplatesignature_textvalidation, s_ezsigntemplatesignature_textvalidationcustommessage, e_ezsigntemplatesignature_dependencyrequirement, s_ezsigntemplatesignature_positioningpattern, i_ezsigntemplatesignature_positioningoffsetx, i_ezsigntemplatesignature_positioningoffsety, e_ezsigntemplatesignature_positioningoccurence, s_ezsigntemplatesignature_creditcardamountdescription, d_ezsigntemplatesignature_creditcardamount, b_ezsigntemplatesignature_customdate, a_obj_ezsigntemplatesignaturecustomdate, a_obj_ezsigntemplateelementdependency, a_obj_ezsigntemplatesignaturepaymentdetail].hash
    end
