...
module EzmaxApi
  ...
  class CustomFormDataEzsignformfieldgroupResponse < ApiModelBase
    ...
    def self.openapi_types
      {
        ...
        :'a_obj_ezsignformfield' => :'Array<CustomFormDataEzsignformfieldResponse>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::CustomFormDataEzsignformfieldgroupResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomFormDataEzsignformfieldgroupResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [s_ezsignformfieldgroup_label, a_obj_ezsignformfield].hash
    end
