...
module EzmaxApi
  ...
  class EzmaxinvoicingsummaryglobalResponseCompound < ApiModelBase
    ...
    attr_accessor :a_obj_ezmaxinvoicingcommission
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzmaxinvoicingsummaryglobalResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzmaxinvoicingsummaryglobalResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'a_obj_ezmaxinvoicingcommission')
        if (value = attributes[:'a_obj_ezmaxinvoicingcommission']).is_a?(Array)
          self.a_obj_ezmaxinvoicingcommission = value
        end
      end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] dt_ezmaxinvoicingsummaryglobal_start Value to be assigned
    def dt_ezmaxinvoicingsummaryglobal_start=(dt_ezmaxinvoicingsummaryglobal_start)
      if dt_ezmaxinvoicingsummaryglobal_start.nil?
        fail ArgumentError, 'dt_ezmaxinvoicingsummaryglobal_start cannot be nil'
      end

      @dt_ezmaxinvoicingsummaryglobal_start = dt_ezmaxinvoicingsummaryglobal_start
    end

    # Custom attribute writer method with validation
    # @param [Object] dt_ezmaxinvoicingsummaryglobal_end Value to be assigned
    def dt_ezmaxinvoicingsummaryglobal_end=(dt_ezmaxinvoicingsummaryglobal_end)
      if dt_ezmaxinvoicingsummaryglobal_end.nil?
        fail ArgumentError, 'dt_ezmaxinvoicingsummaryglobal_end cannot be nil'
      end

      @dt_ezmaxinvoicingsummaryglobal_end = dt_ezmaxinvoicingsummaryglobal_end
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezmaxinvoicingsummaryglobal_adjustment Value to be assigned
    def b_ezmaxinvoicingsummaryglobal_adjustment=(b_ezmaxinvoicingsummaryglobal_adjustment)
      if b_ezmaxinvoicingsummaryglobal_adjustment.nil?
        fail ArgumentError, 'b_ezmaxinvoicingsummaryglobal_adjustment cannot be nil'
      end

      @b_ezmaxinvoicingsummaryglobal_adjustment = b_ezmaxinvoicingsummaryglobal_adjustment
    end

    # Custom attribute writer method with validation
    # @param [Object] t_ezmaxproduct_help_x Value to be assigned
    def t_ezmaxproduct_help_x=(t_ezmaxproduct_help_x)
      if t_ezmaxproduct_help_x.nil?
        fail ArgumentError, 't_ezmaxproduct_help_x cannot be nil'
      end

      @t_ezmaxproduct_help_x = t_ezmaxproduct_help_x
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          a_obj_ezmaxinvoicingcommission == o.a_obj_ezmaxinvoicingcommission
    end
