...
module EzmaxApi
  ...
  class EzsignbulksendCreateEzsignbulksendtransmissionV2Request < ApiModelBase
    ...
    def hash
      [fki_userlogintype_id, fki_secretquestion_id, fki_ezsigntsarequirement_id, s_ezsignbulksendtransmission_description, dt_ezsigndocument_duedate, i_ezsignfolder_sendreminderfirstdays, i_ezsignfolder_sendreminderotherdays, t_extra_message, s_csv_base64].hash
    end
