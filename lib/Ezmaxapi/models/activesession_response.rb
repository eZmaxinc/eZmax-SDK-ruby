...
module EzmaxApi
  ...
  class ActivesessionResponse < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::ActivesessionResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def hash
      [e_activesession_usertype, e_activesession_origin, e_activesession_weekdaystart, fki_language_id, s_company_name_x, s_department_name_x, b_activesession_debug, b_activesession_issuperadmin, b_activesession_attachment, b_activesession_canafe, b_activesession_financial, b_activesession_realestatecompleted, e_activesession_ezsign, e_activesession_ezsignaccess, e_activesession_ezsignprepaid, e_activesession_realestateinprogress, pks_customer_code, fki_systemconfigurationtype_id, fki_signature_id].hash
    end
