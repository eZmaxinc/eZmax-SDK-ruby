...
module EzmaxApi
  ...
  class CommonResponseErrorCreditcardValidation < ApiModelBase
    ...
    attr_accessor :obj_creditcardtransactionresponse
    ...
    def self.attribute_map
      {
        ...
        :'obj_creditcardtransactionresponse' => :'objCreditcardtransactionresponse'
      }
    end
    ...
    def self.openapi_types
      {
        ...
        :'obj_creditcardtransactionresponse' => :'CustomCreditcardtransactionresponseResponse'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::CommonResponseErrorCreditcardValidation` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CommonResponseErrorCreditcardValidation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'obj_creditcardtransactionresponse')
        self.obj_creditcardtransactionresponse = attributes[:'obj_creditcardtransactionresponse']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          obj_creditcardtransactionresponse == o.obj_creditcardtransactionresponse
    end
    ...
    def hash
      [s_error_message, e_error_code, a_s_error_messagedetail, obj_creditcardtransactionresponse].hash
    end
