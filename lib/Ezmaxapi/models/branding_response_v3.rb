...
module EzmaxApi
  ...
  class BrandingResponseV3
    ...
    def hash
      [pki_branding_id, fki_email_id, obj_branding_description, s_branding_description_x, s_branding_name, s_email_address, e_branding_logo, e_branding_alignlogo, i_branding_color, b_branding_isactive].hash
    end
