...
module EzmaxApi
  # A Branding Object
  class BrandingResponseV3 < ApiModelBase
    # The unique ID of the Branding
    attr_accessor :pki_branding_id

    # The unique ID of the Domain
    attr_accessor :fki_domain_id
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::BrandingResponseV3` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::BrandingResponseV3`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fki_domain_id')
        self.fki_domain_id = attributes[:'fki_domain_id']
      end
    ...
    def list_invalid_properties
      ...
      if !@fki_domain_id.nil? && @fki_domain_id > 255
        invalid_properties.push('invalid value for "fki_domain_id", must be smaller than or equal to 255.')
      end

      if !@fki_domain_id.nil? && @fki_domain_id < 0
        invalid_properties.push('invalid value for "fki_domain_id", must be greater than or equal to 0.')
      end

      pattern = Regexp.new(/^(?=.{4,75}$)([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,63}$/)
      if !@s_domain_name.nil? && @s_domain_name !~ pattern
    ...
    def valid?
      ...
      return false if !@fki_domain_id.nil? && @fki_domain_id > 255
      return false if !@fki_domain_id.nil? && @fki_domain_id < 0
      return false if !@s_domain_name.nil? && @s_domain_name !~ Regexp.new(/^(?=.{4,75}$)([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,63}$/)
    ...
    # Custom attribute writer method with validation
    # @param [Object] fki_domain_id Value to be assigned
    def fki_domain_id=(fki_domain_id)
      if fki_domain_id.nil?
        fail ArgumentError, 'fki_domain_id cannot be nil'
      end

      if fki_domain_id > 255
        fail ArgumentError, 'invalid value for "fki_domain_id", must be smaller than or equal to 255.'
      end

      if fki_domain_id < 0
        fail ArgumentError, 'invalid value for "fki_domain_id", must be greater than or equal to 0.'
      end

      @fki_domain_id = fki_domain_id
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] obj_branding_description Value to be assigned
    def obj_branding_description=(obj_branding_description)
      if obj_branding_description.nil?
        fail ArgumentError, 'obj_branding_description cannot be nil'
      end

      @obj_branding_description = obj_branding_description
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_branding_logo Value to be assigned
    def e_branding_logo=(e_branding_logo)
      if e_branding_logo.nil?
        fail ArgumentError, 'e_branding_logo cannot be nil'
      end

      @e_branding_logo = e_branding_logo
    end

    # Custom attribute writer method with validation
    # @param [Object] e_branding_alignlogo Value to be assigned
    def e_branding_alignlogo=(e_branding_alignlogo)
      if e_branding_alignlogo.nil?
        fail ArgumentError, 'e_branding_alignlogo cannot be nil'
      end

      @e_branding_alignlogo = e_branding_alignlogo
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_branding_isactive Value to be assigned
    def b_branding_isactive=(b_branding_isactive)
      if b_branding_isactive.nil?
        fail ArgumentError, 'b_branding_isactive cannot be nil'
      end

      @b_branding_isactive = b_branding_isactive
    end
    ...
    def hash
      [pki_branding_id, fki_domain_id, s_domain_name, fki_email_id, obj_branding_description, s_branding_description_x, s_branding_name, s_email_address, e_branding_logo, e_branding_alignlogo, i_branding_color, b_branding_isactive].hash
    end
