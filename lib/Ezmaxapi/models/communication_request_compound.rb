...
module EzmaxApi
  ...
  class CommunicationRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CommunicationRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] t_communication_body Value to be assigned
    def t_communication_body=(t_communication_body)
      if t_communication_body.nil?
        fail ArgumentError, 't_communication_body cannot be nil'
      end

      @t_communication_body = t_communication_body
    end

    # Custom attribute writer method with validation
    # @param [Object] b_communication_private Value to be assigned
    def b_communication_private=(b_communication_private)
      if b_communication_private.nil?
        fail ArgumentError, 'b_communication_private cannot be nil'
      end

      @b_communication_private = b_communication_private
    end
