...
module EzmaxApi
  ...
  class EzsigndocumentGetObjectV1ResponseMPayload < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigndocumentGetObjectV1ResponseMPayload`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsigndocument_steptype Value to be assigned
    def e_ezsigndocument_steptype=(e_ezsigndocument_steptype)
      if e_ezsigndocument_steptype.nil?
        fail ArgumentError, 'e_ezsigndocument_steptype cannot be nil'
      end

      @e_ezsigndocument_steptype = e_ezsigndocument_steptype
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsigndocument_stepformtotal Value to be assigned
    def i_ezsigndocument_stepformtotal=(i_ezsigndocument_stepformtotal)
      if i_ezsigndocument_stepformtotal.nil?
        fail ArgumentError, 'i_ezsigndocument_stepformtotal cannot be nil'
      end

      @i_ezsigndocument_stepformtotal = i_ezsigndocument_stepformtotal
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsigndocument_stepformcurrent Value to be assigned
    def i_ezsigndocument_stepformcurrent=(i_ezsigndocument_stepformcurrent)
      if i_ezsigndocument_stepformcurrent.nil?
        fail ArgumentError, 'i_ezsigndocument_stepformcurrent cannot be nil'
      end

      @i_ezsigndocument_stepformcurrent = i_ezsigndocument_stepformcurrent
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsigndocument_stepsignaturetotal Value to be assigned
    def i_ezsigndocument_stepsignaturetotal=(i_ezsigndocument_stepsignaturetotal)
      if i_ezsigndocument_stepsignaturetotal.nil?
        fail ArgumentError, 'i_ezsigndocument_stepsignaturetotal cannot be nil'
      end

      @i_ezsigndocument_stepsignaturetotal = i_ezsigndocument_stepsignaturetotal
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsigndocument_stepsignature_current Value to be assigned
    def i_ezsigndocument_stepsignature_current=(i_ezsigndocument_stepsignature_current)
      if i_ezsigndocument_stepsignature_current.nil?
        fail ArgumentError, 'i_ezsigndocument_stepsignature_current cannot be nil'
      end

      @i_ezsigndocument_stepsignature_current = i_ezsigndocument_stepsignature_current
    end
