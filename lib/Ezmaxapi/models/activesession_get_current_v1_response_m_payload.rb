...
module EzmaxApi
  ...
  class ActivesessionGetCurrentV1ResponseMPayload
    ...
    def hash
      [e_activesession_usertype, e_activesession_origin, e_activesession_weekdaystart, fki_language_id, s_company_name_x, s_department_name_x, b_activesession_debug, b_activesession_issuperadmin, pks_customer_code, fki_systemconfigurationtype_id, fki_signature_id, a_pki_permission_id, obj_user_real, obj_user_cloned, obj_apikey, a_e_module_internalname].hash
    end
