...
module EzmaxApi
  ...
  class EzsigntemplateResponseCompound < ApiModelBase
    ...
    attr_accessor :s_ezsigntemplate_filenamepattern
    ...
    attr_accessor :a_obj_ezsigntemplateannotation
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplateResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_ezsigntemplate_filenamepattern')
        self.s_ezsigntemplate_filenamepattern = attributes[:'s_ezsigntemplate_filenamepattern']
      end
      ...
      if attributes.key?(:'a_obj_ezsigntemplateannotation')
        if (value = attributes[:'a_obj_ezsigntemplateannotation']).is_a?(Array)
          self.a_obj_ezsigntemplateannotation = value
        end
      end
    end
    ...
    def list_invalid_properties
      ...
      if !@s_ezsigntemplate_filenamepattern.nil? && @s_ezsigntemplate_filenamepattern !~ pattern
        invalid_properties.push("invalid value for \"s_ezsigntemplate_filenamepattern\", must conform to the pattern #{pattern}.")
      end
    ...
    def valid?
      ...
      return false if !@s_ezsigntemplate_filenamepattern.nil? && @s_ezsigntemplate_filenamepattern !~ Regexp.new(/^.{1,50}$/)
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_ezsigntemplate_filenamepattern Value to be assigned
    def s_ezsigntemplate_filenamepattern=(s_ezsigntemplate_filenamepattern)
      if s_ezsigntemplate_filenamepattern.nil?
        fail ArgumentError, 's_ezsigntemplate_filenamepattern cannot be nil'
      end

      pattern = Regexp.new(/^.{1,50}$/)
      if s_ezsigntemplate_filenamepattern !~ pattern
        fail ArgumentError, "invalid value for \"s_ezsigntemplate_filenamepattern\", must conform to the pattern #{pattern}."
      end

      @s_ezsigntemplate_filenamepattern = s_ezsigntemplate_filenamepattern
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          s_ezsigntemplate_filenamepattern == o.s_ezsigntemplate_filenamepattern &&
          ...
          a_obj_ezsigntemplateannotation == o.a_obj_ezsigntemplateannotation
    end
    ...
    def hash
      [pki_ezsigntemplate_id, fki_ezsigntemplatedocument_id, fki_ezsignfoldertype_id, fki_language_id, fki_ezdoctemplatedocument_id, s_language_name_x, s_ezsigntemplate_description, s_ezsigntemplate_externaldescription, t_ezsigntemplate_comment, s_ezsigntemplate_filenamepattern, b_ezsigntemplate_adminonly, s_ezsignfoldertype_name_x, obj_audit, b_ezsigntemplate_editallowed, e_ezsigntemplate_type, obj_ezsigntemplatedocument, a_obj_ezsigntemplatesigner, a_obj_ezsigntemplateannotation].hash
    end
