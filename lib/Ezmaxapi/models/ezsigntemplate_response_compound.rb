...
module EzmaxApi
  ...
  class EzsigntemplateResponseCompound < EzsigntemplateResponse
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          a_obj_ezsigntemplatesigner == o.a_obj_ezsigntemplatesigner && super(o)
    end
    ...
    def hash
      [obj_ezsigntemplatedocument, a_obj_ezsigntemplatesigner].hash
    end
