  ...
  class CommunicationexternalrecipientRequestCompound
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::CommunicationexternalrecipientRequestCompound` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CommunicationexternalrecipientRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_communicationexternalrecipient_name')
        ...
        self.s_communicationexternalrecipient_name = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @s_communicationexternalrecipient_name.nil?
        invalid_properties.push('invalid value for "s_communicationexternalrecipient_name", s_communicationexternalrecipient_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @s_communicationexternalrecipient_name.nil?
      return false if @s_communicationexternalrecipient_name !~ Regexp.new(/^.{0,50}$/)
      true
    end
