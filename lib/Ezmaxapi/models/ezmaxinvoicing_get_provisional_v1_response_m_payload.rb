...
module EzmaxApi
  ...
  class EzmaxinvoicingGetProvisionalV1ResponseMPayload < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzmaxinvoicingGetProvisionalV1ResponseMPayload` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzmaxinvoicingGetProvisionalV1ResponseMPayload`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezmaxinvoicing_paymenttype Value to be assigned
    def e_ezmaxinvoicing_paymenttype=(e_ezmaxinvoicing_paymenttype)
      if e_ezmaxinvoicing_paymenttype.nil?
        fail ArgumentError, 'e_ezmaxinvoicing_paymenttype cannot be nil'
      end

      @e_ezmaxinvoicing_paymenttype = e_ezmaxinvoicing_paymenttype
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezmaxinvoicing_rebate_ezsignallagents Value to be assigned
    def b_ezmaxinvoicing_rebate_ezsignallagents=(b_ezmaxinvoicing_rebate_ezsignallagents)
      if b_ezmaxinvoicing_rebate_ezsignallagents.nil?
        fail ArgumentError, 'b_ezmaxinvoicing_rebate_ezsignallagents cannot be nil'
      end

      @b_ezmaxinvoicing_rebate_ezsignallagents = b_ezmaxinvoicing_rebate_ezsignallagents
    end

    # Custom attribute writer method with validation
    # @param [Object] obj_ezmaxinvoicingcontract Value to be assigned
    def obj_ezmaxinvoicingcontract=(obj_ezmaxinvoicingcontract)
      if obj_ezmaxinvoicingcontract.nil?
        fail ArgumentError, 'obj_ezmaxinvoicingcontract cannot be nil'
      end

      @obj_ezmaxinvoicingcontract = obj_ezmaxinvoicingcontract
    end

    # Custom attribute writer method with validation
    # @param [Object] obj_ezmaxpricing Value to be assigned
    def obj_ezmaxpricing=(obj_ezmaxpricing)
      if obj_ezmaxpricing.nil?
        fail ArgumentError, 'obj_ezmaxpricing cannot be nil'
      end

      @obj_ezmaxpricing = obj_ezmaxpricing
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezmaxinvoicingsummaryglobal Value to be assigned
    def a_obj_ezmaxinvoicingsummaryglobal=(a_obj_ezmaxinvoicingsummaryglobal)
      if a_obj_ezmaxinvoicingsummaryglobal.nil?
        fail ArgumentError, 'a_obj_ezmaxinvoicingsummaryglobal cannot be nil'
      end

      @a_obj_ezmaxinvoicingsummaryglobal = a_obj_ezmaxinvoicingsummaryglobal
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezmaxinvoicingsummaryexternal Value to be assigned
    def a_obj_ezmaxinvoicingsummaryexternal=(a_obj_ezmaxinvoicingsummaryexternal)
      if a_obj_ezmaxinvoicingsummaryexternal.nil?
        fail ArgumentError, 'a_obj_ezmaxinvoicingsummaryexternal cannot be nil'
      end

      @a_obj_ezmaxinvoicingsummaryexternal = a_obj_ezmaxinvoicingsummaryexternal
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezmaxinvoicingsummaryinternal Value to be assigned
    def a_obj_ezmaxinvoicingsummaryinternal=(a_obj_ezmaxinvoicingsummaryinternal)
      if a_obj_ezmaxinvoicingsummaryinternal.nil?
        fail ArgumentError, 'a_obj_ezmaxinvoicingsummaryinternal cannot be nil'
      end

      @a_obj_ezmaxinvoicingsummaryinternal = a_obj_ezmaxinvoicingsummaryinternal
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezmaxinvoicingagent Value to be assigned
    def a_obj_ezmaxinvoicingagent=(a_obj_ezmaxinvoicingagent)
      if a_obj_ezmaxinvoicingagent.nil?
        fail ArgumentError, 'a_obj_ezmaxinvoicingagent cannot be nil'
      end

      @a_obj_ezmaxinvoicingagent = a_obj_ezmaxinvoicingagent
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezmaxinvoicinguser Value to be assigned
    def a_obj_ezmaxinvoicinguser=(a_obj_ezmaxinvoicinguser)
      if a_obj_ezmaxinvoicinguser.nil?
        fail ArgumentError, 'a_obj_ezmaxinvoicinguser cannot be nil'
      end

      @a_obj_ezmaxinvoicinguser = a_obj_ezmaxinvoicinguser
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezmaxinvoicingezsignfolder Value to be assigned
    def a_obj_ezmaxinvoicingezsignfolder=(a_obj_ezmaxinvoicingezsignfolder)
      if a_obj_ezmaxinvoicingezsignfolder.nil?
        fail ArgumentError, 'a_obj_ezmaxinvoicingezsignfolder cannot be nil'
      end

      @a_obj_ezmaxinvoicingezsignfolder = a_obj_ezmaxinvoicingezsignfolder
    end

    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezmaxinvoicingezsigndocument Value to be assigned
    def a_obj_ezmaxinvoicingezsigndocument=(a_obj_ezmaxinvoicingezsigndocument)
      if a_obj_ezmaxinvoicingezsigndocument.nil?
        fail ArgumentError, 'a_obj_ezmaxinvoicingezsigndocument cannot be nil'
      end

      @a_obj_ezmaxinvoicingezsigndocument = a_obj_ezmaxinvoicingezsigndocument
    end
