...
module EzmaxApi
  ...
  class EzsigndocumentMatchingtemplateV3Response < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigndocumentMatchingtemplateV3Response` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigndocumentMatchingtemplateV3Response`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@pki_ezsigntemplateglobal_id.nil? && @pki_ezsigntemplateglobal_id < 0
    ...
    def valid?
      ...
      return false if !@pki_ezsigntemplateglobal_id.nil? && @pki_ezsigntemplateglobal_id < 0
      true
    end
    ...
    def hash
      [pki_ezsigntemplate_id, pki_ezsigntemplateglobal_id].hash
    end
