...
module EzmaxApi
  ...
  class ActivesessionListElement < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::ActivesessionListElement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] pki_activesession_id Value to be assigned
    def pki_activesession_id=(pki_activesession_id)
      if pki_activesession_id.nil?
        fail ArgumentError, 'pki_activesession_id cannot be nil'
      end

      @pki_activesession_id = pki_activesession_id
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_activesession_ip Value to be assigned
    def s_activesession_ip=(s_activesession_ip)
      if s_activesession_ip.nil?
        fail ArgumentError, 's_activesession_ip cannot be nil'
      end

      @s_activesession_ip = s_activesession_ip
    end
