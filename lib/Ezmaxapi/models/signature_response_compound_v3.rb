...
module EzmaxApi
  # A Signature Object
  class SignatureResponseCompoundV3 < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::SignatureResponseCompoundV3` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::SignatureResponseCompoundV3`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_signature_preference Value to be assigned
    def e_signature_preference=(e_signature_preference)
      if e_signature_preference.nil?
        fail ArgumentError, 'e_signature_preference cannot be nil'
      end

      @e_signature_preference = e_signature_preference
    end

    # Custom attribute writer method with validation
    # @param [Object] b_signature_svg Value to be assigned
    def b_signature_svg=(b_signature_svg)
      if b_signature_svg.nil?
        fail ArgumentError, 'b_signature_svg cannot be nil'
      end

      @b_signature_svg = b_signature_svg
    end

    # Custom attribute writer method with validation
    # @param [Object] b_signature_svginitials Value to be assigned
    def b_signature_svginitials=(b_signature_svginitials)
      if b_signature_svginitials.nil?
        fail ArgumentError, 'b_signature_svginitials cannot be nil'
      end

      @b_signature_svginitials = b_signature_svginitials
    end
