...
module EzmaxApi
  ...
  class EzsigntemplatepublicRequestCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatepublicRequestCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatepublicRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@pki_ezsigntemplatepublic_id.nil? && @pki_ezsigntemplatepublic_id > 65535
        invalid_properties.push('invalid value for "pki_ezsigntemplatepublic_id", must be smaller than or equal to 65535.')
      end

      if !@pki_ezsigntemplatepublic_id.nil? && @pki_ezsigntemplatepublic_id < 0
    ...
    def valid?
      ...
      return false if !@pki_ezsigntemplatepublic_id.nil? && @pki_ezsigntemplatepublic_id > 65535
      return false if !@pki_ezsigntemplatepublic_id.nil? && @pki_ezsigntemplatepublic_id < 0
    ...
    def hash
      [pki_ezsigntemplatepublic_id, fki_ezsignfoldertype_id, fki_userlogintype_id, fki_ezsigntemplate_id, fki_ezsigntemplatepackage_id, s_ezsigntemplatepublic_description, b_ezsigntemplatepublic_isactive, t_ezsigntemplatepublic_note, e_ezsigntemplatepublic_limittype, i_ezsigntemplatepublic_limit].hash
    end
