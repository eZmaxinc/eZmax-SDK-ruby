...
module EzmaxApi
  ...
  class EzsigntemplatedocumentpagerecognitionResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsigntemplatedocumentpagerecognitionResponseCompound` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigntemplatedocumentpagerecognitionResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsigntemplatedocumentpagerecognition_operator Value to be assigned
    def e_ezsigntemplatedocumentpagerecognition_operator=(e_ezsigntemplatedocumentpagerecognition_operator)
      if e_ezsigntemplatedocumentpagerecognition_operator.nil?
        fail ArgumentError, 'e_ezsigntemplatedocumentpagerecognition_operator cannot be nil'
      end

      @e_ezsigntemplatedocumentpagerecognition_operator = e_ezsigntemplatedocumentpagerecognition_operator
    end

    # Custom attribute writer method with validation
    # @param [Object] e_ezsigntemplatedocumentpagerecognition_section Value to be assigned
    def e_ezsigntemplatedocumentpagerecognition_section=(e_ezsigntemplatedocumentpagerecognition_section)
      if e_ezsigntemplatedocumentpagerecognition_section.nil?
        fail ArgumentError, 'e_ezsigntemplatedocumentpagerecognition_section cannot be nil'
      end

      @e_ezsigntemplatedocumentpagerecognition_section = e_ezsigntemplatedocumentpagerecognition_section
    end
