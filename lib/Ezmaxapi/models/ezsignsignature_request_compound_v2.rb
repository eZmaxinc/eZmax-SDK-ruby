...
module EzmaxApi
  ...
  class EzsignsignatureRequestCompoundV2 < EzsignsignatureRequest
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          a_obj_ezsignelementdependency == o.a_obj_ezsignelementdependency && super(o)
    end
    ...
    def hash
      [b_ezsignsignature_customdate, a_obj_ezsignsignaturecustomdate, a_obj_ezsignelementdependency].hash
    end
