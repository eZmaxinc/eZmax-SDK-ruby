...
module EzmaxApi
  ...
  class CommunicationattachmentResponseCompound
    ...
    attr_accessor :s_communicationattachment_name
    ...
    def self.attribute_map
      {
        ...
        :'s_communicationattachment_name' => :'sCommunicationattachmentName',
    ...
    def self.openapi_types
      {
        ...
        :'s_communicationattachment_name' => :'String',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::CommunicationattachmentResponseCompound` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CommunicationattachmentResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'pki_communicationattachment_id')
        ...
        self.pki_communicationattachment_id = nil
      end
      ...
      if attributes.key?(:'s_communicationattachment_name')
        self.s_communicationattachment_name = attributes[:'s_communicationattachment_name']
      else
        self.s_communicationattachment_name = nil
      end
    ...
    def list_invalid_properties
      ...
      if @pki_communicationattachment_id.nil?
        invalid_properties.push('invalid value for "pki_communicationattachment_id", pki_communicationattachment_id cannot be nil.')
      end
      ...
      if @s_communicationattachment_name.nil?
        invalid_properties.push('invalid value for "s_communicationattachment_name", s_communicationattachment_name cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @pki_communicationattachment_id.nil?
      ...
      return false if @s_communicationattachment_name.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          s_communicationattachment_name == o.s_communicationattachment_name &&
    ...
    def hash
      [pki_communicationattachment_id, fki_attachment_id, fki_invoice_id, fki_salarypreparation_id, s_communicationattachment_name, s_download_url].hash
    end
