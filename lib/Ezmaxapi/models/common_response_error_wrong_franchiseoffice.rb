...
module EzmaxApi
  ...
  class CommonResponseErrorWrongFranchiseoffice < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CommonResponseErrorWrongFranchiseoffice`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] s_franchiseagence_name Value to be assigned
    def s_franchiseagence_name=(s_franchiseagence_name)
      if s_franchiseagence_name.nil?
        fail ArgumentError, 's_franchiseagence_name cannot be nil'
      end

      @s_franchiseagence_name = s_franchiseagence_name
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] i_franchiseoffice_code Value to be assigned
    def i_franchiseoffice_code=(i_franchiseoffice_code)
      if i_franchiseoffice_code.nil?
        fail ArgumentError, 'i_franchiseoffice_code cannot be nil'
      end

      @i_franchiseoffice_code = i_franchiseoffice_code
    end
