...
module EzmaxApi
  ...
  class CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CustomEzsignformfieldgroupCreateEzsignelementsPositionedByWordRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @s_ezsignformfieldgroup_label.to_s.length < 1
        invalid_properties.push('invalid value for "s_ezsignformfieldgroup_label", the character length must be greater than or equal to 1.')
      end
      ...
      if !@s_ezsignformfieldgroup_textvalidationcustommessage.nil? && @s_ezsignformfieldgroup_textvalidationcustommessage.to_s.length < 0
        invalid_properties.push('invalid value for "s_ezsignformfieldgroup_textvalidationcustommessage", the character length must be greater than or equal to 0.')
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsignformfieldgroup_type Value to be assigned
    def e_ezsignformfieldgroup_type=(e_ezsignformfieldgroup_type)
      if e_ezsignformfieldgroup_type.nil?
        fail ArgumentError, 'e_ezsignformfieldgroup_type cannot be nil'
      end

      @e_ezsignformfieldgroup_type = e_ezsignformfieldgroup_type
    end
    ...
    def s_ezsignformfieldgroup_label=(s_ezsignformfieldgroup_label)
      ...
      if s_ezsignformfieldgroup_label.to_s.length < 1
        fail ArgumentError, 'invalid value for "s_ezsignformfieldgroup_label", the character length must be greater than or equal to 1.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] b_ezsignformfieldgroup_readonly Value to be assigned
    def b_ezsignformfieldgroup_readonly=(b_ezsignformfieldgroup_readonly)
      if b_ezsignformfieldgroup_readonly.nil?
        fail ArgumentError, 'b_ezsignformfieldgroup_readonly cannot be nil'
      end

      @b_ezsignformfieldgroup_readonly = b_ezsignformfieldgroup_readonly
    end
    ...
    def s_ezsignformfieldgroup_textvalidationcustommessage=(s_ezsignformfieldgroup_textvalidationcustommessage)
      ...
      if s_ezsignformfieldgroup_textvalidationcustommessage.to_s.length < 0
        fail ArgumentError, 'invalid value for "s_ezsignformfieldgroup_textvalidationcustommessage", the character length must be greater than or equal to 0.'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] a_obj_ezsignformfieldgroupsigner Value to be assigned
    def a_obj_ezsignformfieldgroupsigner=(a_obj_ezsignformfieldgroupsigner)
      if a_obj_ezsignformfieldgroupsigner.nil?
        fail ArgumentError, 'a_obj_ezsignformfieldgroupsigner cannot be nil'
      end

      @a_obj_ezsignformfieldgroupsigner = a_obj_ezsignformfieldgroupsigner
    end
    ...
    def hash
      [pki_ezsignformfieldgroup_id, fki_ezsigndocument_id, e_ezsignformfieldgroup_type, e_ezsignformfieldgroup_signerrequirement, s_ezsignformfieldgroup_label, i_ezsignformfieldgroup_step, s_ezsignformfieldgroup_defaultvalue, i_ezsignformfieldgroup_filledmin, i_ezsignformfieldgroup_filledmax, b_ezsignformfieldgroup_readonly, i_ezsignformfieldgroup_maxlength, b_ezsignformfieldgroup_encrypted, s_ezsignformfieldgroup_regexp, s_ezsignformfieldgroup_textvalidationcustommessage, t_ezsignformfieldgroup_tooltip, e_ezsignformfieldgroup_tooltipposition, e_ezsignformfieldgroup_textvalidation, a_obj_ezsignformfieldgroupsigner, a_obj_dropdown_element, a_obj_ezsignformfield, obj_createezsignelementspositionedbyword].hash
    end
