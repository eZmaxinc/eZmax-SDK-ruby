...
module EzmaxApi
  ...
  class EzsignbulksendListElement < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignbulksendListElement`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] i_ezsignbulksendtransmission Value to be assigned
    def i_ezsignbulksendtransmission=(i_ezsignbulksendtransmission)
      if i_ezsignbulksendtransmission.nil?
        fail ArgumentError, 'i_ezsignbulksendtransmission cannot be nil'
      end

      @i_ezsignbulksendtransmission = i_ezsignbulksendtransmission
    end

    # Custom attribute writer method with validation
    # @param [Object] i_ezsignfolder Value to be assigned
    def i_ezsignfolder=(i_ezsignfolder)
      if i_ezsignfolder.nil?
        fail ArgumentError, 'i_ezsignfolder cannot be nil'
      end

      @i_ezsignfolder = i_ezsignfolder
    end
