...
module EzmaxApi
  ...
  class WebhookResponseCompound
    ...
    def hash
      [pki_webhook_id, s_webhook_description, fki_ezsignfoldertype_id, s_ezsignfoldertype_name_x, e_webhook_module, e_webhook_ezsignevent, e_webhook_managementevent, s_webhook_url, s_webhook_emailfailed, b_webhook_isactive, b_webhook_skipsslvalidation, s_webhook_event].hash
    end
