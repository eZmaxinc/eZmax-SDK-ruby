...
module EzmaxApi
  ...
  class EzsignsignatureResponseCompoundV3 < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignsignatureResponseCompoundV3` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignsignatureResponseCompoundV3`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@s_currency_description_x.nil? && @s_currency_description_x !~ pattern
    ...
    def valid?
      ...
      return false if !@s_currency_description_x.nil? && @s_currency_description_x !~ Regexp.new(/^.{1,20}$/)
    ...
    def hash
      [pki_ezsignsignature_id, fki_ezsigndocument_id, fki_ezsignfoldersignerassociation_id, fki_ezsignsigningreason_id, fki_font_id, fki_paymentgateway_id, s_currency_description_x, d_ezsignsignature_creditcardamount, s_ezsignsignature_creditcardamountdescription, b_ezsignsignature_creditcardcustomamount, s_ezsignsigningreason_description_x, i_ezsignpage_pagenumber, i_ezsignsignature_x, i_ezsignsignature_y, i_ezsignsignature_height, i_ezsignsignature_width, i_ezsignsignature_step, i_ezsignsignature_stepadjusted, e_ezsignsignature_type, e_ezsignsignature_signaturepad, e_ezsignsignature_signaturepadrequired, t_ezsignsignature_tooltip, e_ezsignsignature_tooltipposition, e_ezsignsignature_font, i_ezsignsignature_validationstep, s_ezsignsignature_attachmentdescription, e_ezsignsignature_attachmentnamesource, e_ezsignsignature_consultationtrigger, b_ezsignsignature_handwritten, b_ezsignsignature_reason, b_ezsignsignature_required, fki_ezsignfoldersignerassociation_id_validation, dt_ezsignsignature_date, i_ezsignsignatureattachment_count, s_ezsignsignature_description, i_ezsignsignature_maxlength, e_ezsignsignature_textvalidation, s_ezsignsignature_textvalidationcustommessage, e_ezsignsignature_dependencyrequirement, s_ezsignsignature_defaultvalue, s_ezsignsignature_regexp, obj_contact_name, obj_contact_name_delegation, obj_signature, s_ezsignsignergroup_description_x, b_ezsignsignature_customdate, a_obj_ezsignsignaturecustomdate, obj_creditcardtransaction, a_obj_ezsignelementdependency, a_obj_ezsignsignaturepaymentdetail].hash
    end
