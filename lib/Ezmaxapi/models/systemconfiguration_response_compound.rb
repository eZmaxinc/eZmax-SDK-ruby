...
module EzmaxApi
  ...
  class SystemconfigurationResponseCompound
    ...
    def hash
      [pki_systemconfiguration_id, fki_systemconfigurationtype_id, s_systemconfigurationtype_description_x, e_systemconfiguration_newexternaluseraction, e_systemconfiguration_language1, e_systemconfiguration_language2, e_systemconfiguration_ezsign, e_systemconfiguration_ezsignofficeplan, b_systemconfiguration_ezsignpaidbyoffice, b_systemconfiguration_ezsignpersonnal, b_systemconfiguration_isdisposalactive, b_systemconfiguration_sspr, dt_systemconfiguration_readonlyexpirationstart, dt_systemconfiguration_readonlyexpirationend].hash
    end
