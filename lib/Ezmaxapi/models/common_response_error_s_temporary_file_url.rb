...
module EzmaxApi
  ...
  class CommonResponseErrorSTemporaryFileUrl < ApiModelBase
    ...
    attr_accessor :s_temporary_file_url
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::CommonResponseErrorSTemporaryFileUrl` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::CommonResponseErrorSTemporaryFileUrl`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'s_temporary_file_url')
        self.s_temporary_file_url = attributes[:'s_temporary_file_url']
      end
    end
    ...
    def valid?
      ...
      return false if !@s_temporary_file_url.nil? && @s_temporary_file_url !~ Regexp.new(/^https:\/\/[^\s\/$.?#].[^\s]*$/)
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          s_temporary_file_url == o.s_temporary_file_url
    end
    ...
    def hash
      [s_error_message, e_error_code, a_s_error_messagedetail, s_temporary_file_url].hash
    end
