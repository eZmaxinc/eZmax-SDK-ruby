...
module EzmaxApi
  ...
  class EzsignelementdependencyResponseCompound < ApiModelBase
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignelementdependencyResponseCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] e_ezsignelementdependency_validation Value to be assigned
    def e_ezsignelementdependency_validation=(e_ezsignelementdependency_validation)
      if e_ezsignelementdependency_validation.nil?
        fail ArgumentError, 'e_ezsignelementdependency_validation cannot be nil'
      end

      @e_ezsignelementdependency_validation = e_ezsignelementdependency_validation
    end
