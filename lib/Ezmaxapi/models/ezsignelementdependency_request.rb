...
module EzmaxApi
  ...
  class EzsignelementdependencyRequest < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `EzmaxApi::EzsignelementdependencyRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsignelementdependencyRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if !@s_ezsignelementdependency_ezsignformfieldgrouplabel.nil? && @s_ezsignelementdependency_ezsignformfieldgrouplabel.to_s.length < 1
        invalid_properties.push('invalid value for "s_ezsignelementdependency_ezsignformfieldgrouplabel", the character length must be greater than or equal to 1.')
      end
    ...
    def s_ezsignelementdependency_ezsignformfieldgrouplabel=(s_ezsignelementdependency_ezsignformfieldgrouplabel)
      ...
      if s_ezsignelementdependency_ezsignformfieldgrouplabel.to_s.length < 1
        fail ArgumentError, 'invalid value for "s_ezsignelementdependency_ezsignformfieldgrouplabel", the character length must be greater than or equal to 1.'
      end
