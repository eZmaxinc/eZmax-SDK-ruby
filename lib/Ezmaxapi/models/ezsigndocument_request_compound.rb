...
module EzmaxApi
  ...
  class EzsigndocumentRequestCompound < ApiModelBase
    ...
    attr_accessor :fki_ezsignimportdocument_id
    ...
    def self.openapi_types
      {
        ...
        :'fki_ezsignimportdocument_id' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `EzmaxApi::EzsigndocumentRequestCompound`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'fki_ezsignimportdocument_id')
        self.fki_ezsignimportdocument_id = attributes[:'fki_ezsignimportdocument_id']
      end
    ...
    def list_invalid_properties
      ...
      if !@fki_ezsignimportdocument_id.nil? && @fki_ezsignimportdocument_id > 16777215
        invalid_properties.push('invalid value for "fki_ezsignimportdocument_id", must be smaller than or equal to 16777215.')
      end

      if !@fki_ezsignimportdocument_id.nil? && @fki_ezsignimportdocument_id < 0
        invalid_properties.push('invalid value for "fki_ezsignimportdocument_id", must be greater than or equal to 0.')
      end
    ...
    def valid?
      ...
      return false if !@fki_ezsignimportdocument_id.nil? && @fki_ezsignimportdocument_id > 16777215
      return false if !@fki_ezsignimportdocument_id.nil? && @fki_ezsignimportdocument_id < 0
      ...
      e_ezsigndocument_source_validator = EnumAttributeValidator.new('String', ["Base64", "Ezsignimportdocument", "Ezsigntemplate", "Url"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] fki_ezsignimportdocument_id Value to be assigned
    def fki_ezsignimportdocument_id=(fki_ezsignimportdocument_id)
      if fki_ezsignimportdocument_id.nil?
        fail ArgumentError, 'fki_ezsignimportdocument_id cannot be nil'
      end

      if fki_ezsignimportdocument_id > 16777215
        fail ArgumentError, 'invalid value for "fki_ezsignimportdocument_id", must be smaller than or equal to 16777215.'
      end

      if fki_ezsignimportdocument_id < 0
        fail ArgumentError, 'invalid value for "fki_ezsignimportdocument_id", must be greater than or equal to 0.'
      end

      @fki_ezsignimportdocument_id = fki_ezsignimportdocument_id
    end
    ...
    def e_ezsigndocument_source=(e_ezsigndocument_source)
      validator = EnumAttributeValidator.new('String', ["Base64", "Ezsignimportdocument", "Ezsigntemplate", "Url"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          fki_ezsignimportdocument_id == o.fki_ezsignimportdocument_id &&
    ...
    def hash
      [pki_ezsigndocument_id, fki_ezsignfolder_id, fki_ezsigntemplate_id, fki_ezsignfoldersignerassociation_id, fki_ezsignimportdocument_id, fki_language_id, e_ezsigndocument_source, e_ezsigndocument_format, s_ezsigndocument_base64, s_ezsigndocument_url, b_ezsigndocument_forcerepair, s_ezsigndocument_password, e_ezsigndocument_form, dt_ezsigndocument_duedate, s_ezsigndocument_name, s_ezsigndocument_externalid].hash
    end
