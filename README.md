...
```shell
gem install ./ezmax_api-1.1.0.gem
```

(for development, run `gem install --dev ./ezmax_api-1.1.0.gem` to install the development dependencies)
...
## Documentation for Models
 ...
 - [EzmaxApi::CustomFormDataFolderResponse](docs/CustomFormDataFolderResponse.md)
 - [EzmaxApi::CustomFormDataSignerResponse](docs/CustomFormDataSignerResponse.md)
 - [EzmaxApi::CustomWordPositionResponse](docs/CustomWordPositionResponse.md)
