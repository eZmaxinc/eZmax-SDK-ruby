...
describe 'ObjectEzsignsignatureApi' do
  ...
  # unit tests for ezsignsignature_create_object_v3
  # Create a new Ezsignsignature
  # The endpoint allows to create one or many elements at once.
  # @param ezsignsignature_create_object_v3_request 
  # @param [Hash] opts the optional parameters
  # @return [EzsignsignatureCreateObjectV3Response]
  describe 'ezsignsignature_create_object_v3 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for ezsignsignature_edit_object_v2
  # Edit an existing Ezsignsignature
  # 
  # @param pki_ezsignsignature_id 
  # @param ezsignsignature_edit_object_v2_request 
  # @param [Hash] opts the optional parameters
  # @return [EzsignsignatureEditObjectV2Response]
  describe 'ezsignsignature_edit_object_v2 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for ezsignsignature_get_object_v3
  # Retrieve an existing Ezsignsignature
  # 
  # @param pki_ezsignsignature_id 
  # @param [Hash] opts the optional parameters
  # @return [EzsignsignatureGetObjectV3Response]
  describe 'ezsignsignature_get_object_v3 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
