...
describe 'ObjectEzsignfolderApi' do
  ...
  # unit tests for ezsignfolder_create_object_v3
  # Create a new Ezsignfolder
  # The endpoint allows to create one or many elements at once.
  # @param ezsignfolder_create_object_v3_request 
  # @param [Hash] opts the optional parameters
  # @return [EzsignfolderCreateObjectV3Response]
  describe 'ezsignfolder_create_object_v3 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for ezsignfolder_edit_object_v3
  # Edit an existing Ezsignfolder
  # 
  # @param pki_ezsignfolder_id 
  # @param ezsignfolder_edit_object_v3_request 
  # @param [Hash] opts the optional parameters
  # @return [EzsignfolderEditObjectV3Response]
  describe 'ezsignfolder_edit_object_v3 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for ezsignfolder_get_object_v3
  # Retrieve an existing Ezsignfolder
  # 
  # @param pki_ezsignfolder_id 
  # @param [Hash] opts the optional parameters
  # @return [EzsignfolderGetObjectV3Response]
  describe 'ezsignfolder_get_object_v3 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for ezsignfolder_reorder_v2
  # Reorder Ezsigndocuments in the Ezsignfolder
  # @param pki_ezsignfolder_id 
  # @param ezsignfolder_reorder_v2_request 
  # @param [Hash] opts the optional parameters
  # @return [EzsignfolderReorderV2Response]
  describe 'ezsignfolder_reorder_v2 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
