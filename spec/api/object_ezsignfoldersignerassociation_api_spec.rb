...
describe 'ObjectEzsignfoldersignerassociationApi' do
  ...
  # unit tests for ezsignfoldersignerassociation_reassign_v1
  # Reassign remaining unsigned signatures and forms
  # Reassign remaining unsigned signatures and forms
  # @param pki_ezsignfoldersignerassociation_id 
  # @param ezsignfoldersignerassociation_reassign_v1_request 
  # @param [Hash] opts the optional parameters
  # @return [EzsignfoldersignerassociationReassignV1Response]
  describe 'ezsignfoldersignerassociation_reassign_v1 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
