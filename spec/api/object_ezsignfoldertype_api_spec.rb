...
describe 'ObjectEzsignfoldertypeApi' do
  ...
  # unit tests for ezsignfoldertype_create_object_v2
  # Create a new Ezsignfoldertype
  # The endpoint allows to create one or many elements at once.
  # @param ezsignfoldertype_create_object_v2_request 
  # @param [Hash] opts the optional parameters
  # @return [EzsignfoldertypeCreateObjectV2Response]
  describe 'ezsignfoldertype_create_object_v2 test' do
    it 'should work' do
  ...
  # unit tests for ezsignfoldertype_edit_object_v2
  # Edit an existing Ezsignfoldertype
  # 
  # @param pki_ezsignfoldertype_id 
  # @param ezsignfoldertype_edit_object_v2_request 
  # @param [Hash] opts the optional parameters
  # @return [EzsignfoldertypeEditObjectV2Response]
  describe 'ezsignfoldertype_edit_object_v2 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for ezsignfoldertype_get_object_v3
  # Retrieve an existing Ezsignfoldertype
  # 
  # @param pki_ezsignfoldertype_id 
  # @param [Hash] opts the optional parameters
  # @return [EzsignfoldertypeGetObjectV3Response]
  describe 'ezsignfoldertype_get_object_v3 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
